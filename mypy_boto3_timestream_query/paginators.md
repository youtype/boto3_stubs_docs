...
Boto3 documentation:
[TimestreamQuery.Paginator.Query](https://boto3.amazonaws.com/v1/documentation/api/1.17.77/reference/services/timestream-query.html#TimestreamQuery.Paginator.Query)
