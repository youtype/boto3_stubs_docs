...
from mypy_boto3_rtbfabric.type_defs import ListenerConfigUnionTypeDef
...
from mypy_boto3_rtbfabric.type_defs import AssociateCertificateRequestTypeDef
...
from mypy_boto3_rtbfabric.type_defs import HealthCheckConfigTypeDef
...
```python
# CertificateAssociationSummaryTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import CertificateAssociationSummaryTypeDef


def get_value() -> CertificateAssociationSummaryTypeDef:
    return {
        "acmCertificateArn": ...,
    }


# CertificateAssociationSummaryTypeDef definition

class CertificateAssociationSummaryTypeDef(TypedDict):
    acmCertificateArn: str,
    status: CertificateAssociationStatusType,  # (1)
    associatedAt: NotRequired[datetime.datetime],
    updatedAt: NotRequired[datetime.datetime],
```

1. See [:material-code-brackets: CertificateAssociationStatusType](./literals.md#certificateassociationstatustype)
...
from mypy_boto3_rtbfabric.type_defs import ListenerConfigOutputTypeDef
...
```python
# DeleteLinkRoutingRuleRequestTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import DeleteLinkRoutingRuleRequestTypeDef


def get_value() -> DeleteLinkRoutingRuleRequestTypeDef:
    return {
        "gatewayId": ...,
    }


# DeleteLinkRoutingRuleRequestTypeDef definition
...
from mypy_boto3_rtbfabric.type_defs import DisassociateCertificateRequestTypeDef
...
```python
# GetCertificateAssociationRequestTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import GetCertificateAssociationRequestTypeDef


def get_value() -> GetCertificateAssociationRequestTypeDef:
    return {
        "gatewayId": ...,
    }


# GetCertificateAssociationRequestTypeDef definition
...
```python
# GetLinkRoutingRuleRequestTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import GetLinkRoutingRuleRequestTypeDef


def get_value() -> GetLinkRoutingRuleRequestTypeDef:
    return {
        "gatewayId": ...,
    }


# GetLinkRoutingRuleRequestTypeDef definition
...
```python
# ListCertificateAssociationsRequestTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import ListCertificateAssociationsRequestTypeDef


def get_value() -> ListCertificateAssociationsRequestTypeDef:
    return {
        "gatewayId": ...,
    }


# ListCertificateAssociationsRequestTypeDef definition
...
```python
# ListLinkRoutingRulesRequestTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import ListLinkRoutingRulesRequestTypeDef


def get_value() -> ListLinkRoutingRulesRequestTypeDef:
    return {
        "gatewayId": ...,
    }


# ListLinkRoutingRulesRequestTypeDef definition
...
from mypy_boto3_rtbfabric.type_defs import ListenerConfigTypeDef
...
from mypy_boto3_rtbfabric.type_defs import RateLimiterModuleParametersTypeDef
...
from mypy_boto3_rtbfabric.type_defs import QueryStringKeyValuePairTypeDef
...
```python
# AssociateCertificateResponseTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import AssociateCertificateResponseTypeDef


def get_value() -> AssociateCertificateResponseTypeDef:
    return {
        "gatewayId": ...,
    }


# AssociateCertificateResponseTypeDef definition
...
```python
# CreateLinkRoutingRuleResponseTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import CreateLinkRoutingRuleResponseTypeDef


def get_value() -> CreateLinkRoutingRuleResponseTypeDef:
    return {
        "ruleId": ...,
    }


# CreateLinkRoutingRuleResponseTypeDef definition

class CreateLinkRoutingRuleResponseTypeDef(TypedDict):
    ruleId: str,
    status: RuleStatusType,  # (1)
...
```python
# DeleteLinkRoutingRuleResponseTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import DeleteLinkRoutingRuleResponseTypeDef


def get_value() -> DeleteLinkRoutingRuleResponseTypeDef:
    return {
        "ruleId": ...,
    }


# DeleteLinkRoutingRuleResponseTypeDef definition
...
```python
# DisassociateCertificateResponseTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import DisassociateCertificateResponseTypeDef


def get_value() -> DisassociateCertificateResponseTypeDef:
    return {
        "gatewayId": ...,
    }


# DisassociateCertificateResponseTypeDef definition
...
```python
# GetCertificateAssociationResponseTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import GetCertificateAssociationResponseTypeDef


def get_value() -> GetCertificateAssociationResponseTypeDef:
    return {
        "gatewayId": ...,
    }


# GetCertificateAssociationResponseTypeDef definition
...
```python
# UpdateLinkRoutingRuleResponseTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import UpdateLinkRoutingRuleResponseTypeDef


def get_value() -> UpdateLinkRoutingRuleResponseTypeDef:
    return {
        "ruleId": ...,
    }


# UpdateLinkRoutingRuleResponseTypeDef definition
...
class UpdateResponderGatewayResponseTypeDef(TypedDict):
    gatewayId: str,
    status: ResponderGatewayStatusType,  # (1)
    clientRoutingPolicy: ClientRoutingPolicyType,  # (2)
    ResponseMetadata: ResponseMetadataTypeDef,  # (3)
```

1. See [:material-code-brackets: ResponderGatewayStatusType](./literals.md#respondergatewaystatustype)
2. See [:material-code-brackets: ClientRoutingPolicyType](./literals.md#clientroutingpolicytype)
...
```python
# ListCertificateAssociationsResponseTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import ListCertificateAssociationsResponseTypeDef


def get_value() -> ListCertificateAssociationsResponseTypeDef:
    return {
        "certificateAssociations": ...,
    }


# ListCertificateAssociationsResponseTypeDef definition

class ListCertificateAssociationsResponseTypeDef(TypedDict):
    certificateAssociations: list[CertificateAssociationSummaryTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[CertificateAssociationSummaryTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
class CreateResponderGatewayResponseTypeDef(TypedDict):
    ...
    clientRoutingPolicy: ClientRoutingPolicyType,  # (3)
    ResponseMetadata: ResponseMetadataTypeDef,  # (4)
```

1. See [:material-code-brackets: ResponderGatewayStatusType](./literals.md#respondergatewaystatustype)
2. See [:material-code-braces: ListenerConfigOutputTypeDef](./type_defs.md#listenerconfigoutputtypedef)
3. See [:material-code-brackets: ClientRoutingPolicyType](./literals.md#clientroutingpolicytype)
...
```python
# GetCertificateAssociationRequestWaitExtraTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import GetCertificateAssociationRequestWaitExtraTypeDef


def get_value() -> GetCertificateAssociationRequestWaitExtraTypeDef:
    return {
        "gatewayId": ...,
    }


# GetCertificateAssociationRequestWaitExtraTypeDef definition
...
```python
# GetCertificateAssociationRequestWaitTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import GetCertificateAssociationRequestWaitTypeDef


def get_value() -> GetCertificateAssociationRequestWaitTypeDef:
    return {
        "gatewayId": ...,
    }


# GetCertificateAssociationRequestWaitTypeDef definition
...
from mypy_boto3_rtbfabric.type_defs import GetInboundExternalLinkRequestWaitExtraTypeDef
...
from mypy_boto3_rtbfabric.type_defs import GetLinkRequestWaitExtraExtraTypeDef
...
```python
# GetLinkRoutingRuleRequestWaitExtraTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import GetLinkRoutingRuleRequestWaitExtraTypeDef


def get_value() -> GetLinkRoutingRuleRequestWaitExtraTypeDef:
    return {
        "gatewayId": ...,
    }


# GetLinkRoutingRuleRequestWaitExtraTypeDef definition
...
```python
# GetLinkRoutingRuleRequestWaitTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import GetLinkRoutingRuleRequestWaitTypeDef


def get_value() -> GetLinkRoutingRuleRequestWaitTypeDef:
    return {
        "gatewayId": ...,
    }


# GetLinkRoutingRuleRequestWaitTypeDef definition
...
from mypy_boto3_rtbfabric.type_defs import GetOutboundExternalLinkRequestWaitExtraTypeDef
...
```python
# ListCertificateAssociationsRequestPaginateTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import ListCertificateAssociationsRequestPaginateTypeDef


def get_value() -> ListCertificateAssociationsRequestPaginateTypeDef:
    return {
        "gatewayId": ...,
    }


# ListCertificateAssociationsRequestPaginateTypeDef definition
...
```python
# ListLinkRoutingRulesRequestPaginateTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import ListLinkRoutingRulesRequestPaginateTypeDef


def get_value() -> ListLinkRoutingRulesRequestPaginateTypeDef:
    return {
        "gatewayId": ...,
    }


# ListLinkRoutingRulesRequestPaginateTypeDef definition
...
from mypy_boto3_rtbfabric.type_defs import RuleConditionTypeDef
...
class RuleConditionTypeDef(TypedDict):
    ...
    queryStringEquals: NotRequired[QueryStringKeyValuePairTypeDef],  # (1)
...
```python
# CreateLinkRoutingRuleRequestTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import CreateLinkRoutingRuleRequestTypeDef


def get_value() -> CreateLinkRoutingRuleRequestTypeDef:
    return {
        "clientToken": ...,
    }


# CreateLinkRoutingRuleRequestTypeDef definition
...
```python
# GetLinkRoutingRuleResponseTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import GetLinkRoutingRuleResponseTypeDef


def get_value() -> GetLinkRoutingRuleResponseTypeDef:
    return {
        "gatewayId": ...,
    }


# GetLinkRoutingRuleResponseTypeDef definition
...
1. See [:material-code-braces: RuleConditionTypeDef](./type_defs.md#ruleconditiontypedef)
2. See [:material-code-brackets: RuleStatusType](./literals.md#rulestatustype)
3. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## LinkRoutingRuleSummaryTypeDef

```python
# LinkRoutingRuleSummaryTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import LinkRoutingRuleSummaryTypeDef


def get_value() -> LinkRoutingRuleSummaryTypeDef:
    return {
        "ruleId": ...,
    }


# LinkRoutingRuleSummaryTypeDef definition
...
```python
# UpdateLinkRoutingRuleRequestTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import UpdateLinkRoutingRuleRequestTypeDef


def get_value() -> UpdateLinkRoutingRuleRequestTypeDef:
    return {
        "gatewayId": ...,
    }


# UpdateLinkRoutingRuleRequestTypeDef definition
...
class GetResponderGatewayResponseTypeDef(TypedDict):
    ...
    externalInboundEndpoint: str,
    clientRoutingPolicy: ClientRoutingPolicyType,  # (7)
...
7. See [:material-code-brackets: ClientRoutingPolicyType](./literals.md#clientroutingpolicytype)
...
```python
# ListLinkRoutingRulesResponseTypeDef TypedDict usage example

from mypy_boto3_rtbfabric.type_defs import ListLinkRoutingRulesResponseTypeDef


def get_value() -> ListLinkRoutingRulesResponseTypeDef:
    return {
        "rules": ...,
    }


# ListLinkRoutingRulesResponseTypeDef definition

class ListLinkRoutingRulesResponseTypeDef(TypedDict):
    rules: list[LinkRoutingRuleSummaryTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[LinkRoutingRuleSummaryTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
class CreateResponderGatewayRequestTypeDef(TypedDict):
    ...
    clientRoutingPolicy: NotRequired[ClientRoutingPolicyType],  # (6)
```
...
6. See [:material-code-brackets: ClientRoutingPolicyType](./literals.md#clientroutingpolicytype)
...
class UpdateResponderGatewayRequestTypeDef(TypedDict):
    ...
    managedEndpointConfiguration: NotRequired[ManagedEndpointConfigurationUnionTypeDef],  # (4)
    description: NotRequired[str],
    clientRoutingPolicy: NotRequired[ClientRoutingPolicyType],  # (5)
```
...
3. See [:material-code-braces: TrustStoreConfigurationUnionTypeDef](#truststoreconfigurationuniontypedef)
4. See [:material-code-braces: ManagedEndpointConfigurationUnionTypeDef](#managedendpointconfigurationuniontypedef)
5. See [:material-code-brackets: ClientRoutingPolicyType](./literals.md#clientroutingpolicytype)
