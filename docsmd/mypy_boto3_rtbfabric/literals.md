...
```python
# ClientRoutingPolicyType usage example
from mypy_boto3_rtbfabric.literals import ClientRoutingPolicyType

def get_value() -> ClientRoutingPolicyType:
    return "ANY_AVAILABILITY_ZONE"
```

```python
# ClientRoutingPolicyType definition
ClientRoutingPolicyType = Literal[
