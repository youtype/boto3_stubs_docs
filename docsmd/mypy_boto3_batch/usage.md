...
result = client.cancel_jobs()  # (2)
```

1. client: [BatchClient](./client.md)
2. result: [:material-code-braces: CancelJobsResponseTypeDef](./type_defs.md#canceljobsresponsetypedef)
...
kwargs: CancelJobsRequestTypeDef = {...}
result: CancelJobsResponseTypeDef = client.cancel_jobs(**kwargs)
```
