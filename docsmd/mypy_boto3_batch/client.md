...
Type annotations and code completion for `#!python boto3.client("batch").cancel_jobs` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/batch/client/cancel_jobs.html)

```python
# cancel_jobs method definition
...
def cancel_jobs(
    ...
    *,
    jobs: Sequence[str],
    reason: str,
) -> CancelJobsResponseTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: CancelJobsResponseTypeDef](./type_defs.md#canceljobsresponsetypedef)


```python
# cancel_jobs method usage example with argument unpacking

kwargs: CancelJobsRequestTypeDef = {  # (1)
    "jobs": ...,
    "reason": ...,
}

parent.cancel_jobs(**kwargs)
```

1. See [:material-code-braces: CancelJobsRequestTypeDef](./type_defs.md#canceljobsrequesttypedef)
...
Type annotations and code completion for `#!python boto3.client("batch").terminate_jobs` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/batch/client/terminate_jobs.html)

```python
# terminate_jobs method definition
...
def terminate_jobs(
    ...
    *,
    jobs: Sequence[str],
    reason: str,
) -> TerminateJobsResponseTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: TerminateJobsResponseTypeDef](./type_defs.md#terminatejobsresponsetypedef)


```python
# terminate_jobs method usage example with argument unpacking

kwargs: TerminateJobsRequestTypeDef = {  # (1)
    "jobs": ...,
    "reason": ...,
}

parent.terminate_jobs(**kwargs)
```

1. See [:material-code-braces: TerminateJobsRequestTypeDef](./type_defs.md#terminatejobsrequesttypedef)
...
### terminate\_service\_jobs

Terminates up to 50 service jobs in a job queue.

Type annotations and code completion for `#!python boto3.client("batch").terminate_service_jobs` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/batch/client/terminate_service_jobs.html)

```python
# terminate_service_jobs method definition
...
def terminate_service_jobs(
    ...
    *,
    jobs: Sequence[str],
    reason: str,
) -> TerminateServiceJobsResponseTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: TerminateServiceJobsResponseTypeDef](./type_defs.md#terminateservicejobsresponsetypedef)


```python
# terminate_service_jobs method usage example with argument unpacking

kwargs: TerminateServiceJobsRequestTypeDef = {  # (1)
    "jobs": ...,
    "reason": ...,
}

parent.terminate_service_jobs(**kwargs)
```

1. See [:material-code-braces: TerminateServiceJobsRequestTypeDef](./type_defs.md#terminateservicejobsrequesttypedef)
