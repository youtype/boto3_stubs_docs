...
```python
# CancelJobsErrorDetailTypeDef TypedDict usage example

from mypy_boto3_batch.type_defs import CancelJobsErrorDetailTypeDef


def get_value() -> CancelJobsErrorDetailTypeDef:
    return {
        "job": ...,
    }


# CancelJobsErrorDetailTypeDef definition
...
```python
# CancelJobsRequestTypeDef TypedDict usage example

from mypy_boto3_batch.type_defs import CancelJobsRequestTypeDef


def get_value() -> CancelJobsRequestTypeDef:
    return {
        "jobs": ...,
    }


# CancelJobsRequestTypeDef definition
...
```python
# TerminateJobsErrorDetailTypeDef TypedDict usage example

from mypy_boto3_batch.type_defs import TerminateJobsErrorDetailTypeDef


def get_value() -> TerminateJobsErrorDetailTypeDef:
    return {
        "job": ...,
    }


# TerminateJobsErrorDetailTypeDef definition
...
```python
# TerminateJobsRequestTypeDef TypedDict usage example

from mypy_boto3_batch.type_defs import TerminateJobsRequestTypeDef


def get_value() -> TerminateJobsRequestTypeDef:
    return {
        "jobs": ...,
    }


# TerminateJobsRequestTypeDef definition
...
```python
# TerminateServiceJobsErrorDetailTypeDef TypedDict usage example

from mypy_boto3_batch.type_defs import TerminateServiceJobsErrorDetailTypeDef


def get_value() -> TerminateServiceJobsErrorDetailTypeDef:
    return {
        "job": ...,
    }


# TerminateServiceJobsErrorDetailTypeDef definition
...
```python
# TerminateServiceJobsRequestTypeDef TypedDict usage example

from mypy_boto3_batch.type_defs import TerminateServiceJobsRequestTypeDef


def get_value() -> TerminateServiceJobsRequestTypeDef:
    return {
        "jobs": ...,
    }


# TerminateServiceJobsRequestTypeDef definition
...
```python
# CancelJobsResponseTypeDef TypedDict usage example

from mypy_boto3_batch.type_defs import CancelJobsResponseTypeDef


def get_value() -> CancelJobsResponseTypeDef:
    return {
        "successful": ...,
    }


# CancelJobsResponseTypeDef definition

class CancelJobsResponseTypeDef(TypedDict):
    successful: list[str],
    errors: list[CancelJobsErrorDetailTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See `list[CancelJobsErrorDetailTypeDef]`
...
```python
# TerminateJobsResponseTypeDef TypedDict usage example

from mypy_boto3_batch.type_defs import TerminateJobsResponseTypeDef


def get_value() -> TerminateJobsResponseTypeDef:
    return {
        "successful": ...,
    }


# TerminateJobsResponseTypeDef definition

class TerminateJobsResponseTypeDef(TypedDict):
    successful: list[str],
    errors: list[TerminateJobsErrorDetailTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See `list[TerminateJobsErrorDetailTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## TerminateServiceJobsResponseTypeDef

```python
# TerminateServiceJobsResponseTypeDef TypedDict usage example

from mypy_boto3_batch.type_defs import TerminateServiceJobsResponseTypeDef


def get_value() -> TerminateServiceJobsResponseTypeDef:
    return {
        "successful": ...,
    }


# TerminateServiceJobsResponseTypeDef definition

class TerminateServiceJobsResponseTypeDef(TypedDict):
    successful: list[str],
    errors: list[TerminateServiceJobsErrorDetailTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See `list[TerminateServiceJobsErrorDetailTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
