...
```python title="Usage Example"
from mypy_boto3_cloudcontrol.literals import OperationStatusType
...
```python title="Usage Example"
from mypy_boto3_cloudcontrol.literals import OperationType
...
```python title="Usage Example"
from mypy_boto3_cloudcontrol.literals import ResourceRequestSuccessWaiterName
...
```python title="Usage Example"
from mypy_boto3_cloudcontrol.literals import ServiceName
...
```python title="Usage Example"
from mypy_boto3_cloudcontrol.literals import RegionName
