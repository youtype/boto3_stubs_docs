...
### create\_dataset\_integration

Creates a dataset integration for the caller's account in the current region
and returns its ARN.

Type annotations and code completion for `#!python boto3.client("observabilityadmin").create_dataset_integration` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/observabilityadmin/client/create_dataset_integration.html)

```python
# create_dataset_integration method definition
...
def create_dataset_integration(
    ...
    *,
    RoleArn: str,
    Tags: Mapping[str, str] = ...,
) -> CreateDatasetIntegrationOutputTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: CreateDatasetIntegrationOutputTypeDef](./type_defs.md#createdatasetintegrationoutputtypedef)


```python
# create_dataset_integration method usage example with argument unpacking

kwargs: CreateDatasetIntegrationInputTypeDef = {  # (1)
    "RoleArn": ...,
}

parent.create_dataset_integration(**kwargs)
```

1. See [:material-code-braces: CreateDatasetIntegrationInputTypeDef](./type_defs.md#createdatasetintegrationinputtypedef)
...
### delete\_dataset\_integration

Deletes a dataset integration for the caller's account in the current region.

Type annotations and code completion for `#!python boto3.client("observabilityadmin").delete_dataset_integration` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/observabilityadmin/client/delete_dataset_integration.html)

```python
# delete_dataset_integration method definition
...
```python
# delete_dataset_integration method usage example with argument unpacking

kwargs: DeleteDatasetIntegrationInputTypeDef = {  # (1)
    "Arn": ...,
}

parent.delete_dataset_integration(**kwargs)
```

1. See [:material-code-braces: DeleteDatasetIntegrationInputTypeDef](./type_defs.md#deletedatasetintegrationinputtypedef)
...
### get\_dataset\_integration

Returns the dataset integration for the caller's account in the current region.

Type annotations and code completion for `#!python boto3.client("observabilityadmin").get_dataset_integration` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/observabilityadmin/client/get_dataset_integration.html)

```python
# get_dataset_integration method definition

def get_dataset_integration(
    self,
    *,
    Arn: str,
) -> GetDatasetIntegrationOutputTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: GetDatasetIntegrationOutputTypeDef](./type_defs.md#getdatasetintegrationoutputtypedef)


```python
# get_dataset_integration method usage example with argument unpacking

kwargs: GetDatasetIntegrationInputTypeDef = {  # (1)
    "Arn": ...,
}

parent.get_dataset_integration(**kwargs)
```

1. See [:material-code-braces: GetDatasetIntegrationInputTypeDef](./type_defs.md#getdatasetintegrationinputtypedef)
...
### list\_dataset\_integrations

Returns the dataset integrations in your account.

Type annotations and code completion for `#!python boto3.client("observabilityadmin").list_dataset_integrations` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/observabilityadmin/client/list_dataset_integrations.html)

```python
# list_dataset_integrations method definition
...
def list_dataset_integrations(
    ...
    *,
    MaxResults: int = ...,
    NextToken: str = ...,
) -> ListDatasetIntegrationsOutputTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: ListDatasetIntegrationsOutputTypeDef](./type_defs.md#listdatasetintegrationsoutputtypedef)


```python
# list_dataset_integrations method usage example with argument unpacking

kwargs: ListDatasetIntegrationsInputTypeDef = {  # (1)
    "MaxResults": ...,
}

parent.list_dataset_integrations(**kwargs)
```

1. See [:material-code-braces: ListDatasetIntegrationsInputTypeDef](./type_defs.md#listdatasetintegrationsinputtypedef)
...
### update\_dataset\_integration

Updates a dataset integration for the caller's account in the current region.

Type annotations and code completion for `#!python boto3.client("observabilityadmin").update_dataset_integration` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/observabilityadmin/client/update_dataset_integration.html)

```python
# update_dataset_integration method definition
...
def update_dataset_integration(
    ...
    *,
    Arn: str,
    RoleArn: str,
) -> UpdateDatasetIntegrationOutputTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: UpdateDatasetIntegrationOutputTypeDef](./type_defs.md#updatedatasetintegrationoutputtypedef)


```python
# update_dataset_integration method usage example with argument unpacking

kwargs: UpdateDatasetIntegrationInputTypeDef = {  # (1)
    "Arn": ...,
    "RoleArn": ...,
}

parent.update_dataset_integration(**kwargs)
```

1. See [:material-code-braces: UpdateDatasetIntegrationInputTypeDef](./type_defs.md#updatedatasetintegrationinputtypedef)
...
- `client.get_paginator("list_dataset_integrations")` -> [ListDatasetIntegrationsPaginator](./paginators.md#listdatasetintegrationspaginator)
