...
Type annotations and code completion for `#!python boto3.client("observabilityadmin").get_paginator("list_dataset_integrations")`.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/observabilityadmin/paginator/ListDatasetIntegrations.html#CloudWatchObservabilityAdminService.Paginator.ListDatasetIntegrations)

```python
# ListDatasetIntegrationsPaginator usage example

from boto3.session import Session

from mypy_boto3_observabilityadmin.paginator import ListDatasetIntegrationsPaginator

def get_list_dataset_integrations_paginator() -> ListDatasetIntegrationsPaginator:
    return Session().client("observabilityadmin").get_paginator("list_dataset_integrations")
```

```python
# ListDatasetIntegrationsPaginator usage example with type annotations
...
client = Session().client("observabilityadmin")  # (1)
paginator: ListDatasetIntegrationsPaginator = client.get_paginator("list_dataset_integrations")  # (2)
for item in paginator.paginate(...):
    print(item)  # (3)
```

1. client: [CloudWatchObservabilityAdminServiceClient](./client.md)
2. paginator: [ListDatasetIntegrationsPaginator](./paginators.md#listdatasetintegrationspaginator)
3. item: `PageIterator[ListDatasetIntegrationsOutputTypeDef]`


### paginate

Type annotations and code completion for `#!python ListDatasetIntegrationsPaginator.paginate` method.
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> botocore.paginate.PageIterator[ListDatasetIntegrationsOutputTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
2. See `PageIterator[ListDatasetIntegrationsOutputTypeDef]`


```python
# paginate method usage example with argument unpacking

kwargs: ListDatasetIntegrationsInputPaginateTypeDef = {  # (1)
    "PaginationConfig": ...,
}
...
1. See [:material-code-braces: ListDatasetIntegrationsInputPaginateTypeDef](./type_defs.md#listdatasetintegrationsinputpaginatetypedef)
