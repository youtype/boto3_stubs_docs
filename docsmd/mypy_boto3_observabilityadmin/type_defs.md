...
class CentralizationRuleSummaryTypeDef(TypedDict):
    ...
    ContextGraphStatus: NotRequired[ContextGraphStatusType],  # (5)
...
5. See [:material-code-brackets: ContextGraphStatusType](./literals.md#contextgraphstatustype)
...
```python
# CreateDatasetIntegrationInputTypeDef TypedDict usage example

from mypy_boto3_observabilityadmin.type_defs import CreateDatasetIntegrationInputTypeDef


def get_value() -> CreateDatasetIntegrationInputTypeDef:
    return {
        "RoleArn": ...,
    }


# CreateDatasetIntegrationInputTypeDef definition
...
```python
# DatasetIntegrationSummaryTypeDef TypedDict usage example

from mypy_boto3_observabilityadmin.type_defs import DatasetIntegrationSummaryTypeDef


def get_value() -> DatasetIntegrationSummaryTypeDef:
    return {
        "Arn": ...,
    }


# DatasetIntegrationSummaryTypeDef definition
...
```python
# DeleteDatasetIntegrationInputTypeDef TypedDict usage example

from mypy_boto3_observabilityadmin.type_defs import DeleteDatasetIntegrationInputTypeDef


def get_value() -> DeleteDatasetIntegrationInputTypeDef:
    return {
        "Arn": ...,
    }


# DeleteDatasetIntegrationInputTypeDef definition
...
```python
# GetDatasetIntegrationInputTypeDef TypedDict usage example

from mypy_boto3_observabilityadmin.type_defs import GetDatasetIntegrationInputTypeDef


def get_value() -> GetDatasetIntegrationInputTypeDef:
    return {
        "Arn": ...,
    }


# GetDatasetIntegrationInputTypeDef definition
...
```python
# ListDatasetIntegrationsInputTypeDef TypedDict usage example

from mypy_boto3_observabilityadmin.type_defs import ListDatasetIntegrationsInputTypeDef


def get_value() -> ListDatasetIntegrationsInputTypeDef:
    return {
        "MaxResults": ...,
    }


# ListDatasetIntegrationsInputTypeDef definition
...
```python
# UpdateDatasetIntegrationInputTypeDef TypedDict usage example

from mypy_boto3_observabilityadmin.type_defs import UpdateDatasetIntegrationInputTypeDef


def get_value() -> UpdateDatasetIntegrationInputTypeDef:
    return {
        "Arn": ...,
    }


# UpdateDatasetIntegrationInputTypeDef definition
...
```python
# CreateDatasetIntegrationOutputTypeDef TypedDict usage example

from mypy_boto3_observabilityadmin.type_defs import CreateDatasetIntegrationOutputTypeDef


def get_value() -> CreateDatasetIntegrationOutputTypeDef:
    return {
        "Arn": ...,
    }


# CreateDatasetIntegrationOutputTypeDef definition
...
```python
# GetDatasetIntegrationOutputTypeDef TypedDict usage example

from mypy_boto3_observabilityadmin.type_defs import GetDatasetIntegrationOutputTypeDef


def get_value() -> GetDatasetIntegrationOutputTypeDef:
    return {
        "Arn": ...,
    }


# GetDatasetIntegrationOutputTypeDef definition
...
```python
# UpdateDatasetIntegrationOutputTypeDef TypedDict usage example

from mypy_boto3_observabilityadmin.type_defs import UpdateDatasetIntegrationOutputTypeDef


def get_value() -> UpdateDatasetIntegrationOutputTypeDef:
    return {
        "Arn": ...,
    }


# UpdateDatasetIntegrationOutputTypeDef definition
...
```python
# ListDatasetIntegrationsOutputTypeDef TypedDict usage example

from mypy_boto3_observabilityadmin.type_defs import ListDatasetIntegrationsOutputTypeDef


def get_value() -> ListDatasetIntegrationsOutputTypeDef:
    return {
        "DatasetIntegrationSummaries": ...,
    }


# ListDatasetIntegrationsOutputTypeDef definition

class ListDatasetIntegrationsOutputTypeDef(TypedDict):
    DatasetIntegrationSummaries: list[DatasetIntegrationSummaryTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    NextToken: NotRequired[str],
```

1. See `list[DatasetIntegrationSummaryTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
```python
# ListDatasetIntegrationsInputPaginateTypeDef TypedDict usage example

from mypy_boto3_observabilityadmin.type_defs import ListDatasetIntegrationsInputPaginateTypeDef


def get_value() -> ListDatasetIntegrationsInputPaginateTypeDef:
    return {
        "PaginationConfig": ...,
    }


# ListDatasetIntegrationsInputPaginateTypeDef definition
...
class GetCentralizationRuleForOrganizationOutputTypeDef(TypedDict):
    ...
    ContextGraphStatus: ContextGraphStatusType,  # (5)
    CentralizationRule: CentralizationRuleOutputTypeDef,  # (6)
...
4. See [:material-code-brackets: TagPropagationFailureReasonType](./literals.md#tagpropagationfailurereasontype)
5. See [:material-code-brackets: ContextGraphStatusType](./literals.md#contextgraphstatustype)
6. See [:material-code-braces: CentralizationRuleOutputTypeDef](./type_defs.md#centralizationruleoutputtypedef)
