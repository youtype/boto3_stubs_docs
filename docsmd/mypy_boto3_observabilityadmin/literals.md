...
```python
# ContextGraphStatusType usage example
from mypy_boto3_observabilityadmin.literals import ContextGraphStatusType

def get_value() -> ContextGraphStatusType:
    return "Healthy"
```

```python
# ContextGraphStatusType definition
ContextGraphStatusType = Literal[
    "Healthy",
    "Provisioning",
    "Unhealthy",
]
...
```python
# ListDatasetIntegrationsPaginatorName usage example
from mypy_boto3_observabilityadmin.literals import ListDatasetIntegrationsPaginatorName

def get_value() -> ListDatasetIntegrationsPaginatorName:
    return "list_dataset_integrations"
```

```python
# ListDatasetIntegrationsPaginatorName definition
ListDatasetIntegrationsPaginatorName = Literal[
