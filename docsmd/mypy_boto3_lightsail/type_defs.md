...
```python
# DistributionCustomErrorResponseTypeDef TypedDict usage example

from mypy_boto3_lightsail.type_defs import DistributionCustomErrorResponseTypeDef


def get_value() -> DistributionCustomErrorResponseTypeDef:
    return {
        "errorCode": ...,
    }


# DistributionCustomErrorResponseTypeDef definition
...
class LightsailDistributionTypeDef(TypedDict):
    ...
    customErrorResponses: NotRequired[list[DistributionCustomErrorResponseTypeDef]],  # (9)
```
...
9. See `list[DistributionCustomErrorResponseTypeDef]`
...
class CreateDistributionRequestTypeDef(TypedDict):
    ...
    defaultRootObject: NotRequired[str],
    customErrorResponses: NotRequired[Sequence[DistributionCustomErrorResponseTypeDef]],  # (8)
```
...
8. See `Sequence[DistributionCustomErrorResponseTypeDef]`
...
class UpdateDistributionRequestTypeDef(TypedDict):
    ...
    enablePrivateOriginAccess: NotRequired[bool],
    defaultRootObject: NotRequired[str],
    customErrorResponses: NotRequired[Sequence[DistributionCustomErrorResponseTypeDef]],  # (6)
```
...
6. See `Sequence[DistributionCustomErrorResponseTypeDef]`
