...
def create_distribution(
    ...
    *,
    ...
    customErrorResponses: Sequence[DistributionCustomErrorResponseTypeDef] = ...,  # (8)
) -> CreateDistributionResultTypeDef:  # (9)
    ...
```
...
9. See [:material-code-braces: CreateDistributionResultTypeDef](./type_defs.md#createdistributionresulttypedef)
...
def update_distribution(
    ...
    *,
    ...
    enablePrivateOriginAccess: bool = ...,
    defaultRootObject: str = ...,
    customErrorResponses: Sequence[DistributionCustomErrorResponseTypeDef] = ...,  # (6)
) -> UpdateDistributionResultTypeDef:  # (7)
    ...
```
...
7. See [:material-code-braces: UpdateDistributionResultTypeDef](./type_defs.md#updatedistributionresulttypedef)
