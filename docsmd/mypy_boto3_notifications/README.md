...
- [NotificationEventAttachmentTypeDef](./type_defs.md#notificationeventattachmenttypedef)
...
- [UpdateManagedNotificationChannelAssociationRequestTypeDef](./type_defs.md#updatemanagednotificationchannelassociationrequesttypedef)
