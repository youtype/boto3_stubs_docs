...
### update\_managed\_notification\_channel\_association

Updates the <code>isSensitiveEventsSubscribed</code> property of a particular
ManagedNotification channel association.

Type annotations and code completion for `#!python boto3.client("notifications").update_managed_notification_channel_association` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/notifications/client/update_managed_notification_channel_association.html)

```python
# update_managed_notification_channel_association method definition
...
```python
# update_managed_notification_channel_association method usage example with argument unpacking

kwargs: UpdateManagedNotificationChannelAssociationRequestTypeDef = {  # (1)
    "managedNotificationConfigurationArn": ...,
    "channelIdentifier": ...,
}

parent.update_managed_notification_channel_association(**kwargs)
```

1. See [:material-code-braces: UpdateManagedNotificationChannelAssociationRequestTypeDef](./type_defs.md#updatemanagednotificationchannelassociationrequesttypedef)
