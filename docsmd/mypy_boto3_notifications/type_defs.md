...
```python
# NotificationEventAttachmentTypeDef TypedDict usage example

from mypy_boto3_notifications.type_defs import NotificationEventAttachmentTypeDef


def get_value() -> NotificationEventAttachmentTypeDef:
    return {
        "displayName": ...,
    }


# NotificationEventAttachmentTypeDef definition
...
```python
# UpdateManagedNotificationChannelAssociationRequestTypeDef TypedDict usage example

from mypy_boto3_notifications.type_defs import UpdateManagedNotificationChannelAssociationRequestTypeDef


def get_value() -> UpdateManagedNotificationChannelAssociationRequestTypeDef:
    return {
        "managedNotificationConfigurationArn": ...,
    }


# UpdateManagedNotificationChannelAssociationRequestTypeDef definition
...
class ManagedNotificationEventTypeDef(TypedDict):
    ...
    endTime: NotRequired[datetime.datetime],
    organizationalUnitId: NotRequired[str],
    attachments: NotRequired[list[NotificationEventAttachmentTypeDef]],  # (8)
```
...
8. See `list[NotificationEventAttachmentTypeDef]`
