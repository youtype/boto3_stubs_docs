...
```python
# BootModeOverrideValuesType usage example
from mypy_boto3_ec2.literals import BootModeOverrideValuesType

def get_value() -> BootModeOverrideValuesType:
    return "uefi"
```

```python
# BootModeOverrideValuesType definition
BootModeOverrideValuesType = Literal[
    "uefi",
]
```
## BootModeTypeType
...
```python
# CapacityReservationAdjustmentStatusType usage example
from mypy_boto3_ec2.literals import CapacityReservationAdjustmentStatusType

def get_value() -> CapacityReservationAdjustmentStatusType:
    return "applied"
```

```python
# CapacityReservationAdjustmentStatusType definition
CapacityReservationAdjustmentStatusType = Literal[
    "applied",
    "rejected",
    "requested",
]
...
```python
# CapacityReservationModificationQuoteStateType usage example
from mypy_boto3_ec2.literals import CapacityReservationModificationQuoteStateType

def get_value() -> CapacityReservationModificationQuoteStateType:
    return "active"
```

```python
# CapacityReservationModificationQuoteStateType definition
CapacityReservationModificationQuoteStateType = Literal[
    "active",
    "expired",
]
```
...
```python
# DescribeCapacityReservationDateChangeQuotesPaginatorName usage example
from mypy_boto3_ec2.literals import DescribeCapacityReservationDateChangeQuotesPaginatorName

def get_value() -> DescribeCapacityReservationDateChangeQuotesPaginatorName:
    return "describe_capacity_reservation_date_change_quotes"
```

```python
# DescribeCapacityReservationDateChangeQuotesPaginatorName definition
...
```python
# NetworkCardInterfaceTypeType usage example
from mypy_boto3_ec2.literals import NetworkCardInterfaceTypeType

def get_value() -> NetworkCardInterfaceTypeType:
    return "efa"
```

```python
# NetworkCardInterfaceTypeType definition
NetworkCardInterfaceTypeType = Literal[
    "efa",
    "efa-only",
    "interface",
    "secondary",
