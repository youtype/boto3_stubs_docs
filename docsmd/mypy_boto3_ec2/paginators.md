...
Type annotations and code completion for `#!python boto3.client("ec2").get_paginator("describe_capacity_reservation_date_change_quotes")`.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2/paginator/DescribeCapacityReservationDateChangeQuotes.html#EC2.Paginator.DescribeCapacityReservationDateChangeQuotes)

```python
# DescribeCapacityReservationDateChangeQuotesPaginator usage example

from boto3.session import Session

from mypy_boto3_ec2.paginator import DescribeCapacityReservationDateChangeQuotesPaginator

def get_describe_capacity_reservation_date_change_quotes_paginator() -> DescribeCapacityReservationDateChangeQuotesPaginator:
    return Session().client("ec2").get_paginator("describe_capacity_reservation_date_change_quotes")
```

```python
# DescribeCapacityReservationDateChangeQuotesPaginator usage example with type annotations
...
client = Session().client("ec2")  # (1)
paginator: DescribeCapacityReservationDateChangeQuotesPaginator = client.get_paginator("describe_capacity_reservation_date_change_quotes")  # (2)
for item in paginator.paginate(...):
    print(item)  # (3)
```

1. client: [EC2Client](./client.md)
2. paginator: [DescribeCapacityReservationDateChangeQuotesPaginator](./paginators.md#describecapacityreservationdatechangequotespaginator)
3. item: `PageIterator[DescribeCapacityReservationDateChangeQuotesResultTypeDef]`


### paginate

Type annotations and code completion for `#!python DescribeCapacityReservationDateChangeQuotesPaginator.paginate` method.
...
def paginate(
    self,
    *,
    CapacityReservationModificationQuoteIds: Sequence[str] = ...,
    DryRun: bool = ...,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> botocore.paginate.PageIterator[DescribeCapacityReservationDateChangeQuotesResultTypeDef]:  # (3)
    ...
```

1. See `Sequence[FilterTypeDef]`
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
3. See `PageIterator[DescribeCapacityReservationDateChangeQuotesResultTypeDef]`


```python
# paginate method usage example with argument unpacking

kwargs: DescribeCapacityReservationDateChangeQuotesRequestPaginateTypeDef = {  # (1)
...
1. See [:material-code-braces: DescribeCapacityReservationDateChangeQuotesRequestPaginateTypeDef](./type_defs.md#describecapacityreservationdatechangequotesrequestpaginatetypedef)
