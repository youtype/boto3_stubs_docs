...
### list\_integration\_table\_properties

Lists the integration table properties in your account.

Type annotations and code completion for `#!python boto3.client("glue").list_integration_table_properties` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/glue/client/list_integration_table_properties.html)

```python
# list_integration_table_properties method definition

def list_integration_table_properties(
    self,
    *,
    Marker: str = ...,
    Filters: Sequence[IntegrationTablePropertiesFilterTypeDef] = ...,  # (1)
    MaxRecords: int = ...,
) -> ListIntegrationTablePropertiesResponseTypeDef:  # (2)
    ...
```

1. See `Sequence[IntegrationTablePropertiesFilterTypeDef]`
2. See [:material-code-braces: ListIntegrationTablePropertiesResponseTypeDef](./type_defs.md#listintegrationtablepropertiesresponsetypedef)


```python
# list_integration_table_properties method usage example with argument unpacking

kwargs: ListIntegrationTablePropertiesRequestTypeDef = {  # (1)
    "Marker": ...,
}

parent.list_integration_table_properties(**kwargs)
```

1. See [:material-code-braces: ListIntegrationTablePropertiesRequestTypeDef](./type_defs.md#listintegrationtablepropertiesrequesttypedef)
...
def start_data_quality_rule_recommendation_run(
    ...
    *,
    ...
    RecommendationMode: RecommendationModeType = ...,  # (3)
) -> StartDataQualityRuleRecommendationRunResponseTypeDef:  # (4)
    ...
```
...
4. See [:material-code-braces: StartDataQualityRuleRecommendationRunResponseTypeDef](./type_defs.md#startdataqualityrulerecommendationrunresponsetypedef)
