...
```python
# RecommendationModeType usage example
from mypy_boto3_glue.literals import RecommendationModeType

def get_value() -> RecommendationModeType:
    return "ADVANCED"
```

```python
# RecommendationModeType definition
RecommendationModeType = Literal[
    "ADVANCED",
    "BASIC",
]
```
...
```python
# SubObjectSourceTypeType usage example
from mypy_boto3_glue.literals import SubObjectSourceTypeType

def get_value() -> SubObjectSourceTypeType:
    return "HIVE_CSV"
```

```python
# SubObjectSourceTypeType definition
