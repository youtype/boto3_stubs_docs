...
```python
# IntegrationTablePropertiesFilterTypeDef TypedDict usage example

from mypy_boto3_glue.type_defs import IntegrationTablePropertiesFilterTypeDef


def get_value() -> IntegrationTablePropertiesFilterTypeDef:
    return {
        "Name": ...,
    }


# IntegrationTablePropertiesFilterTypeDef definition
...
```python
# SubObjectStatisticsTypeDef TypedDict usage example

from mypy_boto3_glue.type_defs import SubObjectStatisticsTypeDef


def get_value() -> SubObjectStatisticsTypeDef:
    return {
        "SourceType": ...,
    }


# SubObjectStatisticsTypeDef definition

class SubObjectStatisticsTypeDef(TypedDict):
    SourceType: NotRequired[SubObjectSourceTypeType],  # (1)
...
1. See [:material-code-brackets: SubObjectSourceTypeType](./literals.md#subobjectsourcetypetype)
...
```python
# ListIntegrationTablePropertiesRequestTypeDef TypedDict usage example

from mypy_boto3_glue.type_defs import ListIntegrationTablePropertiesRequestTypeDef


def get_value() -> ListIntegrationTablePropertiesRequestTypeDef:
    return {
        "Marker": ...,
    }


# ListIntegrationTablePropertiesRequestTypeDef definition

class ListIntegrationTablePropertiesRequestTypeDef(TypedDict):
    Marker: NotRequired[str],
    Filters: NotRequired[Sequence[IntegrationTablePropertiesFilterTypeDef]],  # (1)
    MaxRecords: NotRequired[int],
```

1. See `Sequence[IntegrationTablePropertiesFilterTypeDef]`
...
class ViewDefinitionInputTypeDef(TypedDict):
    ...
    SubObjectsStatistics: NotRequired[Sequence[SubObjectStatisticsTypeDef]],  # (3)
...
3. See `Sequence[SubObjectStatisticsTypeDef]`
...
class ViewDefinitionTypeDef(TypedDict):
    ...
    SubObjectsStatistics: NotRequired[list[SubObjectStatisticsTypeDef]],  # (2)
    Representations: NotRequired[list[ViewRepresentationTypeDef]],  # (3)
...
2. See `list[SubObjectStatisticsTypeDef]`
3. See `list[ViewRepresentationTypeDef]`
...
class DataQualityRuleRecommendationRunDescriptionTypeDef(TypedDict):
    ...
    RecommendationMode: NotRequired[RecommendationModeType],  # (3)
```

1. See [:material-code-brackets: TaskStatusTypeType](./literals.md#taskstatustypetype)
2. See [:material-code-braces: DataSourceOutputTypeDef](./type_defs.md#datasourceoutputtypedef)
3. See [:material-code-brackets: RecommendationModeType](./literals.md#recommendationmodetype)
...
class GetDataQualityRuleRecommendationRunResponseTypeDef(TypedDict):
    ...
    RecommendationMode: RecommendationModeType,  # (4)
    ResponseMetadata: ResponseMetadataTypeDef,  # (5)
```
...
4. See [:material-code-brackets: RecommendationModeType](./literals.md#recommendationmodetype)
5. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
```python
# IntegrationTablePropertiesTypeDef TypedDict usage example

from mypy_boto3_glue.type_defs import IntegrationTablePropertiesTypeDef


def get_value() -> IntegrationTablePropertiesTypeDef:
    return {
        "ResourceArn": ...,
    }


# IntegrationTablePropertiesTypeDef definition

class IntegrationTablePropertiesTypeDef(TypedDict):
    ResourceArn: str,
    TableName: str,
    SourceTableConfig: NotRequired[SourceTableConfigOutputTypeDef],  # (1)
    TargetTableConfig: NotRequired[TargetTableConfigOutputTypeDef],  # (2)
```
...
```python
# ListIntegrationTablePropertiesResponseTypeDef TypedDict usage example

from mypy_boto3_glue.type_defs import ListIntegrationTablePropertiesResponseTypeDef


def get_value() -> ListIntegrationTablePropertiesResponseTypeDef:
    return {
        "IntegrationTablePropertiesList": ...,
    }


# ListIntegrationTablePropertiesResponseTypeDef definition

class ListIntegrationTablePropertiesResponseTypeDef(TypedDict):
    IntegrationTablePropertiesList: list[IntegrationTablePropertiesTypeDef],  # (1)
    Marker: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See `list[IntegrationTablePropertiesTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
