...
```python
# ResourceConfigurationDefinitionUnionTypeDef Union usage example

from mypy_boto3_vpc_lattice.type_defs import ResourceConfigurationDefinitionUnionTypeDef


def get_value() -> ResourceConfigurationDefinitionUnionTypeDef:
    return ...


# ResourceConfigurationDefinitionUnionTypeDef definition

ResourceConfigurationDefinitionUnionTypeDef = Union[
    ResourceConfigurationDefinitionTypeDef,  # (1)
    ResourceConfigurationDefinitionOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: ResourceConfigurationDefinitionTypeDef](./type_defs.md#resourceconfigurationdefinitiontypedef)
2. See [:material-code-braces: ResourceConfigurationDefinitionOutputTypeDef](./type_defs.md#resourceconfigurationdefinitionoutputtypedef)
...
```python
# CidrResourceOutputTypeDef TypedDict usage example

from mypy_boto3_vpc_lattice.type_defs import CidrResourceOutputTypeDef


def get_value() -> CidrResourceOutputTypeDef:
    return {
        "cidrRanges": ...,
    }


# CidrResourceOutputTypeDef definition
...
```python
# CidrResourceTypeDef TypedDict usage example

from mypy_boto3_vpc_lattice.type_defs import CidrResourceTypeDef


def get_value() -> CidrResourceTypeDef:
    return {
        "cidrRanges": ...,
    }


# CidrResourceTypeDef definition
...
```python
# PayerResponsibilityEntryTypeDef TypedDict usage example

from mypy_boto3_vpc_lattice.type_defs import PayerResponsibilityEntryTypeDef


def get_value() -> PayerResponsibilityEntryTypeDef:
    return {
        "scope": ...,
    }


# PayerResponsibilityEntryTypeDef definition

class PayerResponsibilityEntryTypeDef(TypedDict):
    scope: NotRequired[PayerResponsibilityScopeType],  # (1)
    payerResponsibilityType: NotRequired[PayerResponsibilityPayerType],  # (2)
```

1. See [:material-code-brackets: PayerResponsibilityScopeType](./literals.md#payerresponsibilityscopetype)
2. See [:material-code-brackets: PayerResponsibilityPayerType](./literals.md#payerresponsibilitypayertype)
...
```python
# ResourceConfigurationDefinitionOutputTypeDef TypedDict usage example

from mypy_boto3_vpc_lattice.type_defs import ResourceConfigurationDefinitionOutputTypeDef


def get_value() -> ResourceConfigurationDefinitionOutputTypeDef:
    return {
        "dnsResource": ...,
    }


# ResourceConfigurationDefinitionOutputTypeDef definition
...
class ResourceConfigurationDefinitionOutputTypeDef(TypedDict):
    ...
    cidrResource: NotRequired[CidrResourceOutputTypeDef],  # (4)
```
...
4. See [:material-code-braces: CidrResourceOutputTypeDef](./type_defs.md#cidrresourceoutputtypedef)
...
class ResourceConfigurationDefinitionTypeDef(TypedDict):
    ...
    ipResource: NotRequired[IpResourceTypeDef],  # (2)
    arnResource: NotRequired[ArnResourceTypeDef],  # (3)
    cidrResource: NotRequired[CidrResourceTypeDef],  # (4)
```

1. See [:material-code-braces: DnsResourceTypeDef](./type_defs.md#dnsresourcetypedef)
2. See [:material-code-braces: IpResourceTypeDef](./type_defs.md#ipresourcetypedef)
3. See [:material-code-braces: ArnResourceTypeDef](./type_defs.md#arnresourcetypedef)
4. See [:material-code-braces: CidrResourceTypeDef](./type_defs.md#cidrresourcetypedef)
...
class ResourceEndpointAssociationSummaryTypeDef(TypedDict):
    ...
    createdBy: NotRequired[str],
    createdAt: NotRequired[datetime.datetime],
    payerResponsibility: NotRequired[list[PayerResponsibilityEntryTypeDef]],  # (1)
```

1. See `list[PayerResponsibilityEntryTypeDef]`
...
class CreateResourceConfigurationResponseTypeDef(TypedDict):
    ...
    resourceConfigurationDefinition: ResourceConfigurationDefinitionOutputTypeDef,  # (4)
...
4. See [:material-code-braces: ResourceConfigurationDefinitionOutputTypeDef](./type_defs.md#resourceconfigurationdefinitionoutputtypedef)
5. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
class CreateResourceConfigurationRequestTypeDef(TypedDict):
    ...
    resourceGatewayIdentifier: NotRequired[str],
    resourceConfigurationGroupIdentifier: NotRequired[str],
    resourceConfigurationDefinition: NotRequired[ResourceConfigurationDefinitionUnionTypeDef],  # (3)
...
1. See [:material-code-brackets: ResourceConfigurationTypeType](./literals.md#resourceconfigurationtypetype)
2. See [:material-code-brackets: ProtocolTypeType](./literals.md#protocoltypetype)
3. See [:material-code-braces: ResourceConfigurationDefinitionUnionTypeDef](#resourceconfigurationdefinitionuniontypedef)
...
class UpdateResourceConfigurationRequestTypeDef(TypedDict):
    resourceConfigurationIdentifier: str,
    resourceConfigurationDefinition: NotRequired[ResourceConfigurationDefinitionUnionTypeDef],  # (1)
    allowAssociationToShareableServiceNetwork: NotRequired[bool],
    portRanges: NotRequired[Sequence[str]],
```

1. See [:material-code-braces: ResourceConfigurationDefinitionUnionTypeDef](#resourceconfigurationdefinitionuniontypedef)
