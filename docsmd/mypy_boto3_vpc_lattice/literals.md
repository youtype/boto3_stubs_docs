...
```python
# PayerResponsibilityPayerType usage example
from mypy_boto3_vpc_lattice.literals import PayerResponsibilityPayerType

def get_value() -> PayerResponsibilityPayerType:
    return "ResourceGatewayAccount"
```

```python
# PayerResponsibilityPayerType definition
PayerResponsibilityPayerType = Literal[
...
from mypy_boto3_vpc_lattice.literals import PayerResponsibilityScopeType
