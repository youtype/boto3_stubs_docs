...
```python
# HarnessHookDecisionType usage example
from mypy_boto3_bedrock_agentcore.literals import HarnessHookDecisionType

def get_value() -> HarnessHookDecisionType:
    return "allow"
```

```python
# HarnessHookDecisionType definition
HarnessHookDecisionType = Literal[
    "allow",
    "deny",
]
```
...
```python
# HarnessHookEventTypeType usage example
from mypy_boto3_bedrock_agentcore.literals import HarnessHookEventTypeType

def get_value() -> HarnessHookEventTypeType:
    return "after_invocation"
```

```python
# HarnessHookEventTypeType definition
