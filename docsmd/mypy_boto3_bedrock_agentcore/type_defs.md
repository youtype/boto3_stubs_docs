...
```python
# SessionTraceIdsOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore.type_defs import SessionTraceIdsOutputTypeDef


def get_value() -> SessionTraceIdsOutputTypeDef:
    return {
        "sessionId": ...,
    }


# SessionTraceIdsOutputTypeDef definition
...
```python
# SessionTraceIdsTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore.type_defs import SessionTraceIdsTypeDef


def get_value() -> SessionTraceIdsTypeDef:
    return {
        "sessionId": ...,
    }


# SessionTraceIdsTypeDef definition
...
```python
# HarnessHookEventTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore.type_defs import HarnessHookEventTypeDef


def get_value() -> HarnessHookEventTypeDef:
    return {
        "hookEventId": ...,
    }


# HarnessHookEventTypeDef definition

class HarnessHookEventTypeDef(TypedDict):
    hookEventId: str,
    name: str,
    type: HarnessHookEventTypeType,  # (1)
    decision: NotRequired[HarnessHookDecisionType],  # (2)
    reason: NotRequired[str],
```

1. See [:material-code-brackets: HarnessHookEventTypeType](./literals.md#harnesshookeventtypetype)
2. See [:material-code-brackets: HarnessHookDecisionType](./literals.md#harnesshookdecisiontype)
...
class CloudWatchFilterConfigOutputTypeDef(TypedDict):
    ...
    timeRange: NotRequired[SessionFilterConfigOutputTypeDef],  # (1)
    sessionTraceIds: NotRequired[list[SessionTraceIdsOutputTypeDef]],  # (2)
```

1. See [:material-code-braces: SessionFilterConfigOutputTypeDef](./type_defs.md#sessionfilterconfigoutputtypedef)
2. See `list[SessionTraceIdsOutputTypeDef]`
...
class CloudWatchFilterConfigTypeDef(TypedDict):
    ...
    sessionTraceIds: NotRequired[Sequence[SessionTraceIdsTypeDef]],  # (2)
```

1. See [:material-code-braces: SessionFilterConfigTypeDef](./type_defs.md#sessionfilterconfigtypedef)
2. See `Sequence[SessionTraceIdsTypeDef]`
...
class InvokeHarnessStreamOutputTypeDef(TypedDict):
    ...
    hookEvent: NotRequired[HarnessHookEventTypeDef],  # (10)
```
...
10. See [:material-code-braces: HarnessHookEventTypeDef](./type_defs.md#harnesshookeventtypedef)
