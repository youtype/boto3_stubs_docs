...
from mypy_boto3_elasticbeanstalk.literals import ArchitectureTypeType
...
```python
# ImageBuildTypeType usage example
from mypy_boto3_elasticbeanstalk.literals import ImageBuildTypeType

def get_value() -> ImageBuildTypeType:
    return "buildpack"
```

```python
# ImageBuildTypeType definition
ImageBuildTypeType = Literal[
    "buildpack",
    "docker",
]
```
