...
def create_application_version(
    ...
    *,
    ...
    ImageConfiguration: ImageConfigurationTypeDef = ...,  # (5)
) -> ApplicationVersionDescriptionMessageTypeDef:  # (6)
    ...
```
...
6. See [:material-code-braces: ApplicationVersionDescriptionMessageTypeDef](./type_defs.md#applicationversiondescriptionmessagetypedef)
