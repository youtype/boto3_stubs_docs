...
```python
# ImageBuildConfigurationTypeDef TypedDict usage example

from mypy_boto3_elasticbeanstalk.type_defs import ImageBuildConfigurationTypeDef


def get_value() -> ImageBuildConfigurationTypeDef:
    return {
        "Type": ...,
    }


# ImageBuildConfigurationTypeDef definition

class ImageBuildConfigurationTypeDef(TypedDict):
    Type: NotRequired[ImageBuildTypeType],  # (1)
    DockerfileLocation: NotRequired[str],
    Buildpack: NotRequired[str],
    Architecture: NotRequired[ArchitectureTypeType],  # (2)
    CodeBuildServiceRole: NotRequired[str],
    ComputeType: NotRequired[ComputeTypeType],  # (3)
    TimeoutInMinutes: NotRequired[int],
```

1. See [:material-code-brackets: ImageBuildTypeType](./literals.md#imagebuildtypetype)
2. See [:material-code-brackets: ArchitectureTypeType](./literals.md#architecturetypetype)
...
from mypy_boto3_elasticbeanstalk.type_defs import ImageSourceTypeDef
...
from mypy_boto3_elasticbeanstalk.type_defs import ClusterTypeDef
...
from mypy_boto3_elasticbeanstalk.type_defs import ImageConfigurationTypeDef
...
class ImageConfigurationTypeDef(TypedDict):
    ...
    Build: NotRequired[ImageBuildConfigurationTypeDef],  # (2)
```

1. See [:material-code-braces: ImageSourceTypeDef](./type_defs.md#imagesourcetypedef)
2. See [:material-code-braces: ImageBuildConfigurationTypeDef](./type_defs.md#imagebuildconfigurationtypedef)
...
class ApplicationVersionDescriptionTypeDef(TypedDict):
    ...
    ImageSource: NotRequired[ImageSourceTypeDef],  # (3)
    ImageBuildConfiguration: NotRequired[ImageBuildConfigurationTypeDef],  # (4)
    Process: NotRequired[bool],
    DateCreated: NotRequired[datetime.datetime],
    DateUpdated: NotRequired[datetime.datetime],
    Status: NotRequired[ApplicationVersionStatusType],  # (5)
```

1. See [:material-code-braces: SourceBuildInformationTypeDef](./type_defs.md#sourcebuildinformationtypedef)
2. See [:material-code-braces: S3LocationTypeDef](./type_defs.md#s3locationtypedef)
3. See [:material-code-braces: ImageSourceTypeDef](./type_defs.md#imagesourcetypedef)
4. See [:material-code-braces: ImageBuildConfigurationTypeDef](./type_defs.md#imagebuildconfigurationtypedef)
5. See [:material-code-brackets: ApplicationVersionStatusType](./literals.md#applicationversionstatustype)
...
class EnvironmentResourceDescriptionTypeDef(TypedDict):
    ...
    Cluster: NotRequired[ClusterTypeDef],  # (2)
    Instances: NotRequired[list[InstanceTypeDef]],  # (3)
    LaunchConfigurations: NotRequired[list[LaunchConfigurationTypeDef]],  # (4)
    LaunchTemplates: NotRequired[list[LaunchTemplateTypeDef]],  # (5)
    LoadBalancers: NotRequired[list[LoadBalancerTypeDef]],  # (6)
    Triggers: NotRequired[list[TriggerTypeDef]],  # (7)
    Queues: NotRequired[list[QueueTypeDef]],  # (8)
```

1. See `list[AutoScalingGroupTypeDef]`
2. See [:material-code-braces: ClusterTypeDef](./type_defs.md#clustertypedef)
3. See `list[InstanceTypeDef]`
4. See `list[LaunchConfigurationTypeDef]`
5. See `list[LaunchTemplateTypeDef]`
6. See `list[LoadBalancerTypeDef]`
7. See `list[TriggerTypeDef]`
8. See `list[QueueTypeDef]`
...
class CreateApplicationVersionMessageTypeDef(TypedDict):
    ...
    ImageConfiguration: NotRequired[ImageConfigurationTypeDef],  # (5)
```
...
5. See [:material-code-braces: ImageConfigurationTypeDef](./type_defs.md#imageconfigurationtypedef)
