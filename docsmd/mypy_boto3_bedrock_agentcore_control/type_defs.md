...
from mypy_boto3_bedrock_agentcore_control.type_defs import VpcConfigUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ClaimMatchValueTypeUnionTypeDef
...
```python
# ClusteringConfigUnionTypeDef Union usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ClusteringConfigUnionTypeDef


def get_value() -> ClusteringConfigUnionTypeDef:
    return ...


# ClusteringConfigUnionTypeDef definition

ClusteringConfigUnionTypeDef = Union[
    ClusteringConfigTypeDef,  # (1)
    ClusteringConfigOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: ClusteringConfigTypeDef](./type_defs.md#clusteringconfigtypedef)
2. See [:material-code-braces: ClusteringConfigOutputTypeDef](./type_defs.md#clusteringconfigoutputtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ComponentConfigurationUnionTypeDef
...
```python
# ConsentPortalIdpConfigUnionTypeDef Union usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ConsentPortalIdpConfigUnionTypeDef


def get_value() -> ConsentPortalIdpConfigUnionTypeDef:
    return ...


# ConsentPortalIdpConfigUnionTypeDef definition

ConsentPortalIdpConfigUnionTypeDef = Union[
    ConsentPortalIdpConfigTypeDef,  # (1)
    ConsentPortalIdpConfigOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: ConsentPortalIdpConfigTypeDef](./type_defs.md#consentportalidpconfigtypedef)
2. See [:material-code-braces: ConsentPortalIdpConfigOutputTypeDef](./type_defs.md#consentportalidpconfigoutputtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessInlineFunctionConfigUnionTypeDef
...
```python
# HarnessManagedMemoryConfigurationUnionTypeDef Union usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessManagedMemoryConfigurationUnionTypeDef


def get_value() -> HarnessManagedMemoryConfigurationUnionTypeDef:
    return ...


# HarnessManagedMemoryConfigurationUnionTypeDef definition

HarnessManagedMemoryConfigurationUnionTypeDef = Union[
    HarnessManagedMemoryConfigurationTypeDef,  # (1)
    HarnessManagedMemoryConfigurationOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: HarnessManagedMemoryConfigurationTypeDef](./type_defs.md#harnessmanagedmemoryconfigurationtypedef)
2. See [:material-code-braces: HarnessManagedMemoryConfigurationOutputTypeDef](./type_defs.md#harnessmanagedmemoryconfigurationoutputtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessRemoteMcpConfigUnionTypeDef
...
```python
# HarnessSkillAwsSkillsSourceUnionTypeDef Union usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessSkillAwsSkillsSourceUnionTypeDef


def get_value() -> HarnessSkillAwsSkillsSourceUnionTypeDef:
    return ...


# HarnessSkillAwsSkillsSourceUnionTypeDef definition

HarnessSkillAwsSkillsSourceUnionTypeDef = Union[
    HarnessSkillAwsSkillsSourceTypeDef,  # (1)
    HarnessSkillAwsSkillsSourceOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: HarnessSkillAwsSkillsSourceTypeDef](./type_defs.md#harnessskillawsskillssourcetypedef)
2. See [:material-code-braces: HarnessSkillAwsSkillsSourceOutputTypeDef](./type_defs.md#harnessskillawsskillssourceoutputtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ManagedVpcResourceUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import MatchPathsUnionTypeDef
...
```python
# NamespaceKeyValidationUnionTypeDef Union usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import NamespaceKeyValidationUnionTypeDef


def get_value() -> NamespaceKeyValidationUnionTypeDef:
    return ...


# NamespaceKeyValidationUnionTypeDef definition

NamespaceKeyValidationUnionTypeDef = Union[
    NamespaceKeyValidationTypeDef,  # (1)
    NamespaceKeyValidationOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: NamespaceKeyValidationTypeDef](./type_defs.md#namespacekeyvalidationtypedef)
2. See [:material-code-braces: NamespaceKeyValidationOutputTypeDef](./type_defs.md#namespacekeyvalidationoutputtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import RegistryRecordOAuthCredentialProviderUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import StringListValidationUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import StringValidationUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import TargetTrafficSplitEntryUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import TokenExchangeGrantTypeConfigTypeUnionTypeDef
...
```python
# AllowedWorkloadConfigurationUnionTypeDef Union usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import AllowedWorkloadConfigurationUnionTypeDef


def get_value() -> AllowedWorkloadConfigurationUnionTypeDef:
    return ...


# AllowedWorkloadConfigurationUnionTypeDef definition

AllowedWorkloadConfigurationUnionTypeDef = Union[
    AllowedWorkloadConfigurationTypeDef,  # (1)
    AllowedWorkloadConfigurationOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: AllowedWorkloadConfigurationTypeDef](./type_defs.md#allowedworkloadconfigurationtypedef)
2. See [:material-code-braces: AllowedWorkloadConfigurationOutputTypeDef](./type_defs.md#allowedworkloadconfigurationoutputtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import TrafficSplitEntryUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessAgentCoreMemoryConfigurationUnionTypeDef
...
```python
# HarnessModelConfigurationUnionTypeDef Union usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessModelConfigurationUnionTypeDef


def get_value() -> HarnessModelConfigurationUnionTypeDef:
    return ...


# HarnessModelConfigurationUnionTypeDef definition

HarnessModelConfigurationUnionTypeDef = Union[
    HarnessModelConfigurationTypeDef,  # (1)
    HarnessModelConfigurationOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: HarnessModelConfigurationTypeDef](./type_defs.md#harnessmodelconfigurationtypedef)
2. See [:material-code-braces: HarnessModelConfigurationOutputTypeDef](./type_defs.md#harnessmodelconfigurationoutputtypedef)

## InterceptorPayloadFilterUnionTypeDef

```python
# InterceptorPayloadFilterUnionTypeDef Union usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import InterceptorPayloadFilterUnionTypeDef


def get_value() -> InterceptorPayloadFilterUnionTypeDef:
    return ...


# InterceptorPayloadFilterUnionTypeDef definition

InterceptorPayloadFilterUnionTypeDef = Union[
    InterceptorPayloadFilterTypeDef,  # (1)
    InterceptorPayloadFilterOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: InterceptorPayloadFilterTypeDef](./type_defs.md#interceptorpayloadfiltertypedef)
2. See [:material-code-braces: InterceptorPayloadFilterOutputTypeDef](./type_defs.md#interceptorpayloadfilteroutputtypedef)

## LimitEntryUnionTypeDef

```python
# LimitEntryUnionTypeDef Union usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import LimitEntryUnionTypeDef


def get_value() -> LimitEntryUnionTypeDef:
    return ...


# LimitEntryUnionTypeDef definition

LimitEntryUnionTypeDef = Union[
    LimitEntryTypeDef,  # (1)
    LimitEntryOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: LimitEntryTypeDef](./type_defs.md#limitentrytypedef)
2. See [:material-code-braces: LimitEntryOutputTypeDef](./type_defs.md#limitentryoutputtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import AuthorizingClaimMatchValueTypeUnionTypeDef
...
```python
# HarnessSkillUnionTypeDef Union usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessSkillUnionTypeDef


def get_value() -> HarnessSkillUnionTypeDef:
    return ...


# HarnessSkillUnionTypeDef definition

HarnessSkillUnionTypeDef = Union[
    HarnessSkillTypeDef,  # (1)
    HarnessSkillOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: HarnessSkillTypeDef](./type_defs.md#harnessskilltypedef)
2. See [:material-code-braces: HarnessSkillOutputTypeDef](./type_defs.md#harnessskilloutputtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import MatchPrincipalsUnionTypeDef
...
```python
# PrivateKeyJwtConfigUnionTypeDef Union usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import PrivateKeyJwtConfigUnionTypeDef


def get_value() -> PrivateKeyJwtConfigUnionTypeDef:
    return ...


# PrivateKeyJwtConfigUnionTypeDef definition

PrivateKeyJwtConfigUnionTypeDef = Union[
    PrivateKeyJwtConfigTypeDef,  # (1)
    PrivateKeyJwtConfigOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: PrivateKeyJwtConfigTypeDef](./type_defs.md#privatekeyjwtconfigtypedef)
2. See [:material-code-braces: PrivateKeyJwtConfigOutputTypeDef](./type_defs.md#privatekeyjwtconfigoutputtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import PrivateEndpointUnionTypeDef
...
```python
# NamespaceKeyEntryUnionTypeDef Union usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import NamespaceKeyEntryUnionTypeDef


def get_value() -> NamespaceKeyEntryUnionTypeDef:
    return ...


# NamespaceKeyEntryUnionTypeDef definition

NamespaceKeyEntryUnionTypeDef = Union[
    NamespaceKeyEntryTypeDef,  # (1)
    NamespaceKeyEntryOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: NamespaceKeyEntryTypeDef](./type_defs.md#namespacekeyentrytypedef)
2. See [:material-code-braces: NamespaceKeyEntryOutputTypeDef](./type_defs.md#namespacekeyentryoutputtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessGatewayOutboundAuthUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import RegistryRecordCredentialProviderUnionUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ValidationUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import WeightedRouteUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import OnBehalfOfTokenExchangeConfigTypeUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import WeightedOverrideUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import StreamDeliveryResourcesUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessMemoryConfigurationUnionTypeDef
...
```python
# InterceptorInputConfigurationUnionTypeDef Union usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import InterceptorInputConfigurationUnionTypeDef


def get_value() -> InterceptorInputConfigurationUnionTypeDef:
    return ...


# InterceptorInputConfigurationUnionTypeDef definition

InterceptorInputConfigurationUnionTypeDef = Union[
    InterceptorInputConfigurationTypeDef,  # (1)
    InterceptorInputConfigurationOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: InterceptorInputConfigurationTypeDef](./type_defs.md#interceptorinputconfigurationtypedef)
2. See [:material-code-braces: InterceptorInputConfigurationOutputTypeDef](./type_defs.md#interceptorinputconfigurationoutputtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CustomClaimValidationTypeUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ConditionUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import PrivateEndpointOverrideUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessAgentCoreGatewayConfigUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import RegistryRecordCredentialProviderConfigurationUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import LlmExtractionConfigUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import RouteToTargetActionUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ConfigurationBundleActionUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ComputeConfigurationUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CustomJWTAuthorizerConfigurationUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessToolConfigurationUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import FromUrlSynchronizationConfigurationUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ExtractionConfigUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ActionUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessToolUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import SynchronizationConfigurationUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import MetadataSchemaEntryUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import MemoryRecordSchemaUnionTypeDef
...
```python
# AgentRuntimeVersionSummaryTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import AgentRuntimeVersionSummaryTypeDef


def get_value() -> AgentRuntimeVersionSummaryTypeDef:
    return {
        "agentRuntimeArn": ...,
    }


# AgentRuntimeVersionSummaryTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import SkillDefinitionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import SkillMdDefinitionTypeDef
...
```python
# HostingEnvironmentTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HostingEnvironmentTypeDef


def get_value() -> HostingEnvironmentTypeDef:
    return {
        "arn": ...,
    }


# HostingEnvironmentTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ApprovalConfigurationTypeDef
...
```python
# SecretReferenceTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import SecretReferenceTypeDef


def get_value() -> SecretReferenceTypeDef:
    return {
        "secretId": ...,
    }


# SecretReferenceTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import OAuth2AuthorizationDataTypeDef
...
```python
# CapacityProviderConfigurationTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import CapacityProviderConfigurationTypeDef


def get_value() -> CapacityProviderConfigurationTypeDef:
    return {
        "capacityProviderArn": ...,
    }


# CapacityProviderConfigurationTypeDef definition
...
```python
# CapacityProviderSummaryTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import CapacityProviderSummaryTypeDef


def get_value() -> CapacityProviderSummaryTypeDef:
    return {
        "capacityProviderId": ...,
    }


# CapacityProviderSummaryTypeDef definition

class CapacityProviderSummaryTypeDef(TypedDict):
    capacityProviderId: str,
    capacityProviderArn: str,
    name: str,
    status: CapacityProviderStatusType,  # (1)
    lastUpdatedAt: datetime.datetime,
```
...
```python
# CapacityProviderVolumeConfigurationTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import CapacityProviderVolumeConfigurationTypeDef


def get_value() -> CapacityProviderVolumeConfigurationTypeDef:
    return {
        "volumeName": ...,
    }


# CapacityProviderVolumeConfigurationTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CapacityReservationTargetTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import SecretsManagerLocationTypeDef
...
```python
# ClusteringConfigOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ClusteringConfigOutputTypeDef


def get_value() -> ClusteringConfigOutputTypeDef:
    return {
        "frequencies": ...,
    }


# ClusteringConfigOutputTypeDef definition

class ClusteringConfigOutputTypeDef(TypedDict):
    frequencies: list[ClusteringFrequencyType],  # (1)
```

1. See `list[ClusteringFrequencyType]`

## ClusteringConfigTypeDef

```python
# ClusteringConfigTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ClusteringConfigTypeDef


def get_value() -> ClusteringConfigTypeDef:
    return {
        "frequencies": ...,
    }


# ClusteringConfigTypeDef definition

class ClusteringConfigTypeDef(TypedDict):
    frequencies: Sequence[ClusteringFrequencyType],  # (1)
```

1. See `Sequence[ClusteringFrequencyType]`
...
from mypy_boto3_bedrock_agentcore_control.type_defs import LambdaEvaluatorConfigTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ComponentConfigurationOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ComponentConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import MatchPathsOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import StaticOverrideTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ConfigurationBundleReferenceTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ConfigurationBundleSummaryTypeDef
...
```python
# ConnectorParameterOverrideTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ConnectorParameterOverrideTypeDef


def get_value() -> ConnectorParameterOverrideTypeDef:
    return {
        "path": ...,
    }


# ConnectorParameterOverrideTypeDef definition
...
```python
# ConnectorSourceTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ConnectorSourceTypeDef


def get_value() -> ConnectorSourceTypeDef:
    return {
        "connectorId": ...,
    }


# ConnectorSourceTypeDef definition
...
```python
# ConsentPortalIdpConfigOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ConsentPortalIdpConfigOutputTypeDef


def get_value() -> ConsentPortalIdpConfigOutputTypeDef:
    return {
        "credentialProviderArn": ...,
    }


# ConsentPortalIdpConfigOutputTypeDef definition
...
```python
# ConsentPortalIdpConfigTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ConsentPortalIdpConfigTypeDef


def get_value() -> ConsentPortalIdpConfigTypeDef:
    return {
        "credentialProviderArn": ...,
    }


# ConsentPortalIdpConfigTypeDef definition
...
```python
# ConsentPortalSourceTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ConsentPortalSourceTypeDef


def get_value() -> ConsentPortalSourceTypeDef:
    return {
        "identifier": ...,
    }


# ConsentPortalSourceTypeDef definition

class ConsentPortalSourceTypeDef(TypedDict):
    identifier: str,
    type: ConsentPortalSourceTypeType,  # (1)
```

1. See [:material-code-brackets: ConsentPortalSourceTypeType](./literals.md#consentportalsourcetypetype)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ContentConfigurationTypeDef
...
```python
# PermissionsConfigurationTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import PermissionsConfigurationTypeDef


def get_value() -> PermissionsConfigurationTypeDef:
    return {
        "capacityProviderOperatorRoleArn": ...,
    }


# PermissionsConfigurationTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import VersionCreatedBySourceTypeDef
...
```python
# CreateDatasetVersionRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import CreateDatasetVersionRequestTypeDef


def get_value() -> CreateDatasetVersionRequestTypeDef:
    return {
        "datasetId": ...,
    }


# CreateDatasetVersionRequestTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import WafConfigurationTypeDef
...
class WafConfigurationTypeDef(TypedDict):
    failureMode: NotRequired[WafFailureModeType],  # (1)
```

1. See [:material-code-brackets: WafFailureModeType](./literals.md#waffailuremodetype)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import SystemManagedBlockTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ManagedResourceDetailsTypeDef
...
```python
# CreateHarnessEndpointRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import CreateHarnessEndpointRequestTypeDef


def get_value() -> CreateHarnessEndpointRequestTypeDef:
    return {
        "harnessId": ...,
    }


# CreateHarnessEndpointRequestTypeDef definition
...
```python
# HarnessEndpointTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessEndpointTypeDef


def get_value() -> HarnessEndpointTypeDef:
    return {
        "harnessId": ...,
    }


# HarnessEndpointTypeDef definition
...
class HarnessEndpointTypeDef(TypedDict):
    ...
    endpointName: str,
    arn: str,
    status: HarnessEndpointStatusType,  # (1)
    createdAt: datetime.datetime,
...
1. See [:material-code-brackets: HarnessEndpointStatusType](./literals.md#harnessendpointstatustype)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessSystemContentBlockTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import IndexedKeyTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import InsightTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import IamCredentialProviderTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import PaymentCredentialProviderConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CustomDescriptorTypeDef
...
```python
# LambdaTransformConfigurationTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import LambdaTransformConfigurationTypeDef


def get_value() -> LambdaTransformConfigurationTypeDef:
    return {
        "arn": ...,
    }


# LambdaTransformConfigurationTypeDef definition
...
```python
# InlineExamplesSourceTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import InlineExamplesSourceTypeDef


def get_value() -> InlineExamplesSourceTypeDef:
    return {
        "examples": ...,
    }


# InlineExamplesSourceTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import S3SourceTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import DatasetSummaryTypeDef
...
class DatasetSummaryTypeDef(TypedDict):
    ...
    schemaType: DatasetSchemaTypeType,  # (3)
    exampleCount: int,
    createdAt: datetime.datetime,
    updatedAt: datetime.datetime,
    description: NotRequired[str],
    draftStatus: NotRequired[DraftStatusType],  # (2)
```

1. See [:material-code-brackets: DatasetStatusType](./literals.md#datasetstatustype)
2. See [:material-code-brackets: DraftStatusType](./literals.md#draftstatustype)
3. See [:material-code-brackets: DatasetSchemaTypeType](./literals.md#datasetschematypetype)

## DatasetVersionSummaryTypeDef

```python
# DatasetVersionSummaryTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import DatasetVersionSummaryTypeDef


def get_value() -> DatasetVersionSummaryTypeDef:
    return {
        "datasetVersion": ...,
    }


# DatasetVersionSummaryTypeDef definition
...
```python
# DeleteCapacityProviderInputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import DeleteCapacityProviderInputTypeDef


def get_value() -> DeleteCapacityProviderInputTypeDef:
    return {
        "capacityProviderId": ...,
    }


# DeleteCapacityProviderInputTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import DeleteConfigurationBundleRequestTypeDef
...
```python
# DeleteConsentPortalRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import DeleteConsentPortalRequestTypeDef


def get_value() -> DeleteConsentPortalRequestTypeDef:
    return {
        "consentPortalIdentifier": ...,
    }


# DeleteConsentPortalRequestTypeDef definition
...
```python
# DeleteDatasetExamplesRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import DeleteDatasetExamplesRequestTypeDef


def get_value() -> DeleteDatasetExamplesRequestTypeDef:
    return {
        "datasetId": ...,
    }


# DeleteDatasetExamplesRequestTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import DeleteDatasetRequestTypeDef
...
```python
# DeleteGatewayRateLimitRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import DeleteGatewayRateLimitRequestTypeDef


def get_value() -> DeleteGatewayRateLimitRequestTypeDef:
    return {
        "gatewayIdentifier": ...,
    }


# DeleteGatewayRateLimitRequestTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import DeleteGatewayRuleRequestTypeDef
...
```python
# DeleteHarnessEndpointRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import DeleteHarnessEndpointRequestTypeDef


def get_value() -> DeleteHarnessEndpointRequestTypeDef:
    return {
        "harnessId": ...,
    }


# DeleteHarnessEndpointRequestTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import DeleteHarnessRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import DeletePaymentConnectorRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import DeletePaymentCredentialProviderRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import DeletePaymentManagerRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import DeleteRegistryRecordRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import DeleteRegistryRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import EbsVolumeConfigurationTypeDef
...
```python
# InstanceLifecycleConfigurationTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import InstanceLifecycleConfigurationTypeDef


def get_value() -> InstanceLifecycleConfigurationTypeDef:
    return {
        "idleInstanceTimeout": ...,
    }


# InstanceLifecycleConfigurationTypeDef definition
...
```python
# RootVolumeConfigurationTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import RootVolumeConfigurationTypeDef


def get_value() -> RootVolumeConfigurationTypeDef:
    return {
        "volumeType": ...,
    }


# RootVolumeConfigurationTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import VpcConfigurationOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import VpcConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import EfsAccessPointConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import EfsConfigurationTypeDef
...
```python
# EphemeralEBSVolumeConfigurationTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import EphemeralEBSVolumeConfigurationTypeDef


def get_value() -> EphemeralEBSVolumeConfigurationTypeDef:
    return {
        "volumeType": ...,
    }


# EphemeralEBSVolumeConfigurationTypeDef definition
...
class EvaluatorSummaryTypeDef(TypedDict):
    ...
    status: EvaluatorStatusType,  # (4)
    createdAt: datetime.datetime,
    updatedAt: datetime.datetime,
    description: NotRequired[str],
    provider: NotRequired[ProviderType],  # (2)
    level: NotRequired[EvaluatorLevelType],  # (3)
...
3. See [:material-code-brackets: EvaluatorLevelType](./literals.md#evaluatorleveltype)
4. See [:material-code-brackets: EvaluatorStatusType](./literals.md#evaluatorstatustype)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import S3FilesAccessPointConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import SessionStorageConfigurationTypeDef
...
```python
# GetCapacityProviderInputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import GetCapacityProviderInputTypeDef


def get_value() -> GetCapacityProviderInputTypeDef:
    return {
        "capacityProviderId": ...,
    }


# GetCapacityProviderInputTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import GetConfigurationBundleRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import GetConfigurationBundleVersionRequestTypeDef
...
```python
# GetConsentPortalRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import GetConsentPortalRequestTypeDef


def get_value() -> GetConsentPortalRequestTypeDef:
    return {
        "consentPortalIdentifier": ...,
    }


# GetConsentPortalRequestTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import GetDatasetRequestTypeDef
...
```python
# GetGatewayRateLimitRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import GetGatewayRateLimitRequestTypeDef


def get_value() -> GetGatewayRateLimitRequestTypeDef:
    return {
        "gatewayIdentifier": ...,
    }


# GetGatewayRateLimitRequestTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import GetGatewayRuleRequestTypeDef
...
```python
# GetHarnessEndpointRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import GetHarnessEndpointRequestTypeDef


def get_value() -> GetHarnessEndpointRequestTypeDef:
    return {
        "harnessId": ...,
    }


# GetHarnessEndpointRequestTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import GetHarnessRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import GetPaymentConnectorRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import GetPaymentCredentialProviderRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import GetPaymentManagerRequestTypeDef
...
```python
# GetPolicyEngineSummaryRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import GetPolicyEngineSummaryRequestTypeDef


def get_value() -> GetPolicyEngineSummaryRequestTypeDef:
    return {
        "policyEngineId": ...,
    }


# GetPolicyEngineSummaryRequestTypeDef definition
...
```python
# GetPolicyGenerationSummaryRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import GetPolicyGenerationSummaryRequestTypeDef


def get_value() -> GetPolicyGenerationSummaryRequestTypeDef:
    return {
        "policyGenerationId": ...,
    }


# GetPolicyGenerationSummaryRequestTypeDef definition
...
```python
# GetPolicySummaryRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import GetPolicySummaryRequestTypeDef


def get_value() -> GetPolicySummaryRequestTypeDef:
    return {
        "policyEngineId": ...,
    }


# GetPolicySummaryRequestTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import GetRegistryRecordRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import GetRegistryRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessAgentCoreBrowserConfigTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessAgentCoreCodeInterpreterConfigTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessAgentCoreMemoryRetrievalConfigTypeDef
...
```python
# HarnessBedrockModelConfigOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessBedrockModelConfigOutputTypeDef


def get_value() -> HarnessBedrockModelConfigOutputTypeDef:
    return {
        "modelId": ...,
    }


# HarnessBedrockModelConfigOutputTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessBedrockModelConfigTypeDef
...
```python
# HarnessGeminiModelConfigOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessGeminiModelConfigOutputTypeDef


def get_value() -> HarnessGeminiModelConfigOutputTypeDef:
    return {
        "modelId": ...,
    }


# HarnessGeminiModelConfigOutputTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessGeminiModelConfigTypeDef
...
```python
# HarnessHookEventBridgeTargetTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessHookEventBridgeTargetTypeDef


def get_value() -> HarnessHookEventBridgeTargetTypeDef:
    return {
        "arn": ...,
    }


# HarnessHookEventBridgeTargetTypeDef definition
...
```python
# HarnessHookLambdaTargetTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessHookLambdaTargetTypeDef


def get_value() -> HarnessHookLambdaTargetTypeDef:
    return {
        "arn": ...,
    }


# HarnessHookLambdaTargetTypeDef definition

class HarnessHookLambdaTargetTypeDef(TypedDict):
    arn: str,
    timeoutSeconds: NotRequired[int],
    failureMode: NotRequired[HarnessHookFailureModeType],  # (1)
```

1. See [:material-code-brackets: HarnessHookFailureModeType](./literals.md#harnesshookfailuremodetype)

## HarnessHookSnsTargetTypeDef

```python
# HarnessHookSnsTargetTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessHookSnsTargetTypeDef


def get_value() -> HarnessHookSnsTargetTypeDef:
    return {
        "arn": ...,
    }


# HarnessHookSnsTargetTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessInlineFunctionConfigOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessInlineFunctionConfigTypeDef
...
```python
# HarnessLiteLlmModelConfigOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessLiteLlmModelConfigOutputTypeDef


def get_value() -> HarnessLiteLlmModelConfigOutputTypeDef:
    return {
        "modelId": ...,
    }


# HarnessLiteLlmModelConfigOutputTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessLiteLlmModelConfigTypeDef
...
```python
# HarnessManagedMemoryConfigurationOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessManagedMemoryConfigurationOutputTypeDef


def get_value() -> HarnessManagedMemoryConfigurationOutputTypeDef:
    return {
        "arn": ...,
    }


# HarnessManagedMemoryConfigurationOutputTypeDef definition

class HarnessManagedMemoryConfigurationOutputTypeDef(TypedDict):
    arn: NotRequired[str],
    strategies: NotRequired[list[HarnessManagedMemoryStrategyTypeType]],  # (1)
    eventExpiryDuration: NotRequired[int],
    encryptionKeyArn: NotRequired[str],
```

1. See `list[HarnessManagedMemoryStrategyTypeType]`

## HarnessManagedMemoryConfigurationTypeDef

```python
# HarnessManagedMemoryConfigurationTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessManagedMemoryConfigurationTypeDef


def get_value() -> HarnessManagedMemoryConfigurationTypeDef:
    return {
        "arn": ...,
    }


# HarnessManagedMemoryConfigurationTypeDef definition

class HarnessManagedMemoryConfigurationTypeDef(TypedDict):
    arn: NotRequired[str],
    strategies: NotRequired[Sequence[HarnessManagedMemoryStrategyTypeType]],  # (1)
    eventExpiryDuration: NotRequired[int],
    encryptionKeyArn: NotRequired[str],
```

1. See `Sequence[HarnessManagedMemoryStrategyTypeType]`

## HarnessOpenAiModelConfigOutputTypeDef

```python
# HarnessOpenAiModelConfigOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessOpenAiModelConfigOutputTypeDef


def get_value() -> HarnessOpenAiModelConfigOutputTypeDef:
    return {
        "modelId": ...,
    }


# HarnessOpenAiModelConfigOutputTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessOpenAiModelConfigTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessRemoteMcpConfigOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessRemoteMcpConfigTypeDef
...
```python
# HarnessSkillAwsSkillsSourceOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessSkillAwsSkillsSourceOutputTypeDef


def get_value() -> HarnessSkillAwsSkillsSourceOutputTypeDef:
    return {
        "paths": ...,
    }


# HarnessSkillAwsSkillsSourceOutputTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessSkillAwsSkillsSourceTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessSkillGitAuthTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessSkillS3SourceTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessSlidingWindowConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessSummarizationConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessSummaryTypeDef
...
```python
# HarnessVersionSummaryTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessVersionSummaryTypeDef


def get_value() -> HarnessVersionSummaryTypeDef:
    return {
        "harnessId": ...,
    }


# HarnessVersionSummaryTypeDef definition
...
```python
# HttpConnectorSourceTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HttpConnectorSourceTypeDef


def get_value() -> HttpConnectorSourceTypeDef:
    return {
        "connectorId": ...,
    }


# HttpConnectorSourceTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import IamPrincipalTypeDef
...
```python
# InferenceConnectorSourceTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import InferenceConnectorSourceTypeDef


def get_value() -> InferenceConnectorSourceTypeDef:
    return {
        "connectorId": ...,
    }


# InferenceConnectorSourceTypeDef definition
...
```python
# ModelEntryTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ModelEntryTypeDef


def get_value() -> ModelEntryTypeDef:
    return {
        "model": ...,
    }


# ModelEntryTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import InstanceRequirementsOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import InstanceRequirementsTypeDef
...
```python
# InterceptorPayloadExclusionSelectorTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import InterceptorPayloadExclusionSelectorTypeDef


def get_value() -> InterceptorPayloadExclusionSelectorTypeDef:
    return {
        "field": ...,
    }


# InterceptorPayloadExclusionSelectorTypeDef definition

class InterceptorPayloadExclusionSelectorTypeDef(TypedDict):
    field: NotRequired[InterceptorPayloadExclusionType],  # (1)
```

1. See [:material-code-brackets: InterceptorPayloadExclusionType](./literals.md#interceptorpayloadexclusiontype)
...
```python
# KmsKeySourceTypeTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import KmsKeySourceTypeTypeDef


def get_value() -> KmsKeySourceTypeTypeDef:
    return {
        "kmsKeyArn": ...,
    }


# KmsKeySourceTypeTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import LicenseSpecificationTypeDef
...
```python
# RateConfigTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import RateConfigTypeDef


def get_value() -> RateConfigTypeDef:
    return {
        "rate": ...,
    }


# RateConfigTypeDef definition
...
1. See [:material-code-brackets: PeriodType](./literals.md#periodtype)
...
```python
# ListAgentRuntimeVersionsByCapacityProviderInputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListAgentRuntimeVersionsByCapacityProviderInputTypeDef


def get_value() -> ListAgentRuntimeVersionsByCapacityProviderInputTypeDef:
    return {
        "capacityProviderId": ...,
    }


# ListAgentRuntimeVersionsByCapacityProviderInputTypeDef definition
...
```python
# ListCapacityProvidersInputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListCapacityProvidersInputTypeDef


def get_value() -> ListCapacityProvidersInputTypeDef:
    return {
        "maxResults": ...,
    }


# ListCapacityProvidersInputTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import VersionFilterTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListConfigurationBundlesRequestTypeDef
...
```python
# ListConsentPortalsRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListConsentPortalsRequestTypeDef


def get_value() -> ListConsentPortalsRequestTypeDef:
    return {
        "maxResults": ...,
    }


# ListConsentPortalsRequestTypeDef definition
...
```python
# ListDatasetExamplesRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListDatasetExamplesRequestTypeDef


def get_value() -> ListDatasetExamplesRequestTypeDef:
    return {
        "datasetId": ...,
    }


# ListDatasetExamplesRequestTypeDef definition
...
```python
# ListDatasetVersionsRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListDatasetVersionsRequestTypeDef


def get_value() -> ListDatasetVersionsRequestTypeDef:
    return {
        "datasetId": ...,
    }


# ListDatasetVersionsRequestTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListDatasetsRequestTypeDef
...
```python
# ListGatewayRateLimitsRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListGatewayRateLimitsRequestTypeDef


def get_value() -> ListGatewayRateLimitsRequestTypeDef:
    return {
        "gatewayIdentifier": ...,
    }


# ListGatewayRateLimitsRequestTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListGatewayRulesRequestTypeDef
...
```python
# ListHarnessEndpointsRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListHarnessEndpointsRequestTypeDef


def get_value() -> ListHarnessEndpointsRequestTypeDef:
    return {
        "harnessId": ...,
    }


# ListHarnessEndpointsRequestTypeDef definition
...
```python
# ListHarnessVersionsRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListHarnessVersionsRequestTypeDef


def get_value() -> ListHarnessVersionsRequestTypeDef:
    return {
        "harnessId": ...,
    }


# ListHarnessVersionsRequestTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListHarnessesRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListPaymentConnectorsRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import PaymentConnectorSummaryTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListPaymentCredentialProvidersRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import PaymentCredentialProviderItemTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListPaymentManagersRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import PaymentManagerSummaryTypeDef
...
```python
# ListPolicyEngineSummariesRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListPolicyEngineSummariesRequestTypeDef


def get_value() -> ListPolicyEngineSummariesRequestTypeDef:
    return {
        "nextToken": ...,
    }


# ListPolicyEngineSummariesRequestTypeDef definition
...
```python
# PolicyEngineSummaryTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import PolicyEngineSummaryTypeDef


def get_value() -> PolicyEngineSummaryTypeDef:
    return {
        "policyEngineId": ...,
    }


# PolicyEngineSummaryTypeDef definition
...
```python
# ListPolicyGenerationSummariesRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListPolicyGenerationSummariesRequestTypeDef


def get_value() -> ListPolicyGenerationSummariesRequestTypeDef:
    return {
        "policyEngineId": ...,
    }


# ListPolicyGenerationSummariesRequestTypeDef definition
...
```python
# ListPolicySummariesRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListPolicySummariesRequestTypeDef


def get_value() -> ListPolicySummariesRequestTypeDef:
    return {
        "policyEngineId": ...,
    }


# ListPolicySummariesRequestTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import PolicySummaryTypeDef
...
class PolicySummaryTypeDef(TypedDict):
    ...
    updatedAt: datetime.datetime,
    policyArn: str,
    status: PolicyStatusType,  # (1)
    enforcementMode: NotRequired[EnforcementModeType],  # (2)
```

1. See [:material-code-brackets: PolicyStatusType](./literals.md#policystatustype)
2. See [:material-code-brackets: EnforcementModeType](./literals.md#enforcementmodetype)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListRegistriesRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import RegistrySummaryTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListRegistryRecordsRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import RegistryRecordSummaryTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import SessionConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import StreamingConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ManagedVpcResourceOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ManagedVpcResourceTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import MatchPathsTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ServerDefinitionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ToolsDefinitionTypeDef
...
```python
# ProviderPrefixTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ProviderPrefixTypeDef


def get_value() -> ProviderPrefixTypeDef:
    return {
        "strip": ...,
    }


# ProviderPrefixTypeDef definition
...
```python
# NamespaceKeyValidationOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import NamespaceKeyValidationOutputTypeDef


def get_value() -> NamespaceKeyValidationOutputTypeDef:
    return {
        "allowedValues": ...,
    }


# NamespaceKeyValidationOutputTypeDef definition
...
```python
# NamespaceKeyValidationTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import NamespaceKeyValidationTypeDef


def get_value() -> NamespaceKeyValidationTypeDef:
    return {
        "allowedValues": ...,
    }


# NamespaceKeyValidationTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import NumberValidationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import TokenExchangeGrantTypeConfigTypeOutputTypeDef
...
```python
# ReasoningConfigurationTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ReasoningConfigurationTypeDef


def get_value() -> ReasoningConfigurationTypeDef:
    return {
        "effort": ...,
    }


# ReasoningConfigurationTypeDef definition
...
```python
# StickinessConfigurationOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import StickinessConfigurationOutputTypeDef


def get_value() -> StickinessConfigurationOutputTypeDef:
    return {
        "identifier": ...,
    }


# StickinessConfigurationOutputTypeDef definition
...
```python
# StickinessConfigurationTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import StickinessConfigurationTypeDef


def get_value() -> StickinessConfigurationTypeDef:
    return {
        "identifier": ...,
    }


# StickinessConfigurationTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import PolicyStatementTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import SelfManagedLatticeResourceTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import RegistryRecordIamCredentialProviderTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import RegistryRecordOAuthCredentialProviderOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import RegistryRecordOAuthCredentialProviderTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import StaticRouteTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import S3FilesConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import StringListValidationOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import StringListValidationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import StringValidationOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import StringValidationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import SubmitRegistryRecordForApprovalRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import TargetTrafficSplitEntryOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import TargetTrafficSplitEntryTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import TokenExchangeGrantTypeConfigTypeTypeDef
...
```python
# UpdateDatasetExamplesRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateDatasetExamplesRequestTypeDef


def get_value() -> UpdateDatasetExamplesRequestTypeDef:
    return {
        "datasetId": ...,
    }


# UpdateDatasetExamplesRequestTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateDatasetRequestTypeDef
...
```python
# UpdateHarnessEndpointRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateHarnessEndpointRequestTypeDef


def get_value() -> UpdateHarnessEndpointRequestTypeDef:
    return {
        "harnessId": ...,
    }


# UpdateHarnessEndpointRequestTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatedSynchronizationTypeTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateRegistryRecordStatusRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import A2aDescriptorTypeDef
...
```python
# AddDatasetExamplesResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import AddDatasetExamplesResponseTypeDef


def get_value() -> AddDatasetExamplesResponseTypeDef:
    return {
        "datasetArn": ...,
    }


# AddDatasetExamplesResponseTypeDef definition
...
```python
# CreateCapacityProviderOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import CreateCapacityProviderOutputTypeDef


def get_value() -> CreateCapacityProviderOutputTypeDef:
    return {
        "capacityProviderId": ...,
    }


# CreateCapacityProviderOutputTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CreateConfigurationBundleResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CreateDatasetResponseTypeDef
...
```python
# CreateDatasetVersionResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import CreateDatasetVersionResponseTypeDef


def get_value() -> CreateDatasetVersionResponseTypeDef:
    return {
        "datasetArn": ...,
    }


# CreateDatasetVersionResponseTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CreateRegistryRecordResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CreateRegistryResponseTypeDef
...
```python
# DeleteCapacityProviderOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import DeleteCapacityProviderOutputTypeDef


def get_value() -> DeleteCapacityProviderOutputTypeDef:
    return {
        "capacityProviderId": ...,
    }


# DeleteCapacityProviderOutputTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import DeleteConfigurationBundleResponseTypeDef
...
```python
# DeleteDatasetExamplesResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import DeleteDatasetExamplesResponseTypeDef


def get_value() -> DeleteDatasetExamplesResponseTypeDef:
    return {
        "datasetArn": ...,
    }


# DeleteDatasetExamplesResponseTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import DeleteDatasetResponseTypeDef
...
```python
# DeleteGatewayRateLimitResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import DeleteGatewayRateLimitResponseTypeDef


def get_value() -> DeleteGatewayRateLimitResponseTypeDef:
    return {
        "rateLimitId": ...,
    }


# DeleteGatewayRateLimitResponseTypeDef definition

class DeleteGatewayRateLimitResponseTypeDef(TypedDict):
    rateLimitId: str,
    status: GatewayRateLimitStatusType,  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-brackets: GatewayRateLimitStatusType](./literals.md#gatewayratelimitstatustype)
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import DeleteGatewayRuleResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import DeletePaymentConnectorResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import DeletePaymentManagerResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import DeleteRegistryResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import GetDatasetResponseTypeDef
...
class GetDatasetResponseTypeDef(TypedDict):
    ...
    description: str,
    status: DatasetStatusType,  # (1)
    draftStatus: DraftStatusType,  # (2)
    failureReason: str,
    schemaType: DatasetSchemaTypeType,  # (3)
    kmsKeyArn: str,
    exampleCount: int,
    downloadUrl: str,
    downloadUrlExpiresAt: datetime.datetime,
    createdAt: datetime.datetime,
    updatedAt: datetime.datetime,
    tags: dict[str, str],
...
```python
# GetPolicyEngineSummaryResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import GetPolicyEngineSummaryResponseTypeDef


def get_value() -> GetPolicyEngineSummaryResponseTypeDef:
    return {
        "policyEngineId": ...,
    }


# GetPolicyEngineSummaryResponseTypeDef definition
...
```python
# GetPolicySummaryResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import GetPolicySummaryResponseTypeDef


def get_value() -> GetPolicySummaryResponseTypeDef:
    return {
        "policyId": ...,
    }


# GetPolicySummaryResponseTypeDef definition
...
class GetPolicySummaryResponseTypeDef(TypedDict):
    ...
    policyArn: str,
    status: PolicyStatusType,  # (1)
    enforcementMode: EnforcementModeType,  # (2)
...
```python
# ListDatasetExamplesResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListDatasetExamplesResponseTypeDef


def get_value() -> ListDatasetExamplesResponseTypeDef:
    return {
        "datasetArn": ...,
    }


# ListDatasetExamplesResponseTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import SubmitRegistryRecordForApprovalResponseTypeDef
...
```python
# UpdateCapacityProviderOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateCapacityProviderOutputTypeDef


def get_value() -> UpdateCapacityProviderOutputTypeDef:
    return {
        "capacityProviderId": ...,
    }


# UpdateCapacityProviderOutputTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateConfigurationBundleResponseTypeDef
...
```python
# UpdateDatasetExamplesResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateDatasetExamplesResponseTypeDef


def get_value() -> UpdateDatasetExamplesResponseTypeDef:
    return {
        "datasetArn": ...,
    }


# UpdateDatasetExamplesResponseTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateDatasetResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateRegistryRecordStatusResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessEnvironmentArtifactTypeDef
...
```python
# ListAgentRuntimeVersionsByCapacityProviderOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListAgentRuntimeVersionsByCapacityProviderOutputTypeDef


def get_value() -> ListAgentRuntimeVersionsByCapacityProviderOutputTypeDef:
    return {
        "agentRuntimes": ...,
    }


# ListAgentRuntimeVersionsByCapacityProviderOutputTypeDef definition

class ListAgentRuntimeVersionsByCapacityProviderOutputTypeDef(TypedDict):
    agentRuntimes: list[AgentRuntimeVersionSummaryTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[AgentRuntimeVersionSummaryTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatedSkillDefinitionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import AgentSkillsDescriptorTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatedSkillMdDefinitionTypeDef
...
```python
# AllowedWorkloadConfigurationOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import AllowedWorkloadConfigurationOutputTypeDef


def get_value() -> AllowedWorkloadConfigurationOutputTypeDef:
    return {
        "hostingEnvironments": ...,
    }


# AllowedWorkloadConfigurationOutputTypeDef definition

class AllowedWorkloadConfigurationOutputTypeDef(TypedDict):
    hostingEnvironments: NotRequired[list[HostingEnvironmentTypeDef]],  # (1)
    workloadIdentities: NotRequired[list[str]],
```

1. See `list[HostingEnvironmentTypeDef]`

## AllowedWorkloadConfigurationTypeDef

```python
# AllowedWorkloadConfigurationTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import AllowedWorkloadConfigurationTypeDef


def get_value() -> AllowedWorkloadConfigurationTypeDef:
    return {
        "hostingEnvironments": ...,
    }


# AllowedWorkloadConfigurationTypeDef definition

class AllowedWorkloadConfigurationTypeDef(TypedDict):
    hostingEnvironments: NotRequired[Sequence[HostingEnvironmentTypeDef]],  # (1)
    workloadIdentities: NotRequired[Sequence[str]],
```

1. See `Sequence[HostingEnvironmentTypeDef]`
...
from mypy_boto3_bedrock_agentcore_control.type_defs import McpToolSchemaConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatedApprovalConfigurationTypeDef
...
class AtlassianOauth2ProviderConfigInputTypeDef(TypedDict):
    ...
    clientSecretConfig: NotRequired[SecretReferenceTypeDef],  # (1)
    clientSecretSource: NotRequired[SecretSourceTypeType],  # (2)
```
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CoinbaseCdpConfigurationInputTypeDef
...
class CoinbaseCdpConfigurationInputTypeDef(TypedDict):
    ...
    apiKeySecretSource: NotRequired[SecretSourceTypeType],  # (1)
    apiKeySecretConfig: NotRequired[SecretReferenceTypeDef],  # (2)
    walletSecret: NotRequired[str],
    walletSecretSource: NotRequired[SecretSourceTypeType],  # (1)
    walletSecretConfig: NotRequired[SecretReferenceTypeDef],  # (2)
```

1. See [:material-code-brackets: SecretSourceTypeType](./literals.md#secretsourcetypetype)
2. See [:material-code-braces: SecretReferenceTypeDef](./type_defs.md#secretreferencetypedef)
3. See [:material-code-brackets: SecretSourceTypeType](./literals.md#secretsourcetypetype)
4. See [:material-code-braces: SecretReferenceTypeDef](./type_defs.md#secretreferencetypedef)
...
class CreateApiKeyCredentialProviderRequestTypeDef(TypedDict):
    ...
    apiKeySecretConfig: NotRequired[SecretReferenceTypeDef],  # (1)
    apiKeySecretSource: NotRequired[SecretSourceTypeType],  # (2)
    tags: NotRequired[Mapping[str, str]],
```
...
from mypy_boto3_bedrock_agentcore_control.type_defs import StripePrivyConfigurationInputTypeDef
...
class StripePrivyConfigurationInputTypeDef(TypedDict):
    ...
    appSecretSource: NotRequired[SecretSourceTypeType],  # (1)
    appSecretConfig: NotRequired[SecretReferenceTypeDef],  # (2)
    authorizationPrivateKey: NotRequired[str],
    authorizationPrivateKeySource: NotRequired[SecretSourceTypeType],  # (1)
    authorizationPrivateKeyConfig: NotRequired[SecretReferenceTypeDef],  # (2)
```
...
from mypy_boto3_bedrock_agentcore_control.type_defs import AuthorizationDataTypeDef
...
```python
# ListCapacityProvidersOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListCapacityProvidersOutputTypeDef


def get_value() -> ListCapacityProvidersOutputTypeDef:
    return {
        "capacityProviders": ...,
    }


# ListCapacityProvidersOutputTypeDef definition

class ListCapacityProvidersOutputTypeDef(TypedDict):
    capacityProviders: list[CapacityProviderSummaryTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[CapacityProviderSummaryTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CapacityReservationSpecificationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CertificateLocationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CodeBasedEvaluatorConfigTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ResourceLocationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CoinbaseCdpConfigurationOutputTypeDef
...
class CoinbaseCdpConfigurationOutputTypeDef(TypedDict):
    ...
    walletSecretSource: NotRequired[SecretSourceTypeType],  # (2)
```

1. See [:material-code-braces: SecretTypeDef](./type_defs.md#secrettypedef)
2. See [:material-code-brackets: SecretSourceTypeType](./literals.md#secretsourcetypetype)
3. See [:material-code-braces: SecretTypeDef](./type_defs.md#secrettypedef)
4. See [:material-code-brackets: SecretSourceTypeType](./literals.md#secretsourcetypetype)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import StripePrivyConfigurationOutputTypeDef
...
class StripePrivyConfigurationOutputTypeDef(TypedDict):
    ...
    appSecretSource: NotRequired[SecretSourceTypeType],  # (2)
    authorizationPrivateKeyJsonKey: NotRequired[str],
    authorizationPrivateKeySource: NotRequired[SecretSourceTypeType],  # (2)
```
...
from mypy_boto3_bedrock_agentcore_control.type_defs import TrafficSplitEntryOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import TrafficSplitEntryTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListConfigurationBundlesResponseTypeDef
...
```python
# ConnectorConfigurationOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ConnectorConfigurationOutputTypeDef


def get_value() -> ConnectorConfigurationOutputTypeDef:
    return {
        "name": ...,
    }


# ConnectorConfigurationOutputTypeDef definition

class ConnectorConfigurationOutputTypeDef(TypedDict):
    name: str,
    description: NotRequired[str],
    parameterValues: NotRequired[dict[str, Any]],
    parameterOverrides: NotRequired[list[ConnectorParameterOverrideTypeDef]],  # (1)
```

1. See `list[ConnectorParameterOverrideTypeDef]`
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ConnectorConfigurationTypeDef
...
class ConnectorConfigurationTypeDef(TypedDict):
    ...
    parameterOverrides: NotRequired[Sequence[ConnectorParameterOverrideTypeDef]],  # (1)
```

1. See `Sequence[ConnectorParameterOverrideTypeDef]`

## ConsentPortalSummaryTypeDef

```python
# ConsentPortalSummaryTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ConsentPortalSummaryTypeDef


def get_value() -> ConsentPortalSummaryTypeDef:
    return {
        "sources": ...,
    }


# ConsentPortalSummaryTypeDef definition

class ConsentPortalSummaryTypeDef(TypedDict):
    sources: list[ConsentPortalSourceTypeDef],  # (1)
    consentPortalArn: str,
    consentPortalId: str,
    createdAt: datetime.datetime,
    name: str,
    status: ConsentPortalStatusType,  # (2)
    updatedAt: datetime.datetime,
    description: NotRequired[str],
    portalUrl: NotRequired[str],
```

1. See `list[ConsentPortalSourceTypeDef]`
2. See [:material-code-brackets: ConsentPortalStatusType](./literals.md#consentportalstatustype)

## CreateConsentPortalResponseTypeDef

```python
# CreateConsentPortalResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import CreateConsentPortalResponseTypeDef


def get_value() -> CreateConsentPortalResponseTypeDef:
    return {
        "sources": ...,
    }


# CreateConsentPortalResponseTypeDef definition
...
class CreateConsentPortalResponseTypeDef(TypedDict):
    ...
    idpConfig: ConsentPortalIdpConfigOutputTypeDef,  # (2)
    name: str,
    portalUrl: str,
    status: ConsentPortalStatusType,  # (3)
    statusReason: str,
    updatedAt: datetime.datetime,
    ResponseMetadata: ResponseMetadataTypeDef,  # (4)
```
...
1. See `list[ConsentPortalSourceTypeDef]`
2. See [:material-code-braces: ConsentPortalIdpConfigOutputTypeDef](./type_defs.md#consentportalidpconfigoutputtypedef)
3. See [:material-code-brackets: ConsentPortalStatusType](./literals.md#consentportalstatustype)
4. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## GetConsentPortalResponseTypeDef

```python
# GetConsentPortalResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import GetConsentPortalResponseTypeDef


def get_value() -> GetConsentPortalResponseTypeDef:
    return {
        "sources": ...,
    }


# GetConsentPortalResponseTypeDef definition
...
```python
# UpdateConsentPortalResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateConsentPortalResponseTypeDef


def get_value() -> UpdateConsentPortalResponseTypeDef:
    return {
        "sources": ...,
    }


# UpdateConsentPortalResponseTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import KinesisResourceOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import KinesisResourceTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatePaymentManagerResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import VersionLineageMetadataTypeDef
...
```python
# CreateHarnessEndpointResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import CreateHarnessEndpointResponseTypeDef


def get_value() -> CreateHarnessEndpointResponseTypeDef:
    return {
        "endpoint": ...,
    }


# CreateHarnessEndpointResponseTypeDef definition

class CreateHarnessEndpointResponseTypeDef(TypedDict):
    endpoint: HarnessEndpointTypeDef,  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: HarnessEndpointTypeDef](./type_defs.md#harnessendpointtypedef)
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## DeleteHarnessEndpointResponseTypeDef

```python
# DeleteHarnessEndpointResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import DeleteHarnessEndpointResponseTypeDef


def get_value() -> DeleteHarnessEndpointResponseTypeDef:
    return {
        "endpoint": ...,
    }


# DeleteHarnessEndpointResponseTypeDef definition
...
```python
# GetHarnessEndpointResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import GetHarnessEndpointResponseTypeDef


def get_value() -> GetHarnessEndpointResponseTypeDef:
    return {
        "endpoint": ...,
    }


# GetHarnessEndpointResponseTypeDef definition
...
```python
# ListHarnessEndpointsResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListHarnessEndpointsResponseTypeDef


def get_value() -> ListHarnessEndpointsResponseTypeDef:
    return {
        "endpoints": ...,
    }


# ListHarnessEndpointsResponseTypeDef definition

class ListHarnessEndpointsResponseTypeDef(TypedDict):
    endpoints: list[HarnessEndpointTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[HarnessEndpointTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## UpdateHarnessEndpointResponseTypeDef

```python
# UpdateHarnessEndpointResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateHarnessEndpointResponseTypeDef


def get_value() -> UpdateHarnessEndpointResponseTypeDef:
    return {
        "endpoint": ...,
    }


# UpdateHarnessEndpointResponseTypeDef definition
...
class OnlineEvaluationConfigSummaryTypeDef(TypedDict):
    ...
    clusteringConfig: NotRequired[ClusteringConfigOutputTypeDef],  # (4)
```

1. See [:material-code-brackets: OnlineEvaluationConfigStatusType](./literals.md#onlineevaluationconfigstatustype)
2. See [:material-code-brackets: OnlineEvaluationExecutionStatusType](./literals.md#onlineevaluationexecutionstatustype)
3. See `list[InsightTypeDef]`
4. See [:material-code-braces: ClusteringConfigOutputTypeDef](./type_defs.md#clusteringconfigoutputtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessGatewayOutboundAuthOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CredentialsProviderConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatedCustomDescriptorTypeDef
...
```python
# CustomTransformConfigurationTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import CustomTransformConfigurationTypeDef


def get_value() -> CustomTransformConfigurationTypeDef:
    return {
        "lambda": ...,
    }


# CustomTransformConfigurationTypeDef definition

class CustomTransformConfigurationTypeDef(TypedDict):
    lambda: NotRequired[LambdaTransformConfigurationTypeDef],  # (1)
```

1. See [:material-code-braces: LambdaTransformConfigurationTypeDef](./type_defs.md#lambdatransformconfigurationtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import DataSourceTypeTypeDef
...
class DataSourceTypeTypeDef(TypedDict):
    inlineExamples: NotRequired[InlineExamplesSourceTypeDef],  # (1)
    s3Source: NotRequired[S3SourceTypeDef],  # (2)
```

1. See [:material-code-braces: InlineExamplesSourceTypeDef](./type_defs.md#inlineexamplessourcetypedef)
2. See [:material-code-braces: S3SourceTypeDef](./type_defs.md#s3sourcetypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListDatasetsResponseTypeDef
...
```python
# ListDatasetVersionsResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListDatasetVersionsResponseTypeDef


def get_value() -> ListDatasetVersionsResponseTypeDef:
    return {
        "versions": ...,
    }


# ListDatasetVersionsResponseTypeDef definition

class ListDatasetVersionsResponseTypeDef(TypedDict):
    versions: list[DatasetVersionSummaryTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[DatasetVersionSummaryTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import VolumeConfigurationTypeDef
...
class VolumeConfigurationTypeDef(TypedDict):
    ebsConfiguration: NotRequired[EbsVolumeConfigurationTypeDef],  # (1)
```
...
```python
# EphemeralBlockDeviceMappingTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import EphemeralBlockDeviceMappingTypeDef


def get_value() -> EphemeralBlockDeviceMappingTypeDef:
    return {
        "deviceName": ...,
    }


# EphemeralBlockDeviceMappingTypeDef definition

class EphemeralBlockDeviceMappingTypeDef(TypedDict):
    deviceName: NotRequired[str],
    virtualName: NotRequired[str],
    ebs: NotRequired[EphemeralEBSVolumeConfigurationTypeDef],  # (1)
```

1. See [:material-code-braces: EphemeralEBSVolumeConfigurationTypeDef](./type_defs.md#ephemeralebsvolumeconfigurationtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import FilesystemConfigurationTypeDef
...
class FilesystemConfigurationTypeDef(TypedDict):
    ...
    capacityProviderVolume: NotRequired[CapacityProviderVolumeConfigurationTypeDef],  # (4)
```
...
4. See [:material-code-braces: CapacityProviderVolumeConfigurationTypeDef](./type_defs.md#capacityprovidervolumeconfigurationtypedef)
...
```python
# GetPolicyGenerationSummaryResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import GetPolicyGenerationSummaryResponseTypeDef


def get_value() -> GetPolicyGenerationSummaryResponseTypeDef:
    return {
        "policyEngineId": ...,
    }


# GetPolicyGenerationSummaryResponseTypeDef definition
...
```python
# PolicyGenerationSummaryTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import PolicyGenerationSummaryTypeDef


def get_value() -> PolicyGenerationSummaryTypeDef:
    return {
        "policyEngineId": ...,
    }


# PolicyGenerationSummaryTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessAgentCoreMemoryConfigurationOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessAgentCoreMemoryConfigurationTypeDef
...
```python
# HarnessHookTargetTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessHookTargetTypeDef


def get_value() -> HarnessHookTargetTypeDef:
    return {
        "lambda": ...,
    }


# HarnessHookTargetTypeDef definition

class HarnessHookTargetTypeDef(TypedDict):
    lambda: NotRequired[HarnessHookLambdaTargetTypeDef],  # (1)
    sns: NotRequired[HarnessHookSnsTargetTypeDef],  # (2)
    eventBridge: NotRequired[HarnessHookEventBridgeTargetTypeDef],  # (3)
```

1. See [:material-code-braces: HarnessHookLambdaTargetTypeDef](./type_defs.md#harnesshooklambdatargettypedef)
2. See [:material-code-braces: HarnessHookSnsTargetTypeDef](./type_defs.md#harnesshooksnstargettypedef)
3. See [:material-code-braces: HarnessHookEventBridgeTargetTypeDef](./type_defs.md#harnesshookeventbridgetargettypedef)

## HarnessModelConfigurationOutputTypeDef

```python
# HarnessModelConfigurationOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessModelConfigurationOutputTypeDef


def get_value() -> HarnessModelConfigurationOutputTypeDef:
    return {
        "bedrockModelConfig": ...,
    }


# HarnessModelConfigurationOutputTypeDef definition

class HarnessModelConfigurationOutputTypeDef(TypedDict):
    bedrockModelConfig: NotRequired[HarnessBedrockModelConfigOutputTypeDef],  # (1)
    openAiModelConfig: NotRequired[HarnessOpenAiModelConfigOutputTypeDef],  # (2)
    geminiModelConfig: NotRequired[HarnessGeminiModelConfigOutputTypeDef],  # (3)
    liteLlmModelConfig: NotRequired[HarnessLiteLlmModelConfigOutputTypeDef],  # (4)
```

1. See [:material-code-braces: HarnessBedrockModelConfigOutputTypeDef](./type_defs.md#harnessbedrockmodelconfigoutputtypedef)
2. See [:material-code-braces: HarnessOpenAiModelConfigOutputTypeDef](./type_defs.md#harnessopenaimodelconfigoutputtypedef)
3. See [:material-code-braces: HarnessGeminiModelConfigOutputTypeDef](./type_defs.md#harnessgeminimodelconfigoutputtypedef)
4. See [:material-code-braces: HarnessLiteLlmModelConfigOutputTypeDef](./type_defs.md#harnesslitellmmodelconfigoutputtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessModelConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessSkillGitSourceTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessTruncationStrategyConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListHarnessesResponseTypeDef
...
```python
# ListHarnessVersionsResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListHarnessVersionsResponseTypeDef


def get_value() -> ListHarnessVersionsResponseTypeDef:
    return {
        "harnessVersions": ...,
    }


# ListHarnessVersionsResponseTypeDef definition

class ListHarnessVersionsResponseTypeDef(TypedDict):
    harnessVersions: list[HarnessVersionSummaryTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[HarnessVersionSummaryTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## HttpConnectorTargetConfigurationOutputTypeDef

```python
# HttpConnectorTargetConfigurationOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HttpConnectorTargetConfigurationOutputTypeDef


def get_value() -> HttpConnectorTargetConfigurationOutputTypeDef:
    return {
        "source": ...,
    }


# HttpConnectorTargetConfigurationOutputTypeDef definition

class HttpConnectorTargetConfigurationOutputTypeDef(TypedDict):
    source: HttpConnectorSourceTypeDef,  # (1)
    parameters: NotRequired[dict[str, str]],
```

1. See [:material-code-braces: HttpConnectorSourceTypeDef](./type_defs.md#httpconnectorsourcetypedef)

## HttpConnectorTargetConfigurationTypeDef

```python
# HttpConnectorTargetConfigurationTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HttpConnectorTargetConfigurationTypeDef


def get_value() -> HttpConnectorTargetConfigurationTypeDef:
    return {
        "source": ...,
    }


# HttpConnectorTargetConfigurationTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import MatchPrincipalEntryTypeDef
...
```python
# InferenceConnectorTargetConfigurationTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import InferenceConnectorTargetConfigurationTypeDef


def get_value() -> InferenceConnectorTargetConfigurationTypeDef:
    return {
        "source": ...,
    }


# InferenceConnectorTargetConfigurationTypeDef definition

class InferenceConnectorTargetConfigurationTypeDef(TypedDict):
    source: InferenceConnectorSourceTypeDef,  # (1)
```

1. See [:material-code-braces: InferenceConnectorSourceTypeDef](./type_defs.md#inferenceconnectorsourcetypedef)

## InferenceOperationConfigurationOutputTypeDef

```python
# InferenceOperationConfigurationOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import InferenceOperationConfigurationOutputTypeDef


def get_value() -> InferenceOperationConfigurationOutputTypeDef:
    return {
        "path": ...,
    }


# InferenceOperationConfigurationOutputTypeDef definition

class InferenceOperationConfigurationOutputTypeDef(TypedDict):
    path: str,
    providerPath: NotRequired[str],
    models: NotRequired[list[ModelEntryTypeDef]],  # (1)
```

1. See `list[ModelEntryTypeDef]`

## InferenceOperationConfigurationTypeDef

```python
# InferenceOperationConfigurationTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import InferenceOperationConfigurationTypeDef


def get_value() -> InferenceOperationConfigurationTypeDef:
    return {
        "path": ...,
    }


# InferenceOperationConfigurationTypeDef definition

class InferenceOperationConfigurationTypeDef(TypedDict):
    path: str,
    providerPath: NotRequired[str],
    models: NotRequired[Sequence[ModelEntryTypeDef]],  # (1)
```

1. See `Sequence[ModelEntryTypeDef]`
...
```python
# InterceptorPayloadFilterOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import InterceptorPayloadFilterOutputTypeDef


def get_value() -> InterceptorPayloadFilterOutputTypeDef:
    return {
        "exclude": ...,
    }


# InterceptorPayloadFilterOutputTypeDef definition

class InterceptorPayloadFilterOutputTypeDef(TypedDict):
    exclude: list[InterceptorPayloadExclusionSelectorTypeDef],  # (1)
```

1. See `list[InterceptorPayloadExclusionSelectorTypeDef]`

## InterceptorPayloadFilterTypeDef

```python
# InterceptorPayloadFilterTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import InterceptorPayloadFilterTypeDef


def get_value() -> InterceptorPayloadFilterTypeDef:
    return {
        "exclude": ...,
    }


# InterceptorPayloadFilterTypeDef definition

class InterceptorPayloadFilterTypeDef(TypedDict):
    exclude: Sequence[InterceptorPayloadExclusionSelectorTypeDef],  # (1)
```

1. See `Sequence[InterceptorPayloadExclusionSelectorTypeDef]`

## PrivateKeySourceTypeDef

```python
# PrivateKeySourceTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import PrivateKeySourceTypeDef


def get_value() -> PrivateKeySourceTypeDef:
    return {
        "kmsKeySource": ...,
    }


# PrivateKeySourceTypeDef definition

class PrivateKeySourceTypeDef(TypedDict):
    kmsKeySource: NotRequired[KmsKeySourceTypeTypeDef],  # (1)
```

1. See [:material-code-braces: KmsKeySourceTypeTypeDef](./type_defs.md#kmskeysourcetypetypedef)

## LimitEntryOutputTypeDef

```python
# LimitEntryOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import LimitEntryOutputTypeDef


def get_value() -> LimitEntryOutputTypeDef:
    return {
        "dimensions": ...,
    }


# LimitEntryOutputTypeDef definition

class LimitEntryOutputTypeDef(TypedDict):
    dimensions: dict[str, str],
    requests: NotRequired[list[RateConfigTypeDef]],  # (1)
    tokens: NotRequired[list[RateConfigTypeDef]],  # (1)
    connections: NotRequired[list[RateConfigTypeDef]],  # (1)
```

1. See `list[RateConfigTypeDef]`
2. See `list[RateConfigTypeDef]`
3. See `list[RateConfigTypeDef]`

## LimitEntryTypeDef

```python
# LimitEntryTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import LimitEntryTypeDef


def get_value() -> LimitEntryTypeDef:
    return {
        "dimensions": ...,
    }


# LimitEntryTypeDef definition

class LimitEntryTypeDef(TypedDict):
    dimensions: Mapping[str, str],
    requests: NotRequired[Sequence[RateConfigTypeDef]],  # (1)
    tokens: NotRequired[Sequence[RateConfigTypeDef]],  # (1)
    connections: NotRequired[Sequence[RateConfigTypeDef]],  # (1)
```

1. See `Sequence[RateConfigTypeDef]`
2. See `Sequence[RateConfigTypeDef]`
3. See `Sequence[RateConfigTypeDef]`
...
```python
# ListAgentRuntimeVersionsByCapacityProviderInputPaginateTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListAgentRuntimeVersionsByCapacityProviderInputPaginateTypeDef


def get_value() -> ListAgentRuntimeVersionsByCapacityProviderInputPaginateTypeDef:
    return {
        "capacityProviderId": ...,
    }


# ListAgentRuntimeVersionsByCapacityProviderInputPaginateTypeDef definition
...
```python
# ListCapacityProvidersInputPaginateTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListCapacityProvidersInputPaginateTypeDef


def get_value() -> ListCapacityProvidersInputPaginateTypeDef:
    return {
        "PaginationConfig": ...,
    }


# ListCapacityProvidersInputPaginateTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListConfigurationBundlesRequestPaginateTypeDef
...
```python
# ListConsentPortalsRequestPaginateTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListConsentPortalsRequestPaginateTypeDef


def get_value() -> ListConsentPortalsRequestPaginateTypeDef:
    return {
        "PaginationConfig": ...,
    }


# ListConsentPortalsRequestPaginateTypeDef definition
...
```python
# ListDatasetExamplesRequestPaginateTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListDatasetExamplesRequestPaginateTypeDef


def get_value() -> ListDatasetExamplesRequestPaginateTypeDef:
    return {
        "datasetId": ...,
    }


# ListDatasetExamplesRequestPaginateTypeDef definition
...
```python
# ListDatasetVersionsRequestPaginateTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListDatasetVersionsRequestPaginateTypeDef


def get_value() -> ListDatasetVersionsRequestPaginateTypeDef:
    return {
        "datasetId": ...,
    }


# ListDatasetVersionsRequestPaginateTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListDatasetsRequestPaginateTypeDef
...
```python
# ListGatewayRateLimitsRequestPaginateTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListGatewayRateLimitsRequestPaginateTypeDef


def get_value() -> ListGatewayRateLimitsRequestPaginateTypeDef:
    return {
        "gatewayIdentifier": ...,
    }


# ListGatewayRateLimitsRequestPaginateTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListGatewayRulesRequestPaginateTypeDef
...
```python
# ListHarnessEndpointsRequestPaginateTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListHarnessEndpointsRequestPaginateTypeDef


def get_value() -> ListHarnessEndpointsRequestPaginateTypeDef:
    return {
        "harnessId": ...,
    }


# ListHarnessEndpointsRequestPaginateTypeDef definition
...
```python
# ListHarnessVersionsRequestPaginateTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListHarnessVersionsRequestPaginateTypeDef


def get_value() -> ListHarnessVersionsRequestPaginateTypeDef:
    return {
        "harnessId": ...,
    }


# ListHarnessVersionsRequestPaginateTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListHarnessesRequestPaginateTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListPaymentConnectorsRequestPaginateTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListPaymentCredentialProvidersRequestPaginateTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListPaymentManagersRequestPaginateTypeDef
...
```python
# ListPolicyEngineSummariesRequestPaginateTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListPolicyEngineSummariesRequestPaginateTypeDef


def get_value() -> ListPolicyEngineSummariesRequestPaginateTypeDef:
    return {
        "PaginationConfig": ...,
    }


# ListPolicyEngineSummariesRequestPaginateTypeDef definition
...
```python
# ListPolicyGenerationSummariesRequestPaginateTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListPolicyGenerationSummariesRequestPaginateTypeDef


def get_value() -> ListPolicyGenerationSummariesRequestPaginateTypeDef:
    return {
        "policyEngineId": ...,
    }


# ListPolicyGenerationSummariesRequestPaginateTypeDef definition
...
```python
# ListPolicySummariesRequestPaginateTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListPolicySummariesRequestPaginateTypeDef


def get_value() -> ListPolicySummariesRequestPaginateTypeDef:
    return {
        "policyEngineId": ...,
    }


# ListPolicySummariesRequestPaginateTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListRegistriesRequestPaginateTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListRegistryRecordsRequestPaginateTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListConfigurationBundleVersionsRequestPaginateTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListConfigurationBundleVersionsRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListPaymentConnectorsResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListPaymentCredentialProvidersResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListPaymentManagersResponseTypeDef
...
```python
# ListPolicyEngineSummariesResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListPolicyEngineSummariesResponseTypeDef


def get_value() -> ListPolicyEngineSummariesResponseTypeDef:
    return {
        "policyEngines": ...,
    }


# ListPolicyEngineSummariesResponseTypeDef definition

class ListPolicyEngineSummariesResponseTypeDef(TypedDict):
    policyEngines: list[PolicyEngineSummaryTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[PolicyEngineSummaryTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
```python
# ListPolicySummariesResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListPolicySummariesResponseTypeDef


def get_value() -> ListPolicySummariesResponseTypeDef:
    return {
        "policies": ...,
    }


# ListPolicySummariesResponseTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListRegistriesResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListRegistryRecordsResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatedServerDefinitionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import McpDescriptorTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatedToolsDefinitionTypeDef
...
```python
# ModelMappingTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ModelMappingTypeDef


def get_value() -> ModelMappingTypeDef:
    return {
        "providerPrefix": ...,
    }


# ModelMappingTypeDef definition

class ModelMappingTypeDef(TypedDict):
    providerPrefix: NotRequired[ProviderPrefixTypeDef],  # (1)
```

1. See [:material-code-braces: ProviderPrefixTypeDef](./type_defs.md#providerprefixtypedef)

## NamespaceKeyEntryOutputTypeDef

```python
# NamespaceKeyEntryOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import NamespaceKeyEntryOutputTypeDef


def get_value() -> NamespaceKeyEntryOutputTypeDef:
    return {
        "key": ...,
    }


# NamespaceKeyEntryOutputTypeDef definition

class NamespaceKeyEntryOutputTypeDef(TypedDict):
    key: str,
    validation: NotRequired[NamespaceKeyValidationOutputTypeDef],  # (1)
```

1. See [:material-code-braces: NamespaceKeyValidationOutputTypeDef](./type_defs.md#namespacekeyvalidationoutputtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import OnBehalfOfTokenExchangeConfigTypeOutputTypeDef
...
```python
# OpenResponsesEvaluatorModelConfigTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import OpenResponsesEvaluatorModelConfigTypeDef


def get_value() -> OpenResponsesEvaluatorModelConfigTypeDef:
    return {
        "modelId": ...,
    }


# OpenResponsesEvaluatorModelConfigTypeDef definition
...
class OpenResponsesEvaluatorModelConfigTypeDef(TypedDict):
    ...
    temperature: NotRequired[float],
    topP: NotRequired[float],
    reasoning: NotRequired[ReasoningConfigurationTypeDef],  # (1)
```

1. See [:material-code-braces: ReasoningConfigurationTypeDef](./type_defs.md#reasoningconfigurationtypedef)
...
class PolicyDefinitionTypeDef(TypedDict):
    ...
    policy: NotRequired[PolicyStatementTypeDef],  # (3)
```
...
3. See [:material-code-braces: PolicyStatementTypeDef](./type_defs.md#policystatementtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import PrivateEndpointOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import RegistryRecordCredentialProviderUnionOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ToolsFileSystemConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ValidationOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import WeightedRouteOutputTypeDef
...
```python
# UpdateCapacityProviderInputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateCapacityProviderInputTypeDef


def get_value() -> UpdateCapacityProviderInputTypeDef:
    return {
        "capacityProviderId": ...,
    }


# UpdateCapacityProviderInputTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatedA2aDescriptorTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatedHarnessEnvironmentArtifactTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatedAgentSkillsDescriptorFieldsTypeDef
...
```python
# HttpApiSchemaConfigurationTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HttpApiSchemaConfigurationTypeDef


def get_value() -> HttpApiSchemaConfigurationTypeDef:
    return {
        "source": ...,
    }


# HttpApiSchemaConfigurationTypeDef definition

class HttpApiSchemaConfigurationTypeDef(TypedDict):
    source: ApiSchemaConfigurationTypeDef,  # (1)
```
...
from mypy_boto3_bedrock_agentcore_control.type_defs import PaymentProviderConfigurationInputTypeDef
...
class TargetSummaryTypeDef(TypedDict):
    ...
    authorizationData: NotRequired[AuthorizationDataTypeDef],  # (2)
    targetType: NotRequired[TargetTypeType],  # (3)
    listingMode: NotRequired[ListingModeType],  # (4)
```

1. See [:material-code-brackets: TargetStatusType](./literals.md#targetstatustype)
2. See [:material-code-braces: AuthorizationDataTypeDef](./type_defs.md#authorizationdatatypedef)
3. See [:material-code-brackets: TargetTypeType](./literals.md#targettypetype)
4. See [:material-code-brackets: ListingModeType](./literals.md#listingmodetype)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CertificateTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import BrowserEnterprisePolicyTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import PaymentProviderConfigurationOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CreateConfigurationBundleRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateConfigurationBundleRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import WeightedOverrideOutputTypeDef
...
```python
# ConnectorTargetConfigurationOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ConnectorTargetConfigurationOutputTypeDef


def get_value() -> ConnectorTargetConfigurationOutputTypeDef:
    return {
        "source": ...,
    }


# ConnectorTargetConfigurationOutputTypeDef definition

class ConnectorTargetConfigurationOutputTypeDef(TypedDict):
    source: ConnectorSourceTypeDef,  # (1)
    enabled: NotRequired[list[str]],
    configurations: NotRequired[list[ConnectorConfigurationOutputTypeDef]],  # (2)
```

1. See [:material-code-braces: ConnectorSourceTypeDef](./type_defs.md#connectorsourcetypedef)
2. See `list[ConnectorConfigurationOutputTypeDef]`

## ConnectorTargetConfigurationTypeDef

```python
# ConnectorTargetConfigurationTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ConnectorTargetConfigurationTypeDef


def get_value() -> ConnectorTargetConfigurationTypeDef:
    return {
        "source": ...,
    }


# ConnectorTargetConfigurationTypeDef definition

class ConnectorTargetConfigurationTypeDef(TypedDict):
    source: ConnectorSourceTypeDef,  # (1)
    enabled: NotRequired[Sequence[str]],
    configurations: NotRequired[Sequence[ConnectorConfigurationTypeDef]],  # (2)
```

1. See [:material-code-braces: ConnectorSourceTypeDef](./type_defs.md#connectorsourcetypedef)
2. See `Sequence[ConnectorConfigurationTypeDef]`

## CreateConsentPortalRequestTypeDef

```python
# CreateConsentPortalRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import CreateConsentPortalRequestTypeDef


def get_value() -> CreateConsentPortalRequestTypeDef:
    return {
        "executionRoleArn": ...,
    }


# CreateConsentPortalRequestTypeDef definition
...
```python
# UpdateConsentPortalRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateConsentPortalRequestTypeDef


def get_value() -> UpdateConsentPortalRequestTypeDef:
    return {
        "consentPortalIdentifier": ...,
    }


# UpdateConsentPortalRequestTypeDef definition

class UpdateConsentPortalRequestTypeDef(TypedDict):
    consentPortalIdentifier: str,
    executionRoleArn: NotRequired[str],
    idpConfig: NotRequired[ConsentPortalIdpConfigUnionTypeDef],  # (1)
    description: NotRequired[str],
```
...
```python
# ListConsentPortalsResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListConsentPortalsResponseTypeDef


def get_value() -> ListConsentPortalsResponseTypeDef:
    return {
        "consentPortals": ...,
    }


# ListConsentPortalsResponseTypeDef definition

class ListConsentPortalsResponseTypeDef(TypedDict):
    consentPortals: list[ConsentPortalSummaryTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[ConsentPortalSummaryTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import StreamDeliveryResourceOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import StreamDeliveryResourceTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ConfigurationBundleVersionSummaryTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import GetConfigurationBundleResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import GetConfigurationBundleVersionResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessAgentCoreGatewayConfigOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CreatePaymentConnectorRequestTypeDef
...
class CreatePaymentConnectorRequestTypeDef(TypedDict):
    ...
    description: NotRequired[str],
    provisionMode: NotRequired[PaymentConnectorProvisionModeType],  # (3)
    clientToken: NotRequired[str],
```
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CreatePaymentConnectorResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import GetPaymentConnectorResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatePaymentConnectorRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatePaymentConnectorResponseTypeDef
...
```python
# AddDatasetExamplesRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import AddDatasetExamplesRequestTypeDef


def get_value() -> AddDatasetExamplesRequestTypeDef:
    return {
        "datasetId": ...,
    }


# AddDatasetExamplesRequestTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CreateDatasetRequestTypeDef
...
```python
# LaunchParametersOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import LaunchParametersOutputTypeDef


def get_value() -> LaunchParametersOutputTypeDef:
    return {
        "operatingSystem": ...,
    }


# LaunchParametersOutputTypeDef definition

class LaunchParametersOutputTypeDef(TypedDict):
    operatingSystem: OperatingSystemType,  # (1)
    instanceRequirements: InstanceRequirementsOutputTypeDef,  # (2)
    ephemeralVolumes: NotRequired[list[EphemeralBlockDeviceMappingTypeDef]],  # (3)
    monitoring: NotRequired[MonitoringType],  # (4)
    licenseSpecifications: NotRequired[list[LicenseSpecificationTypeDef]],  # (5)
...
3. See `list[EphemeralBlockDeviceMappingTypeDef]`
4. See [:material-code-brackets: MonitoringType](./literals.md#monitoringtype)
5. See `list[LicenseSpecificationTypeDef]`
...
```python
# LaunchParametersTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import LaunchParametersTypeDef


def get_value() -> LaunchParametersTypeDef:
    return {
        "operatingSystem": ...,
    }


# LaunchParametersTypeDef definition

class LaunchParametersTypeDef(TypedDict):
    operatingSystem: OperatingSystemType,  # (1)
    instanceRequirements: InstanceRequirementsTypeDef,  # (2)
    ephemeralVolumes: NotRequired[Sequence[EphemeralBlockDeviceMappingTypeDef]],  # (3)
    monitoring: NotRequired[MonitoringType],  # (4)
    licenseSpecifications: NotRequired[Sequence[LicenseSpecificationTypeDef]],  # (5)
    capacityReservationSpecification: NotRequired[CapacityReservationSpecificationTypeDef],  # (6)
    sshKeyName: NotRequired[str],
    instanceProfileArn: NotRequired[str],
...
3. See `Sequence[EphemeralBlockDeviceMappingTypeDef]`
4. See [:material-code-brackets: MonitoringType](./literals.md#monitoringtype)
5. See `Sequence[LicenseSpecificationTypeDef]`
6. See [:material-code-braces: CapacityReservationSpecificationTypeDef](./type_defs.md#capacityreservationspecificationtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessAgentCoreRuntimeEnvironmentTypeDef
...
```python
# ListPolicyGenerationSummariesResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListPolicyGenerationSummariesResponseTypeDef


def get_value() -> ListPolicyGenerationSummariesResponseTypeDef:
    return {
        "policyGenerations": ...,
    }


# ListPolicyGenerationSummariesResponseTypeDef definition

class ListPolicyGenerationSummariesResponseTypeDef(TypedDict):
    policyGenerations: list[PolicyGenerationSummaryTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[PolicyGenerationSummaryTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessMemoryConfigurationOutputTypeDef
...
class HarnessMemoryConfigurationOutputTypeDef(TypedDict):
    ...
    managedMemoryConfiguration: NotRequired[HarnessManagedMemoryConfigurationOutputTypeDef],  # (2)
...
```python
# HarnessAfterInvocationHookTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessAfterInvocationHookTypeDef


def get_value() -> HarnessAfterInvocationHookTypeDef:
    return {
        "name": ...,
    }


# HarnessAfterInvocationHookTypeDef definition

class HarnessAfterInvocationHookTypeDef(TypedDict):
    name: str,
    target: HarnessHookTargetTypeDef,  # (1)
```

1. See [:material-code-braces: HarnessHookTargetTypeDef](./type_defs.md#harnesshooktargettypedef)

## HarnessAfterToolCallHookTypeDef

```python
# HarnessAfterToolCallHookTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessAfterToolCallHookTypeDef


def get_value() -> HarnessAfterToolCallHookTypeDef:
    return {
        "name": ...,
    }


# HarnessAfterToolCallHookTypeDef definition
...
```python
# HarnessBeforeInvocationHookTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessBeforeInvocationHookTypeDef


def get_value() -> HarnessBeforeInvocationHookTypeDef:
    return {
        "name": ...,
    }


# HarnessBeforeInvocationHookTypeDef definition
...
```python
# HarnessBeforeToolCallHookTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessBeforeToolCallHookTypeDef


def get_value() -> HarnessBeforeToolCallHookTypeDef:
    return {
        "name": ...,
    }


# HarnessBeforeToolCallHookTypeDef definition
...
```python
# HarnessSkillOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessSkillOutputTypeDef


def get_value() -> HarnessSkillOutputTypeDef:
    return {
        "path": ...,
    }


# HarnessSkillOutputTypeDef definition
...
class HarnessSkillOutputTypeDef(TypedDict):
    ...
    awsSkills: NotRequired[HarnessSkillAwsSkillsSourceOutputTypeDef],  # (3)
```
...
3. See [:material-code-braces: HarnessSkillAwsSkillsSourceOutputTypeDef](./type_defs.md#harnessskillawsskillssourceoutputtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessSkillTypeDef
...
class HarnessSkillTypeDef(TypedDict):
    ...
    s3: NotRequired[HarnessSkillS3SourceTypeDef],  # (1)
    git: NotRequired[HarnessSkillGitSourceTypeDef],  # (2)
    awsSkills: NotRequired[HarnessSkillAwsSkillsSourceUnionTypeDef],  # (3)
```

1. See [:material-code-braces: HarnessSkillS3SourceTypeDef](./type_defs.md#harnessskills3sourcetypedef)
2. See [:material-code-braces: HarnessSkillGitSourceTypeDef](./type_defs.md#harnessskillgitsourcetypedef)
3. See [:material-code-braces: HarnessSkillAwsSkillsSourceUnionTypeDef](#harnessskillawsskillssourceuniontypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessTruncationConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import MatchPrincipalsOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import MatchPrincipalsTypeDef
...
```python
# InterceptorInputConfigurationOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import InterceptorInputConfigurationOutputTypeDef


def get_value() -> InterceptorInputConfigurationOutputTypeDef:
    return {
        "passRequestHeaders": ...,
    }


# InterceptorInputConfigurationOutputTypeDef definition

class InterceptorInputConfigurationOutputTypeDef(TypedDict):
    passRequestHeaders: bool,
    payloadFilter: NotRequired[InterceptorPayloadFilterOutputTypeDef],  # (1)
```

1. See [:material-code-braces: InterceptorPayloadFilterOutputTypeDef](./type_defs.md#interceptorpayloadfilteroutputtypedef)

## PrivateKeyJwtConfigOutputTypeDef

```python
# PrivateKeyJwtConfigOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import PrivateKeyJwtConfigOutputTypeDef


def get_value() -> PrivateKeyJwtConfigOutputTypeDef:
    return {
        "privateKeySource": ...,
    }


# PrivateKeyJwtConfigOutputTypeDef definition

class PrivateKeyJwtConfigOutputTypeDef(TypedDict):
    privateKeySource: NotRequired[PrivateKeySourceTypeDef],  # (1)
    signingAlgorithm: NotRequired[SigningAlgorithmType],  # (2)
    additionalHeaderClaims: NotRequired[dict[str, str]],
    additionalPayloadClaims: NotRequired[dict[str, str]],
```

1. See [:material-code-braces: PrivateKeySourceTypeDef](./type_defs.md#privatekeysourcetypedef)
2. See [:material-code-brackets: SigningAlgorithmType](./literals.md#signingalgorithmtype)

## PrivateKeyJwtConfigTypeDef

```python
# PrivateKeyJwtConfigTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import PrivateKeyJwtConfigTypeDef


def get_value() -> PrivateKeyJwtConfigTypeDef:
    return {
        "privateKeySource": ...,
    }


# PrivateKeyJwtConfigTypeDef definition
...
```python
# CreateGatewayRateLimitResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import CreateGatewayRateLimitResponseTypeDef


def get_value() -> CreateGatewayRateLimitResponseTypeDef:
    return {
        "rateLimitId": ...,
    }


# CreateGatewayRateLimitResponseTypeDef definition
...
class CreateGatewayRateLimitResponseTypeDef(TypedDict):
    ...
    entries: list[LimitEntryOutputTypeDef],  # (1)
    status: GatewayRateLimitStatusType,  # (2)
    createdAt: datetime.datetime,
    updatedAt: datetime.datetime,
    ResponseMetadata: ResponseMetadataTypeDef,  # (3)
```

1. See `list[LimitEntryOutputTypeDef]`
2. See [:material-code-brackets: GatewayRateLimitStatusType](./literals.md#gatewayratelimitstatustype)
3. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## GatewayRateLimitDetailTypeDef

```python
# GatewayRateLimitDetailTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import GatewayRateLimitDetailTypeDef


def get_value() -> GatewayRateLimitDetailTypeDef:
    return {
        "rateLimitId": ...,
    }


# GatewayRateLimitDetailTypeDef definition
...
```python
# GetGatewayRateLimitResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import GetGatewayRateLimitResponseTypeDef


def get_value() -> GetGatewayRateLimitResponseTypeDef:
    return {
        "rateLimitId": ...,
    }


# GetGatewayRateLimitResponseTypeDef definition
...
```python
# UpdateGatewayRateLimitResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateGatewayRateLimitResponseTypeDef


def get_value() -> UpdateGatewayRateLimitResponseTypeDef:
    return {
        "rateLimitId": ...,
    }


# UpdateGatewayRateLimitResponseTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import PrivateEndpointTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import DescriptorsTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatedMcpDescriptorFieldsTypeDef
...
```python
# InferenceProviderTargetConfigurationOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import InferenceProviderTargetConfigurationOutputTypeDef


def get_value() -> InferenceProviderTargetConfigurationOutputTypeDef:
    return {
        "endpoint": ...,
    }


# InferenceProviderTargetConfigurationOutputTypeDef definition

class InferenceProviderTargetConfigurationOutputTypeDef(TypedDict):
    endpoint: str,
    modelMapping: NotRequired[ModelMappingTypeDef],  # (1)
    operations: NotRequired[list[InferenceOperationConfigurationOutputTypeDef]],  # (2)
```

1. See [:material-code-braces: ModelMappingTypeDef](./type_defs.md#modelmappingtypedef)
2. See `list[InferenceOperationConfigurationOutputTypeDef]`

## InferenceProviderTargetConfigurationTypeDef

```python
# InferenceProviderTargetConfigurationTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import InferenceProviderTargetConfigurationTypeDef


def get_value() -> InferenceProviderTargetConfigurationTypeDef:
    return {
        "endpoint": ...,
    }


# InferenceProviderTargetConfigurationTypeDef definition

class InferenceProviderTargetConfigurationTypeDef(TypedDict):
    endpoint: str,
    modelMapping: NotRequired[ModelMappingTypeDef],  # (1)
    operations: NotRequired[Sequence[InferenceOperationConfigurationTypeDef]],  # (2)
```

1. See [:material-code-braces: ModelMappingTypeDef](./type_defs.md#modelmappingtypedef)
2. See `Sequence[InferenceOperationConfigurationTypeDef]`

## NamespaceKeyEntryTypeDef

```python
# NamespaceKeyEntryTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import NamespaceKeyEntryTypeDef


def get_value() -> NamespaceKeyEntryTypeDef:
    return {
        "key": ...,
    }


# NamespaceKeyEntryTypeDef definition

class NamespaceKeyEntryTypeDef(TypedDict):
    key: str,
    validation: NotRequired[NamespaceKeyValidationUnionTypeDef],  # (1)
```

1. See [:material-code-braces: NamespaceKeyValidationUnionTypeDef](#namespacekeyvalidationuniontypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessGatewayOutboundAuthTypeDef
...
class EvaluatorModelConfigOutputTypeDef(TypedDict):
    ...
    responsesEvaluatorModelConfig: NotRequired[OpenResponsesEvaluatorModelConfigTypeDef],  # (2)
```
...
2. See [:material-code-braces: OpenResponsesEvaluatorModelConfigTypeDef](./type_defs.md#openresponsesevaluatormodelconfigtypedef)
...
class CreatePolicyRequestTypeDef(TypedDict):
    ...
    enforcementMode: NotRequired[EnforcementModeType],  # (3)
    clientToken: NotRequired[str],
```
...
class CreatePolicyResponseTypeDef(TypedDict):
    ...
    status: PolicyStatusType,  # (1)
    enforcementMode: EnforcementModeType,  # (2)
    definition: PolicyDefinitionTypeDef,  # (3)
    description: str,
    statusReasons: list[str],
    ResponseMetadata: ResponseMetadataTypeDef,  # (4)
```
...
1. See [:material-code-brackets: PolicyStatusType](./literals.md#policystatustype)
2. See [:material-code-brackets: EnforcementModeType](./literals.md#enforcementmodetype)
3. See [:material-code-braces: PolicyDefinitionTypeDef](./type_defs.md#policydefinitiontypedef)
4. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
class UpdatePolicyRequestTypeDef(TypedDict):
    ...
    enforcementMode: NotRequired[EnforcementModeType],  # (4)
```
...
from mypy_boto3_bedrock_agentcore_control.type_defs import PrivateEndpointOverrideOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import RegistryRecordCredentialProviderConfigurationOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import RegistryRecordCredentialProviderUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import LlmExtractionConfigOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ValidationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import RouteToTargetActionOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import WeightedRouteTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import OnBehalfOfTokenExchangeConfigTypeTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatedAgentSkillsDescriptorTypeDef
...
```python
# PassthroughTargetConfigurationOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import PassthroughTargetConfigurationOutputTypeDef


def get_value() -> PassthroughTargetConfigurationOutputTypeDef:
    return {
        "endpoint": ...,
    }


# PassthroughTargetConfigurationOutputTypeDef definition

class PassthroughTargetConfigurationOutputTypeDef(TypedDict):
    endpoint: str,
    protocolType: PassthroughProtocolTypeType,  # (1)
    schema: NotRequired[HttpApiSchemaConfigurationTypeDef],  # (2)
    stickinessConfiguration: NotRequired[StickinessConfigurationOutputTypeDef],  # (3)
    staticQueryParameters: NotRequired[dict[str, str]],
    staticQueryParameterConflictResolution: NotRequired[StaticQueryParameterConflictResolutionType],  # (4)
```

1. See [:material-code-brackets: PassthroughProtocolTypeType](./literals.md#passthroughprotocoltypetype)
2. See [:material-code-braces: HttpApiSchemaConfigurationTypeDef](./type_defs.md#httpapischemaconfigurationtypedef)
3. See [:material-code-braces: StickinessConfigurationOutputTypeDef](./type_defs.md#stickinessconfigurationoutputtypedef)
4. See [:material-code-brackets: StaticQueryParameterConflictResolutionType](./literals.md#staticqueryparameterconflictresolutiontype)

## PassthroughTargetConfigurationTypeDef

```python
# PassthroughTargetConfigurationTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import PassthroughTargetConfigurationTypeDef


def get_value() -> PassthroughTargetConfigurationTypeDef:
    return {
        "endpoint": ...,
    }


# PassthroughTargetConfigurationTypeDef definition

class PassthroughTargetConfigurationTypeDef(TypedDict):
    endpoint: str,
    protocolType: PassthroughProtocolTypeType,  # (1)
    schema: NotRequired[HttpApiSchemaConfigurationTypeDef],  # (2)
    stickinessConfiguration: NotRequired[StickinessConfigurationTypeDef],  # (3)
...
1. See [:material-code-brackets: PassthroughProtocolTypeType](./literals.md#passthroughprotocoltypetype)
2. See [:material-code-braces: HttpApiSchemaConfigurationTypeDef](./type_defs.md#httpapischemaconfigurationtypedef)
3. See [:material-code-braces: StickinessConfigurationTypeDef](./type_defs.md#stickinessconfigurationtypedef)
4. See [:material-code-brackets: StaticQueryParameterConflictResolutionType](./literals.md#staticqueryparameterconflictresolutiontype)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import RuntimeTargetConfigurationTypeDef
...
class RuntimeTargetConfigurationTypeDef(TypedDict):
    ...
    schema: NotRequired[HttpApiSchemaConfigurationTypeDef],  # (1)
```

1. See [:material-code-braces: HttpApiSchemaConfigurationTypeDef](./type_defs.md#httpapischemaconfigurationtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CreatePaymentCredentialProviderRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatePaymentCredentialProviderRequestTypeDef
...
class CreateCodeInterpreterRequestTypeDef(TypedDict):
    ...
    filesystemConfigurations: NotRequired[Sequence[ToolsFileSystemConfigurationTypeDef]],  # (3)
    clientToken: NotRequired[str],
    tags: NotRequired[Mapping[str, str]],
```
...
class GetCodeInterpreterResponseTypeDef(TypedDict):
    ...
    filesystemConfigurations: list[ToolsFileSystemConfigurationTypeDef],  # (4)
    failureReason: str,
    createdAt: datetime.datetime,
    lastUpdatedAt: datetime.datetime,
...
4. See `list[ToolsFileSystemConfigurationTypeDef]`
...
class CreateBrowserRequestTypeDef(TypedDict):
    ...
    filesystemConfigurations: NotRequired[Sequence[ToolsFileSystemConfigurationTypeDef]],  # (6)
    clientToken: NotRequired[str],
    tags: NotRequired[Mapping[str, str]],
```
...
class GetBrowserResponseTypeDef(TypedDict):
    ...
    filesystemConfigurations: list[ToolsFileSystemConfigurationTypeDef],  # (6)
    status: BrowserStatusType,  # (7)
    failureReason: str,
    createdAt: datetime.datetime,
    lastUpdatedAt: datetime.datetime,
...
6. See `list[ToolsFileSystemConfigurationTypeDef]`
7. See [:material-code-brackets: BrowserStatusType](./literals.md#browserstatustype)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CreatePaymentCredentialProviderResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import GetPaymentCredentialProviderResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatePaymentCredentialProviderResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ConfigurationBundleActionOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import WeightedOverrideTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import StreamDeliveryResourcesOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import StreamDeliveryResourcesTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListConfigurationBundleVersionsResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessToolConfigurationOutputTypeDef
...
```python
# LaunchTemplateSourceOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import LaunchTemplateSourceOutputTypeDef


def get_value() -> LaunchTemplateSourceOutputTypeDef:
    return {
        "launchParameters": ...,
    }


# LaunchTemplateSourceOutputTypeDef definition

class LaunchTemplateSourceOutputTypeDef(TypedDict):
    launchParameters: NotRequired[LaunchParametersOutputTypeDef],  # (1)
```

1. See [:material-code-braces: LaunchParametersOutputTypeDef](./type_defs.md#launchparametersoutputtypedef)

## LaunchTemplateSourceTypeDef

```python
# LaunchTemplateSourceTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import LaunchTemplateSourceTypeDef


def get_value() -> LaunchTemplateSourceTypeDef:
    return {
        "launchParameters": ...,
    }


# LaunchTemplateSourceTypeDef definition

class LaunchTemplateSourceTypeDef(TypedDict):
    launchParameters: NotRequired[LaunchParametersTypeDef],  # (1)
```

1. See [:material-code-braces: LaunchParametersTypeDef](./type_defs.md#launchparameterstypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessEnvironmentProviderTypeDef
...
class GetOnlineEvaluationConfigResponseTypeDef(TypedDict):
    ...
    insights: list[InsightTypeDef],  # (4)
    clusteringConfig: ClusteringConfigOutputTypeDef,  # (5)
    outputConfig: OutputConfigTypeDef,  # (6)
    evaluationExecutionRoleArn: str,
    status: OnlineEvaluationConfigStatusType,  # (7)
    executionStatus: OnlineEvaluationExecutionStatusType,  # (8)
    createdAt: datetime.datetime,
    updatedAt: datetime.datetime,
    failureReason: str,
...
4. See `list[InsightTypeDef]`
5. See [:material-code-braces: ClusteringConfigOutputTypeDef](./type_defs.md#clusteringconfigoutputtypedef)
6. See [:material-code-braces: OutputConfigTypeDef](./type_defs.md#outputconfigtypedef)
7. See [:material-code-brackets: OnlineEvaluationConfigStatusType](./literals.md#onlineevaluationconfigstatustype)
8. See [:material-code-brackets: OnlineEvaluationExecutionStatusType](./literals.md#onlineevaluationexecutionstatustype)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessMemoryConfigurationTypeDef
...
class HarnessMemoryConfigurationTypeDef(TypedDict):
    ...
    managedMemoryConfiguration: NotRequired[HarnessManagedMemoryConfigurationUnionTypeDef],  # (2)
...
2. See [:material-code-braces: HarnessManagedMemoryConfigurationUnionTypeDef](#harnessmanagedmemoryconfigurationuniontypedef)

## HarnessHookTypeDef

```python
# HarnessHookTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessHookTypeDef


def get_value() -> HarnessHookTypeDef:
    return {
        "beforeInvocation": ...,
    }


# HarnessHookTypeDef definition

class HarnessHookTypeDef(TypedDict):
    beforeInvocation: NotRequired[HarnessBeforeInvocationHookTypeDef],  # (1)
    afterInvocation: NotRequired[HarnessAfterInvocationHookTypeDef],  # (2)
    beforeToolCall: NotRequired[HarnessBeforeToolCallHookTypeDef],  # (3)
    afterToolCall: NotRequired[HarnessAfterToolCallHookTypeDef],  # (4)
```

1. See [:material-code-braces: HarnessBeforeInvocationHookTypeDef](./type_defs.md#harnessbeforeinvocationhooktypedef)
2. See [:material-code-braces: HarnessAfterInvocationHookTypeDef](./type_defs.md#harnessafterinvocationhooktypedef)
3. See [:material-code-braces: HarnessBeforeToolCallHookTypeDef](./type_defs.md#harnessbeforetoolcallhooktypedef)
4. See [:material-code-braces: HarnessAfterToolCallHookTypeDef](./type_defs.md#harnessaftertoolcallhooktypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ConditionOutputTypeDef
...
class GatewayInterceptorConfigurationOutputTypeDef(TypedDict):
    ...
    inputConfiguration: NotRequired[InterceptorInputConfigurationOutputTypeDef],  # (3)
```
...
3. See [:material-code-braces: InterceptorInputConfigurationOutputTypeDef](./type_defs.md#interceptorinputconfigurationoutputtypedef)
...
class InterceptorInputConfigurationTypeDef(TypedDict):
    passRequestHeaders: bool,
    payloadFilter: NotRequired[InterceptorPayloadFilterUnionTypeDef],  # (1)
```

1. See [:material-code-braces: InterceptorPayloadFilterUnionTypeDef](#interceptorpayloadfilteruniontypedef)

## BatchPutGatewayRateLimitsResponseTypeDef

```python
# BatchPutGatewayRateLimitsResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import BatchPutGatewayRateLimitsResponseTypeDef


def get_value() -> BatchPutGatewayRateLimitsResponseTypeDef:
    return {
        "rateLimits": ...,
    }


# BatchPutGatewayRateLimitsResponseTypeDef definition

class BatchPutGatewayRateLimitsResponseTypeDef(TypedDict):
    rateLimits: list[GatewayRateLimitDetailTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See `list[GatewayRateLimitDetailTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## ListGatewayRateLimitsResponseTypeDef

```python
# ListGatewayRateLimitsResponseTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import ListGatewayRateLimitsResponseTypeDef


def get_value() -> ListGatewayRateLimitsResponseTypeDef:
    return {
        "rateLimits": ...,
    }


# ListGatewayRateLimitsResponseTypeDef definition
...
```python
# BatchPutLimitEntryTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import BatchPutLimitEntryTypeDef


def get_value() -> BatchPutLimitEntryTypeDef:
    return {
        "rateLimitId": ...,
    }


# BatchPutLimitEntryTypeDef definition
...
```python
# CreateGatewayRateLimitRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import CreateGatewayRateLimitRequestTypeDef


def get_value() -> CreateGatewayRateLimitRequestTypeDef:
    return {
        "gatewayIdentifier": ...,
    }


# CreateGatewayRateLimitRequestTypeDef definition
...
```python
# UpdateGatewayRateLimitRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateGatewayRateLimitRequestTypeDef


def get_value() -> UpdateGatewayRateLimitRequestTypeDef:
    return {
        "gatewayIdentifier": ...,
    }


# UpdateGatewayRateLimitRequestTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatedMcpDescriptorTypeDef
...
```python
# InferenceTargetConfigurationOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import InferenceTargetConfigurationOutputTypeDef


def get_value() -> InferenceTargetConfigurationOutputTypeDef:
    return {
        "connector": ...,
    }


# InferenceTargetConfigurationOutputTypeDef definition

class InferenceTargetConfigurationOutputTypeDef(TypedDict):
    connector: NotRequired[InferenceConnectorTargetConfigurationTypeDef],  # (1)
    provider: NotRequired[InferenceProviderTargetConfigurationOutputTypeDef],  # (2)
```

1. See [:material-code-braces: InferenceConnectorTargetConfigurationTypeDef](./type_defs.md#inferenceconnectortargetconfigurationtypedef)
2. See [:material-code-braces: InferenceProviderTargetConfigurationOutputTypeDef](./type_defs.md#inferenceprovidertargetconfigurationoutputtypedef)

## InferenceTargetConfigurationTypeDef

```python
# InferenceTargetConfigurationTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import InferenceTargetConfigurationTypeDef


def get_value() -> InferenceTargetConfigurationTypeDef:
    return {
        "connector": ...,
    }


# InferenceTargetConfigurationTypeDef definition

class InferenceTargetConfigurationTypeDef(TypedDict):
    connector: NotRequired[InferenceConnectorTargetConfigurationTypeDef],  # (1)
    provider: NotRequired[InferenceProviderTargetConfigurationTypeDef],  # (2)
```

1. See [:material-code-braces: InferenceConnectorTargetConfigurationTypeDef](./type_defs.md#inferenceconnectortargetconfigurationtypedef)
2. See [:material-code-braces: InferenceProviderTargetConfigurationTypeDef](./type_defs.md#inferenceprovidertargetconfigurationtypedef)

## DerivedEvaluatorConfigOutputTypeDef

```python
# DerivedEvaluatorConfigOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import DerivedEvaluatorConfigOutputTypeDef


def get_value() -> DerivedEvaluatorConfigOutputTypeDef:
    return {
        "baseEvaluatorId": ...,
    }


# DerivedEvaluatorConfigOutputTypeDef definition

class DerivedEvaluatorConfigOutputTypeDef(TypedDict):
    baseEvaluatorId: str,
    modelConfig: EvaluatorModelConfigOutputTypeDef,  # (1)
```

1. See [:material-code-braces: EvaluatorModelConfigOutputTypeDef](./type_defs.md#evaluatormodelconfigoutputtypedef)
...
```python
# DerivedEvaluatorConfigTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import DerivedEvaluatorConfigTypeDef


def get_value() -> DerivedEvaluatorConfigTypeDef:
    return {
        "baseEvaluatorId": ...,
    }


# DerivedEvaluatorConfigTypeDef definition

class DerivedEvaluatorConfigTypeDef(TypedDict):
    baseEvaluatorId: str,
    modelConfig: EvaluatorModelConfigTypeDef,  # (1)
```
...
class CustomJWTAuthorizerConfigurationOutputTypeDef(TypedDict):
    ...
    allowedWorkloadConfiguration: NotRequired[AllowedWorkloadConfigurationOutputTypeDef],  # (4)
```

1. See `list[CustomClaimValidationTypeOutputTypeDef]`
2. See [:material-code-braces: PrivateEndpointOutputTypeDef](./type_defs.md#privateendpointoutputtypedef)
3. See `list[PrivateEndpointOverrideOutputTypeDef]`
4. See [:material-code-braces: AllowedWorkloadConfigurationOutputTypeDef](./type_defs.md#allowedworkloadconfigurationoutputtypedef)
...
class CustomOauth2ProviderConfigOutputTypeDef(TypedDict):
    oauthDiscovery: Oauth2DiscoveryOutputTypeDef,  # (1)
    clientId: NotRequired[str],
    onBehalfOfTokenExchangeConfig: NotRequired[OnBehalfOfTokenExchangeConfigTypeOutputTypeDef],  # (2)
    clientAuthenticationMethod: NotRequired[ClientAuthenticationMethodTypeType],  # (3)
    privateEndpoint: NotRequired[PrivateEndpointOutputTypeDef],  # (4)
    privateEndpointOverrides: NotRequired[list[PrivateEndpointOverrideOutputTypeDef]],  # (5)
    privateKeyJwtConfig: NotRequired[PrivateKeyJwtConfigOutputTypeDef],  # (6)
```

1. See [:material-code-braces: Oauth2DiscoveryOutputTypeDef](./type_defs.md#oauth2discoveryoutputtypedef)
2. See [:material-code-braces: OnBehalfOfTokenExchangeConfigTypeOutputTypeDef](./type_defs.md#onbehalfoftokenexchangeconfigtypeoutputtypedef)
3. See [:material-code-brackets: ClientAuthenticationMethodTypeType](./literals.md#clientauthenticationmethodtypetype)
4. See [:material-code-braces: PrivateEndpointOutputTypeDef](./type_defs.md#privateendpointoutputtypedef)
5. See `list[PrivateEndpointOverrideOutputTypeDef]`
6. See [:material-code-braces: PrivateKeyJwtConfigOutputTypeDef](./type_defs.md#privatekeyjwtconfigoutputtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import FromUrlSynchronizationConfigurationOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ExtractionConfigOutputTypeDef
...
```python
# HttpTargetConfigurationOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import HttpTargetConfigurationOutputTypeDef


def get_value() -> HttpTargetConfigurationOutputTypeDef:
    return {
        "agentcoreRuntime": ...,
    }


# HttpTargetConfigurationOutputTypeDef definition

class HttpTargetConfigurationOutputTypeDef(TypedDict):
    agentcoreRuntime: NotRequired[RuntimeTargetConfigurationTypeDef],  # (1)
    passthrough: NotRequired[PassthroughTargetConfigurationOutputTypeDef],  # (2)
    connector: NotRequired[HttpConnectorTargetConfigurationOutputTypeDef],  # (3)
```

1. See [:material-code-braces: RuntimeTargetConfigurationTypeDef](./type_defs.md#runtimetargetconfigurationtypedef)
2. See [:material-code-braces: PassthroughTargetConfigurationOutputTypeDef](./type_defs.md#passthroughtargetconfigurationoutputtypedef)
3. See [:material-code-braces: HttpConnectorTargetConfigurationOutputTypeDef](./type_defs.md#httpconnectortargetconfigurationoutputtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HttpTargetConfigurationTypeDef
...
class HttpTargetConfigurationTypeDef(TypedDict):
    agentcoreRuntime: NotRequired[RuntimeTargetConfigurationTypeDef],  # (1)
    passthrough: NotRequired[PassthroughTargetConfigurationTypeDef],  # (2)
    connector: NotRequired[HttpConnectorTargetConfigurationTypeDef],  # (3)
```

1. See [:material-code-braces: RuntimeTargetConfigurationTypeDef](./type_defs.md#runtimetargetconfigurationtypedef)
2. See [:material-code-braces: PassthroughTargetConfigurationTypeDef](./type_defs.md#passthroughtargetconfigurationtypedef)
3. See [:material-code-braces: HttpConnectorTargetConfigurationTypeDef](./type_defs.md#httpconnectortargetconfigurationtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessAgentCoreRuntimeEnvironmentRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ActionOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessToolOutputTypeDef
...
```python
# Ec2ConfigurationOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import Ec2ConfigurationOutputTypeDef


def get_value() -> Ec2ConfigurationOutputTypeDef:
    return {
        "launchTemplateSource": ...,
    }


# Ec2ConfigurationOutputTypeDef definition

class Ec2ConfigurationOutputTypeDef(TypedDict):
    launchTemplateSource: LaunchTemplateSourceOutputTypeDef,  # (1)
    vpcConfiguration: VpcConfigurationOutputTypeDef,  # (2)
    volumes: NotRequired[list[VolumeConfigurationTypeDef]],  # (3)
    lifecycleConfiguration: NotRequired[InstanceLifecycleConfigurationTypeDef],  # (4)
    rootVolume: NotRequired[RootVolumeConfigurationTypeDef],  # (5)
```

1. See [:material-code-braces: LaunchTemplateSourceOutputTypeDef](./type_defs.md#launchtemplatesourceoutputtypedef)
2. See [:material-code-braces: VpcConfigurationOutputTypeDef](./type_defs.md#vpcconfigurationoutputtypedef)
3. See `list[VolumeConfigurationTypeDef]`
4. See [:material-code-braces: InstanceLifecycleConfigurationTypeDef](./type_defs.md#instancelifecycleconfigurationtypedef)
5. See [:material-code-braces: RootVolumeConfigurationTypeDef](./type_defs.md#rootvolumeconfigurationtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import Ec2ConfigurationTypeDef
...
class Ec2ConfigurationTypeDef(TypedDict):
    launchTemplateSource: LaunchTemplateSourceTypeDef,  # (1)
    vpcConfiguration: VpcConfigurationTypeDef,  # (2)
    volumes: NotRequired[Sequence[VolumeConfigurationTypeDef]],  # (3)
    lifecycleConfiguration: NotRequired[InstanceLifecycleConfigurationTypeDef],  # (4)
    rootVolume: NotRequired[RootVolumeConfigurationTypeDef],  # (5)
```

1. See [:material-code-braces: LaunchTemplateSourceTypeDef](./type_defs.md#launchtemplatesourcetypedef)
...
class CreateOnlineEvaluationConfigRequestTypeDef(TypedDict):
    ...
    insights: NotRequired[Sequence[InsightTypeDef]],  # (4)
    clusteringConfig: NotRequired[ClusteringConfigUnionTypeDef],  # (5)
    outputConfig: NotRequired[OutputConfigTypeDef],  # (6)
    tags: NotRequired[Mapping[str, str]],
```
...
class UpdateOnlineEvaluationConfigRequestTypeDef(TypedDict):
    ...
    executionStatus: NotRequired[OnlineEvaluationExecutionStatusType],  # (7)
```
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ConditionTypeDef
...
```python
# BatchPutGatewayRateLimitsRequestTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import BatchPutGatewayRateLimitsRequestTypeDef


def get_value() -> BatchPutGatewayRateLimitsRequestTypeDef:
    return {
        "gatewayIdentifier": ...,
    }


# BatchPutGatewayRateLimitsRequestTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import PrivateEndpointOverrideTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatedDescriptorsUnionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessAgentCoreGatewayConfigTypeDef
...
class EvaluatorConfigOutputTypeDef(TypedDict):
    ...
    derived: NotRequired[DerivedEvaluatorConfigOutputTypeDef],  # (3)
```
...
3. See [:material-code-braces: DerivedEvaluatorConfigOutputTypeDef](./type_defs.md#derivedevaluatorconfigoutputtypedef)
...
class EvaluatorConfigTypeDef(TypedDict):
    ...
    codeBased: NotRequired[CodeBasedEvaluatorConfigTypeDef],  # (2)
    derived: NotRequired[DerivedEvaluatorConfigTypeDef],  # (3)
```

1. See [:material-code-braces: LlmAsAJudgeEvaluatorConfigTypeDef](./type_defs.md#llmasajudgeevaluatorconfigtypedef)
2. See [:material-code-braces: CodeBasedEvaluatorConfigTypeDef](./type_defs.md#codebasedevaluatorconfigtypedef)
3. See [:material-code-braces: DerivedEvaluatorConfigTypeDef](./type_defs.md#derivedevaluatorconfigtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import SynchronizationConfigurationOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import RegistryRecordCredentialProviderConfigurationTypeDef
...
class McpTargetConfigurationOutputTypeDef(TypedDict):
    ...
    connector: NotRequired[ConnectorTargetConfigurationOutputTypeDef],  # (6)
```
...
6. See [:material-code-braces: ConnectorTargetConfigurationOutputTypeDef](./type_defs.md#connectortargetconfigurationoutputtypedef)
...
class McpTargetConfigurationTypeDef(TypedDict):
    ...
    connector: NotRequired[ConnectorTargetConfigurationTypeDef],  # (6)
```
...
6. See [:material-code-braces: ConnectorTargetConfigurationTypeDef](./type_defs.md#connectortargetconfigurationtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import MetadataSchemaEntryOutputTypeDef
...
class MetadataSchemaEntryOutputTypeDef(TypedDict):
    ...
    extractionType: NotRequired[ExtractionTypeType],  # (2)
    extractionConfig: NotRequired[ExtractionConfigOutputTypeDef],  # (3)
```

1. See [:material-code-brackets: MetadataValueTypeType](./literals.md#metadatavaluetypetype)
2. See [:material-code-brackets: ExtractionTypeType](./literals.md#extractiontypetype)
3. See [:material-code-braces: ExtractionConfigOutputTypeDef](./type_defs.md#extractionconfigoutputtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import LlmExtractionConfigTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import RouteToTargetActionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessEnvironmentProviderRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CreateGatewayRuleResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import GatewayRuleDetailTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import GetGatewayRuleResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateGatewayRuleResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ConfigurationBundleActionTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ComputeConfigurationOutputTypeDef
...
class ComputeConfigurationOutputTypeDef(TypedDict):
    ec2Configuration: NotRequired[Ec2ConfigurationOutputTypeDef],  # (1)
```

1. See [:material-code-braces: Ec2ConfigurationOutputTypeDef](./type_defs.md#ec2configurationoutputtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ComputeConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatedHarnessMemoryConfigurationTypeDef
...
class GatewayInterceptorConfigurationTypeDef(TypedDict):
    ...
    inputConfiguration: NotRequired[InterceptorInputConfigurationUnionTypeDef],  # (3)
```

1. See [:material-code-braces: InterceptorConfigurationTypeDef](./type_defs.md#interceptorconfigurationtypedef)
2. See `Sequence[GatewayInterceptionPointType]`
3. See [:material-code-braces: InterceptorInputConfigurationUnionTypeDef](#interceptorinputconfigurationuniontypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatedDescriptorsTypeDef
...
class GetEvaluatorResponseTypeDef(TypedDict):
    ...
    evaluatorType: EvaluatorTypeType,  # (2)
    provider: ProviderType,  # (3)
    level: EvaluatorLevelType,  # (4)
    status: EvaluatorStatusType,  # (5)
    createdAt: datetime.datetime,
    updatedAt: datetime.datetime,
...
2. See [:material-code-brackets: EvaluatorTypeType](./literals.md#evaluatortypetype)
3. See [:material-code-brackets: ProviderType](./literals.md#providertype)
4. See [:material-code-brackets: EvaluatorLevelType](./literals.md#evaluatorleveltype)
5. See [:material-code-brackets: EvaluatorStatusType](./literals.md#evaluatorstatustype)
...
class CreateGatewayResponseTypeDef(TypedDict):
    ...
    kmsKeyArn: str,
    customTransformConfiguration: CustomTransformConfigurationTypeDef,  # (6)
    interceptorConfigurations: list[GatewayInterceptorConfigurationOutputTypeDef],  # (7)
    policyEngineConfiguration: GatewayPolicyEngineConfigurationTypeDef,  # (8)
    workloadIdentityDetails: WorkloadIdentityDetailsTypeDef,  # (9)
    exceptionLevel: ExceptionLevelType,  # (10)
    webAclArn: str,
    wafConfiguration: WafConfigurationTypeDef,  # (11)
...
6. See [:material-code-braces: CustomTransformConfigurationTypeDef](./type_defs.md#customtransformconfigurationtypedef)
7. See `list[GatewayInterceptorConfigurationOutputTypeDef]`
8. See [:material-code-braces: GatewayPolicyEngineConfigurationTypeDef](./type_defs.md#gatewaypolicyengineconfigurationtypedef)
9. See [:material-code-braces: WorkloadIdentityDetailsTypeDef](./type_defs.md#workloadidentitydetailstypedef)
10. See [:material-code-brackets: ExceptionLevelType](./literals.md#exceptionleveltype)
11. See [:material-code-braces: WafConfigurationTypeDef](./type_defs.md#wafconfigurationtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CreatePaymentManagerResponseTypeDef
...
class GetAgentRuntimeResponseTypeDef(TypedDict):
    ...
    capacityProviderConfiguration: CapacityProviderConfigurationTypeDef,  # (11)
    platformVersion: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (12)
```
...
11. See [:material-code-braces: CapacityProviderConfigurationTypeDef](./type_defs.md#capacityproviderconfigurationtypedef)
12. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import GetPaymentManagerResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import GetRegistryResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessTypeDef
...
class HarnessTypeDef(TypedDict):
    ...
    hooks: NotRequired[list[HarnessHookTypeDef]],  # (11)
...
5. See `list[HarnessSkillOutputTypeDef]`
...
11. See `list[HarnessHookTypeDef]`
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateRegistryResponseTypeDef
...
class CreateOauth2CredentialProviderResponseTypeDef(TypedDict):
    ...
    clientSecretSource: SecretSourceTypeType,  # (2)
    name: str,
    credentialProviderArn: str,
    callbackUrl: str,
...
class GetOauth2CredentialProviderResponseTypeDef(TypedDict):
    ...
    name: str,
    credentialProviderArn: str,
    credentialProviderVendor: CredentialProviderVendorTypeType,  # (3)
    callbackUrl: str,
    oauth2ProviderConfigOutput: Oauth2ProviderConfigOutputTypeDef,  # (4)
    createdTime: datetime.datetime,
    lastUpdatedTime: datetime.datetime,
    status: StatusType,  # (5)
    failureReason: str,
...
1. See [:material-code-braces: SecretTypeDef](./type_defs.md#secrettypedef)
2. See [:material-code-brackets: SecretSourceTypeType](./literals.md#secretsourcetypetype)
3. See [:material-code-brackets: CredentialProviderVendorTypeType](./literals.md#credentialprovidervendortypetype)
4. See [:material-code-braces: Oauth2ProviderConfigOutputTypeDef](./type_defs.md#oauth2providerconfigoutputtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import GetRegistryRecordResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateRegistryRecordResponseTypeDef
...
class TargetConfigurationOutputTypeDef(TypedDict):
    ...
    http: NotRequired[HttpTargetConfigurationOutputTypeDef],  # (2)
    inference: NotRequired[InferenceTargetConfigurationOutputTypeDef],  # (3)
```

1. See [:material-code-braces: McpTargetConfigurationOutputTypeDef](./type_defs.md#mcptargetconfigurationoutputtypedef)
2. See [:material-code-braces: HttpTargetConfigurationOutputTypeDef](./type_defs.md#httptargetconfigurationoutputtypedef)
3. See [:material-code-braces: InferenceTargetConfigurationOutputTypeDef](./type_defs.md#inferencetargetconfigurationoutputtypedef)
...
class TargetConfigurationTypeDef(TypedDict):
    ...
    inference: NotRequired[InferenceTargetConfigurationTypeDef],  # (3)
```
...
3. See [:material-code-braces: InferenceTargetConfigurationTypeDef](./type_defs.md#inferencetargetconfigurationtypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import MemoryRecordSchemaOutputTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ListGatewayRulesResponseTypeDef
...
```python
# GetCapacityProviderOutputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import GetCapacityProviderOutputTypeDef


def get_value() -> GetCapacityProviderOutputTypeDef:
    return {
        "capacityProviderId": ...,
    }


# GetCapacityProviderOutputTypeDef definition
...
class GetCapacityProviderOutputTypeDef(TypedDict):
    ...
    status: CapacityProviderStatusType,  # (1)
    description: str,
    statusCode: CapacityProviderStatusCodeType,  # (2)
    statusReason: str,
    permissionsConfiguration: PermissionsConfigurationTypeDef,  # (3)
    computeConfiguration: ComputeConfigurationOutputTypeDef,  # (4)
    createdAt: datetime.datetime,
    lastUpdatedAt: datetime.datetime,
    ResponseMetadata: ResponseMetadataTypeDef,  # (5)
```
...
1. See [:material-code-brackets: CapacityProviderStatusType](./literals.md#capacityproviderstatustype)
2. See [:material-code-brackets: CapacityProviderStatusCodeType](./literals.md#capacityproviderstatuscodetype)
3. See [:material-code-braces: PermissionsConfigurationTypeDef](./type_defs.md#permissionsconfigurationtypedef)
4. See [:material-code-braces: ComputeConfigurationOutputTypeDef](./type_defs.md#computeconfigurationoutputtypedef)
5. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
class CustomJWTAuthorizerConfigurationTypeDef(TypedDict):
    ...
    allowedWorkloadConfiguration: NotRequired[AllowedWorkloadConfigurationUnionTypeDef],  # (4)
```
...
4. See [:material-code-braces: AllowedWorkloadConfigurationUnionTypeDef](#allowedworkloadconfigurationuniontypedef)
...
class CustomOauth2ProviderConfigInputTypeDef(TypedDict):
    ...
    clientId: NotRequired[str],
    clientSecret: NotRequired[str],
    clientSecretConfig: NotRequired[SecretReferenceTypeDef],  # (2)
    clientSecretSource: NotRequired[SecretSourceTypeType],  # (3)
    ...
    privateKeyJwtConfig: NotRequired[PrivateKeyJwtConfigUnionTypeDef],  # (6)
    privateEndpoint: NotRequired[PrivateEndpointUnionTypeDef],  # (7)
    privateEndpointOverrides: NotRequired[Sequence[PrivateEndpointOverrideUnionTypeDef]],  # (8)
```
...
6. See [:material-code-braces: PrivateKeyJwtConfigUnionTypeDef](#privatekeyjwtconfiguniontypedef)
7. See [:material-code-braces: PrivateEndpointUnionTypeDef](#privateendpointuniontypedef)
8. See `Sequence[PrivateEndpointOverrideUnionTypeDef]`
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessToolConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CreateHarnessResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import DeleteHarnessResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import GetHarnessResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateHarnessResponseTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import FromUrlSynchronizationConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ExtractionConfigTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import ActionTypeDef
...
```python
# CreateCapacityProviderInputTypeDef TypedDict usage example

from mypy_boto3_bedrock_agentcore_control.type_defs import CreateCapacityProviderInputTypeDef


def get_value() -> CreateCapacityProviderInputTypeDef:
    return {
        "name": ...,
    }


# CreateCapacityProviderInputTypeDef definition
...
from mypy_boto3_bedrock_agentcore_control.type_defs import HarnessToolTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import SynchronizationConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import MetadataSchemaEntryTypeDef
...
class MetadataSchemaEntryTypeDef(TypedDict):
    ...
    type: NotRequired[MetadataValueTypeType],  # (1)
    extractionType: NotRequired[ExtractionTypeType],  # (2)
    extractionConfig: NotRequired[ExtractionConfigUnionTypeDef],  # (3)
```

1. See [:material-code-brackets: MetadataValueTypeType](./literals.md#metadatavaluetypetype)
2. See [:material-code-brackets: ExtractionTypeType](./literals.md#extractiontypetype)
3. See [:material-code-braces: ExtractionConfigUnionTypeDef](#extractionconfiguniontypedef)
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CreateGatewayRuleRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateGatewayRuleRequestTypeDef
...
class CreateAgentRuntimeRequestTypeDef(TypedDict):
    ...
    capacityProviderConfiguration: NotRequired[CapacityProviderConfigurationTypeDef],  # (8)
    tags: NotRequired[Mapping[str, str]],
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CreatePaymentManagerRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CreateRegistryRequestTypeDef
...
class UpdateAgentRuntimeRequestTypeDef(TypedDict):
    ...
    capacityProviderConfiguration: NotRequired[CapacityProviderConfigurationTypeDef],  # (9)
    platformVersion: NotRequired[str],
    clientToken: NotRequired[str],
```
...
class UpdateGatewayRequestTypeDef(TypedDict):
    ...
    authorizerConfiguration: NotRequired[AuthorizerConfigurationUnionTypeDef],  # (4)
    kmsKeyArn: NotRequired[str],
    customTransformConfiguration: NotRequired[CustomTransformConfigurationTypeDef],  # (5)
    interceptorConfigurations: NotRequired[Sequence[GatewayInterceptorConfigurationUnionTypeDef]],  # (6)
    policyEngineConfiguration: NotRequired[GatewayPolicyEngineConfigurationTypeDef],  # (7)
    exceptionLevel: NotRequired[ExceptionLevelType],  # (8)
    wafConfiguration: NotRequired[WafConfigurationTypeDef],  # (9)
```
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatePaymentManagerRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatedAuthorizerConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CreateHarnessRequestTypeDef
...
class CreateHarnessRequestTypeDef(TypedDict):
    ...
    hooks: NotRequired[Sequence[HarnessHookTypeDef]],  # (10)
    maxIterations: NotRequired[int],
    maxTokens: NotRequired[int],
    timeoutSeconds: NotRequired[int],
    tags: NotRequired[Mapping[str, str]],
...
10. See `Sequence[HarnessHookTypeDef]`
...
from mypy_boto3_bedrock_agentcore_control.type_defs import CreateRegistryRecordRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdatedSynchronizationConfigurationTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import MemoryRecordSchemaTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateHarnessRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateRegistryRequestTypeDef
...
from mypy_boto3_bedrock_agentcore_control.type_defs import UpdateRegistryRecordRequestTypeDef
...
class MemoryTypeDef(TypedDict):
    ...
    namespaceKeys: NotRequired[list[NamespaceKeyEntryOutputTypeDef]],  # (4)
    streamDeliveryResources: NotRequired[StreamDeliveryResourcesOutputTypeDef],  # (5)
    managedByResourceArn: NotRequired[str],
```
...
4. See `list[NamespaceKeyEntryOutputTypeDef]`
5. See [:material-code-braces: StreamDeliveryResourcesOutputTypeDef](./type_defs.md#streamdeliveryresourcesoutputtypedef)
...
class CreateMemoryInputTypeDef(TypedDict):
    ...
    namespaceKeys: NotRequired[Sequence[NamespaceKeyEntryUnionTypeDef]],  # (3)
    streamDeliveryResources: NotRequired[StreamDeliveryResourcesUnionTypeDef],  # (4)
    tags: NotRequired[Mapping[str, str]],
```
