...
def create_harness(
    ...
    *,
    ...
    hooks: Sequence[HarnessHookTypeDef] = ...,  # (10)
    maxIterations: int = ...,
    maxTokens: int = ...,
    timeoutSeconds: int = ...,
    tags: Mapping[str, str] = ...,
) -> CreateHarnessResponseTypeDef:  # (11)
    ...
```
...
11. See [:material-code-braces: CreateHarnessResponseTypeDef](./type_defs.md#createharnessresponsetypedef)
...
def update_harness(
    ...
    *,
    ...
    maxTokens: int = ...,
    timeoutSeconds: int = ...,
) -> UpdateHarnessResponseTypeDef:  # (11)
    ...
```
...
9. See [:material-code-braces: HarnessTruncationConfigurationTypeDef](./type_defs.md#harnesstruncationconfigurationtypedef)
10. See `Sequence[HarnessHookTypeDef]`
11. See [:material-code-braces: UpdateHarnessResponseTypeDef](./type_defs.md#updateharnessresponsetypedef)
