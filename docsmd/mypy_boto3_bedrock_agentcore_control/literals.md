...
```python
# HarnessHookFailureModeType usage example
from mypy_boto3_bedrock_agentcore_control.literals import HarnessHookFailureModeType

def get_value() -> HarnessHookFailureModeType:
    return "allow"
```

```python
# HarnessHookFailureModeType definition
HarnessHookFailureModeType = Literal[
    "allow",
    "deny",
]
```
