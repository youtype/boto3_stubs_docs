...
class DescribeInstanceResponseTypeDef(TypedDict):
    ...
    StatusReason: str,
    PrimaryRegion: str,
    Regions: list[RegionMetadataTypeDef],  # (2)
    EncryptionConfigurationDetails: EncryptionConfigurationDetailsTypeDef,  # (3)
...
3. See [:material-code-braces: EncryptionConfigurationDetailsTypeDef](./type_defs.md#encryptionconfigurationdetailstypedef)
