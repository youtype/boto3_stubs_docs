...
def create_express_gateway_service(
    ...
    *,
    ...
    cpu: str = ...,
    memory: str = ...,
    cpuArchitecture: ExpressCpuArchitectureType = ...,  # (3)
    scalingTarget: ExpressGatewayScalingTargetTypeDef = ...,  # (4)
    tags: Sequence[TagTypeDef] = ...,  # (5)
    taskDefinitionArn: str = ...,
) -> CreateExpressGatewayServiceResponseTypeDef:  # (6)
    ...
```
...
6. See [:material-code-braces: CreateExpressGatewayServiceResponseTypeDef](./type_defs.md#createexpressgatewayserviceresponsetypedef)
...
def update_express_gateway_service(
    ...
    *,
    ...
    scalingTarget: ExpressGatewayScalingTargetTypeDef = ...,  # (4)
    taskDefinitionArn: str = ...,
) -> UpdateExpressGatewayServiceResponseTypeDef:  # (5)
    ...
```
...
3. See [:material-code-brackets: ExpressCpuArchitectureType](./literals.md#expresscpuarchitecturetype)
4. See [:material-code-braces: ExpressGatewayScalingTargetTypeDef](./type_defs.md#expressgatewayscalingtargettypedef)
5. See [:material-code-braces: UpdateExpressGatewayServiceResponseTypeDef](./type_defs.md#updateexpressgatewayserviceresponsetypedef)
