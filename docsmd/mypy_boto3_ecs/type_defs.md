...
class ExpressGatewayServiceConfigurationTypeDef(TypedDict):
    ...
    cpu: NotRequired[str],
    memory: NotRequired[str],
    cpuArchitecture: NotRequired[ExpressCpuArchitectureType],  # (1)
    networkConfiguration: NotRequired[ExpressGatewayServiceNetworkConfigurationOutputTypeDef],  # (2)
    healthCheckPath: NotRequired[str],
    primaryContainer: NotRequired[ExpressGatewayContainerOutputTypeDef],  # (3)
    scalingTarget: NotRequired[ExpressGatewayScalingTargetTypeDef],  # (4)
    ingressPaths: NotRequired[list[IngressPathSummaryTypeDef]],  # (5)
    createdAt: NotRequired[datetime.datetime],
```

1. See [:material-code-brackets: ExpressCpuArchitectureType](./literals.md#expresscpuarchitecturetype)
2. See [:material-code-braces: ExpressGatewayServiceNetworkConfigurationOutputTypeDef](./type_defs.md#expressgatewayservicenetworkconfigurationoutputtypedef)
3. See [:material-code-braces: ExpressGatewayContainerOutputTypeDef](./type_defs.md#expressgatewaycontaineroutputtypedef)
4. See [:material-code-braces: ExpressGatewayScalingTargetTypeDef](./type_defs.md#expressgatewayscalingtargettypedef)
5. See `list[IngressPathSummaryTypeDef]`
...
class CreateExpressGatewayServiceRequestTypeDef(TypedDict):
    ...
    cpu: NotRequired[str],
    memory: NotRequired[str],
    cpuArchitecture: NotRequired[ExpressCpuArchitectureType],  # (3)
    scalingTarget: NotRequired[ExpressGatewayScalingTargetTypeDef],  # (4)
    tags: NotRequired[Sequence[TagTypeDef]],  # (5)
    taskDefinitionArn: NotRequired[str],
```
...
3. See [:material-code-brackets: ExpressCpuArchitectureType](./literals.md#expresscpuarchitecturetype)
4. See [:material-code-braces: ExpressGatewayScalingTargetTypeDef](./type_defs.md#expressgatewayscalingtargettypedef)
5. See `Sequence[TagTypeDef]`
