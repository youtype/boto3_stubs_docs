...
```python
# ExpressCpuArchitectureType usage example
from mypy_boto3_ecs.literals import ExpressCpuArchitectureType

def get_value() -> ExpressCpuArchitectureType:
    return "ARM64"
```

```python
# ExpressCpuArchitectureType definition
ExpressCpuArchitectureType = Literal[
    "ARM64",
    "X86_64",
]
```
