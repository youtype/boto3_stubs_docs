...
waiter = client.get_waiter("channel_active")  # (2)
waiter.wait(...)
```
...
```python
# ChannelActiveWaiter usage example with type annotations
...
waiter: ChannelActiveWaiter = client.get_waiter("channel_active")
waiter.wait(...)
```
