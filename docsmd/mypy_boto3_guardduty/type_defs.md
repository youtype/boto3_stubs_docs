...
```python
# BedrockGuardrailResourceTypeDef TypedDict usage example

from mypy_boto3_guardduty.type_defs import BedrockGuardrailResourceTypeDef


def get_value() -> BedrockGuardrailResourceTypeDef:
    return {
        "Version": ...,
    }


# BedrockGuardrailResourceTypeDef definition

class BedrockGuardrailResourceTypeDef(TypedDict):
    Version: NotRequired[str],
    GuardrailAction: NotRequired[GuardrailActionType],  # (1)
    GuardrailSource: NotRequired[GuardrailSourceType],  # (2)
```

1. See [:material-code-brackets: GuardrailActionType](./literals.md#guardrailactiontype)
2. See [:material-code-brackets: GuardrailSourceType](./literals.md#guardrailsourcetype)
...
class ResourceDataTypeDef(TypedDict):
    ...
    BedrockGuardrail: NotRequired[BedrockGuardrailResourceTypeDef],  # (17)
```
...
17. See [:material-code-braces: BedrockGuardrailResourceTypeDef](./type_defs.md#bedrockguardrailresourcetypedef)
