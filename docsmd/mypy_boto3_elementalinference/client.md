...
### delete\_feed\_policy

Deletes the resource-based policy attached to the specified feed.

Type annotations and code completion for `#!python boto3.client("elementalinference").delete_feed_policy` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/elementalinference/client/delete_feed_policy.html)

```python
# delete_feed_policy method definition
...
```python
# delete_feed_policy method usage example with argument unpacking

kwargs: DeleteFeedPolicyRequestTypeDef = {  # (1)
    "id": ...,
}

parent.delete_feed_policy(**kwargs)
```

1. See [:material-code-braces: DeleteFeedPolicyRequestTypeDef](./type_defs.md#deletefeedpolicyrequesttypedef)
...
Type annotations and code completion for `#!python boto3.client("elementalinference").get_feed_policy` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/elementalinference/client/get_feed_policy.html)

```python
# get_feed_policy method definition

def get_feed_policy(
    self,
    *,
    id: str,
) -> GetFeedPolicyResponseTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: GetFeedPolicyResponseTypeDef](./type_defs.md#getfeedpolicyresponsetypedef)


```python
# get_feed_policy method usage example with argument unpacking

kwargs: GetFeedPolicyRequestTypeDef = {  # (1)
    "id": ...,
}

parent.get_feed_policy(**kwargs)
```

1. See [:material-code-braces: GetFeedPolicyRequestTypeDef](./type_defs.md#getfeedpolicyrequesttypedef)
...
Type annotations and code completion for `#!python boto3.client("elementalinference").put_feed_policy` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/elementalinference/client/put_feed_policy.html)

```python
# put_feed_policy method definition
...
```python
# put_feed_policy method usage example with argument unpacking

kwargs: PutFeedPolicyRequestTypeDef = {  # (1)
    "id": ...,
    "policy": ...,
}

parent.put_feed_policy(**kwargs)
```

1. See [:material-code-braces: PutFeedPolicyRequestTypeDef](./type_defs.md#putfeedpolicyrequesttypedef)
