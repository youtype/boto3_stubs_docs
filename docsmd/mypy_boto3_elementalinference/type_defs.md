...
```python
# ContextualMetadataConfigTypeDef TypedDict usage example

from mypy_boto3_elementalinference.type_defs import ContextualMetadataConfigTypeDef


def get_value() -> ContextualMetadataConfigTypeDef:
    return {
        "summaryGeneration": ...,
    }


# ContextualMetadataConfigTypeDef definition

class ContextualMetadataConfigTypeDef(TypedDict):
    summaryGeneration: NotRequired[SummaryGenerationModeType],  # (1)
```

1. See [:material-code-brackets: SummaryGenerationModeType](./literals.md#summarygenerationmodetype)
...
```python
# DeleteFeedPolicyRequestTypeDef TypedDict usage example

from mypy_boto3_elementalinference.type_defs import DeleteFeedPolicyRequestTypeDef


def get_value() -> DeleteFeedPolicyRequestTypeDef:
    return {
        "id": ...,
    }


# DeleteFeedPolicyRequestTypeDef definition

class DeleteFeedPolicyRequestTypeDef(TypedDict):
    id: str,
```
...
```python
# GetFeedPolicyRequestTypeDef TypedDict usage example

from mypy_boto3_elementalinference.type_defs import GetFeedPolicyRequestTypeDef


def get_value() -> GetFeedPolicyRequestTypeDef:
    return {
        "id": ...,
    }


# GetFeedPolicyRequestTypeDef definition

class GetFeedPolicyRequestTypeDef(TypedDict):
    id: str,
```
...
```python
# PutFeedPolicyRequestTypeDef TypedDict usage example

from mypy_boto3_elementalinference.type_defs import PutFeedPolicyRequestTypeDef


def get_value() -> PutFeedPolicyRequestTypeDef:
    return {
        "id": ...,
    }


# PutFeedPolicyRequestTypeDef definition

class PutFeedPolicyRequestTypeDef(TypedDict):
    id: str,
    policy: str,
```
...
```python
# GetFeedPolicyResponseTypeDef TypedDict usage example

from mypy_boto3_elementalinference.type_defs import GetFeedPolicyResponseTypeDef


def get_value() -> GetFeedPolicyResponseTypeDef:
    return {
        "policy": ...,
    }


# GetFeedPolicyResponseTypeDef definition
...
class OutputConfigOutputTypeDef(TypedDict):
    ...
    contextualMetadata: NotRequired[ContextualMetadataConfigTypeDef],  # (4)
```
...
4. See [:material-code-braces: ContextualMetadataConfigTypeDef](./type_defs.md#contextualmetadataconfigtypedef)
