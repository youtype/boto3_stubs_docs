...
def create_notebook(
    ...
    *,
    ...
    clientToken: str = ...,
) -> CreateNotebookOutputTypeDef:  # (2)
    ...
```

1. See [:material-code-brackets: NotebookTypeType](./literals.md#notebooktypetype)
2. See [:material-code-braces: CreateNotebookOutputTypeDef](./type_defs.md#createnotebookoutputtypedef)
...
def list_notebooks(
    ...
    *,
    ...
    type: NotebookTypeType = ...,  # (4)
    nextToken: str = ...,
) -> ListNotebooksOutputTypeDef:  # (5)
    ...
```
...
4. See [:material-code-brackets: NotebookTypeType](./literals.md#notebooktypetype)
5. See [:material-code-braces: ListNotebooksOutputTypeDef](./type_defs.md#listnotebooksoutputtypedef)
...
def update_notebook(
    ...
    *,
    ...
    type: NotebookTypeType = ...,  # (2)
    metadata: Mapping[str, str] = ...,
    parameters: Mapping[str, str] = ...,
    environmentConfiguration: EnvironmentConfigTypeDef = ...,  # (3)
    clientToken: str = ...,
) -> UpdateNotebookOutputTypeDef:  # (4)
    ...
```

1. See [:material-code-brackets: NotebookStatusType](./literals.md#notebookstatustype)
2. See [:material-code-brackets: NotebookTypeType](./literals.md#notebooktypetype)
3. See [:material-code-braces: EnvironmentConfigTypeDef](./type_defs.md#environmentconfigtypedef)
4. See [:material-code-braces: UpdateNotebookOutputTypeDef](./type_defs.md#updatenotebookoutputtypedef)
