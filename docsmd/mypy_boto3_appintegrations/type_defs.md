...
from mypy_boto3_appintegrations.type_defs import AuthConfigTypeDef
...
class GetApplicationResponseTypeDef(TypedDict):
    ...
    AuthConfig: AuthConfigTypeDef,  # (7)
...
7. See [:material-code-braces: AuthConfigTypeDef](./type_defs.md#authconfigtypedef)
...
class CreateApplicationRequestTypeDef(TypedDict):
    ...
    AuthConfig: NotRequired[AuthConfigTypeDef],  # (7)
```
