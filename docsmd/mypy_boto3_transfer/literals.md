...
```python
# ProxyModeType usage example
from mypy_boto3_transfer.literals import ProxyModeType

def get_value() -> ProxyModeType:
    return "NONE"
```

```python
# ProxyModeType definition
ProxyModeType = Literal[
    "NONE",
