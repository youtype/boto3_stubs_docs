...
```python
# ProxyConfigTypeDef TypedDict usage example

from mypy_boto3_transfer.type_defs import ProxyConfigTypeDef


def get_value() -> ProxyConfigTypeDef:
    return {
        "SftpMode": ...,
    }


# ProxyConfigTypeDef definition

class ProxyConfigTypeDef(TypedDict):
    SftpMode: NotRequired[ProxyModeType],  # (1)
```

1. See [:material-code-brackets: ProxyModeType](./literals.md#proxymodetype)
...
class ProtocolDetailsOutputTypeDef(TypedDict):
    ...
    ProxyConfig: NotRequired[ProxyConfigTypeDef],  # (4)
```
...
4. See [:material-code-braces: ProxyConfigTypeDef](./type_defs.md#proxyconfigtypedef)
