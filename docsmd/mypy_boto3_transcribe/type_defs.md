...
from mypy_boto3_transcribe.type_defs import EncryptionConfigurationUnionTypeDef
...
from mypy_boto3_transcribe.type_defs import EncryptionConfigurationOutputTypeDef
...
from mypy_boto3_transcribe.type_defs import EncryptionConfigurationTypeDef
...
```python
# UpdateLanguageModelResponseTypeDef TypedDict usage example

from mypy_boto3_transcribe.type_defs import UpdateLanguageModelResponseTypeDef


def get_value() -> UpdateLanguageModelResponseTypeDef:
    return {
        "ModelName": ...,
    }


# UpdateLanguageModelResponseTypeDef definition

class UpdateLanguageModelResponseTypeDef(TypedDict):
    ModelName: str,
    ModelStatus: ModelStatusType,  # (1)
    LastModifiedTime: datetime.datetime,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```
...
class GetVocabularyFilterResponseTypeDef(TypedDict):
    ...
    DownloadUri: str,
    DataAccessRoleArn: str,
    EncryptionConfiguration: EncryptionConfigurationOutputTypeDef,  # (2)
    ResponseMetadata: ResponseMetadataTypeDef,  # (3)
```
...
class GetVocabularyResponseTypeDef(TypedDict):
    ...
    DownloadUri: str,
    DataAccessRoleArn: str,
    EncryptionConfiguration: EncryptionConfigurationOutputTypeDef,  # (3)
    ResponseMetadata: ResponseMetadataTypeDef,  # (4)
```

1. See [:material-code-brackets: LanguageCodeType](./literals.md#languagecodetype)
2. See [:material-code-brackets: VocabularyStateType](./literals.md#vocabularystatetype)
3. See [:material-code-braces: EncryptionConfigurationOutputTypeDef](./type_defs.md#encryptionconfigurationoutputtypedef)
...
class LanguageModelTypeDef(TypedDict):
    ...
    EncryptionConfiguration: NotRequired[EncryptionConfigurationOutputTypeDef],  # (5)
```
...
5. See [:material-code-braces: EncryptionConfigurationOutputTypeDef](./type_defs.md#encryptionconfigurationoutputtypedef)
...
class CreateLanguageModelRequestTypeDef(TypedDict):
    ...
    ModelName: str,
    InputDataConfig: InputDataConfigTypeDef,  # (3)
    EncryptionConfiguration: NotRequired[EncryptionConfigurationUnionTypeDef],  # (4)
...
class CreateVocabularyFilterRequestTypeDef(TypedDict):
    ...
    Tags: NotRequired[Sequence[TagTypeDef]],  # (2)
    DataAccessRoleArn: NotRequired[str],
    EncryptionConfiguration: NotRequired[EncryptionConfigurationUnionTypeDef],  # (3)
```
...
```python
# UpdateLanguageModelRequestTypeDef TypedDict usage example

from mypy_boto3_transcribe.type_defs import UpdateLanguageModelRequestTypeDef


def get_value() -> UpdateLanguageModelRequestTypeDef:
    return {
        "ModelName": ...,
    }


# UpdateLanguageModelRequestTypeDef definition

class UpdateLanguageModelRequestTypeDef(TypedDict):
    ModelName: str,
    DataAccessRoleArn: NotRequired[str],
    EncryptionConfiguration: NotRequired[EncryptionConfigurationUnionTypeDef],  # (1)
```
...
class UpdateVocabularyRequestTypeDef(TypedDict):
    ...
    VocabularyFileUri: NotRequired[str],
    DataAccessRoleArn: NotRequired[str],
    EncryptionConfiguration: NotRequired[EncryptionConfigurationUnionTypeDef],  # (2)
```
