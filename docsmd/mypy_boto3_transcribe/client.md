...
def create_language_model(
    ...
    *,
    ...
    EncryptionConfiguration: EncryptionConfigurationUnionTypeDef = ...,  # (4)
    Tags: Sequence[TagTypeDef] = ...,  # (5)
) -> CreateLanguageModelResponseTypeDef:  # (6)
    ...
```
...
4. See [:material-code-braces: EncryptionConfigurationUnionTypeDef](#encryptionconfigurationuniontypedef)
5. See `Sequence[TagTypeDef]`
6. See [:material-code-braces: CreateLanguageModelResponseTypeDef](./type_defs.md#createlanguagemodelresponsetypedef)
...
def create_vocabulary(
    ...
    *,
    ...
    EncryptionConfiguration: EncryptionConfigurationUnionTypeDef = ...,  # (3)
) -> CreateVocabularyResponseTypeDef:  # (4)
    ...
```

1. See [:material-code-brackets: LanguageCodeType](./literals.md#languagecodetype)
2. See `Sequence[TagTypeDef]`
3. See [:material-code-braces: EncryptionConfigurationUnionTypeDef](#encryptionconfigurationuniontypedef)
4. See [:material-code-braces: CreateVocabularyResponseTypeDef](./type_defs.md#createvocabularyresponsetypedef)
...
def create_vocabulary_filter(
    ...
    *,
    ...
    DataAccessRoleArn: str = ...,
    EncryptionConfiguration: EncryptionConfigurationUnionTypeDef = ...,  # (3)
) -> CreateVocabularyFilterResponseTypeDef:  # (4)
    ...
```
...
2. See `Sequence[TagTypeDef]`
3. See [:material-code-braces: EncryptionConfigurationUnionTypeDef](#encryptionconfigurationuniontypedef)
4. See [:material-code-braces: CreateVocabularyFilterResponseTypeDef](./type_defs.md#createvocabularyfilterresponsetypedef)
...
### update\_language\_model

Updates the encryption configuration for an existing custom language model.

Type annotations and code completion for `#!python boto3.client("transcribe").update_language_model` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/transcribe/client/update_language_model.html)

```python
# update_language_model method definition
...
) -> UpdateLanguageModelResponseTypeDef:  # (2)
    ...
```

1. See [:material-code-braces: EncryptionConfigurationUnionTypeDef](#encryptionconfigurationuniontypedef)
2. See [:material-code-braces: UpdateLanguageModelResponseTypeDef](./type_defs.md#updatelanguagemodelresponsetypedef)


```python
# update_language_model method usage example with argument unpacking

kwargs: UpdateLanguageModelRequestTypeDef = {  # (1)
    "ModelName": ...,
}

parent.update_language_model(**kwargs)
```

1. See [:material-code-braces: UpdateLanguageModelRequestTypeDef](./type_defs.md#updatelanguagemodelrequesttypedef)
...
def update_vocabulary(
    ...
    *,
    ...
    VocabularyFileUri: str = ...,
    DataAccessRoleArn: str = ...,
    EncryptionConfiguration: EncryptionConfigurationUnionTypeDef = ...,  # (2)
) -> UpdateVocabularyResponseTypeDef:  # (3)
    ...
```

1. See [:material-code-brackets: LanguageCodeType](./literals.md#languagecodetype)
2. See [:material-code-braces: EncryptionConfigurationUnionTypeDef](#encryptionconfigurationuniontypedef)
3. See [:material-code-braces: UpdateVocabularyResponseTypeDef](./type_defs.md#updatevocabularyresponsetypedef)
...
def update_vocabulary_filter(
    ...
    *,
    ...
    DataAccessRoleArn: str = ...,
    EncryptionConfiguration: EncryptionConfigurationUnionTypeDef = ...,  # (1)
) -> UpdateVocabularyFilterResponseTypeDef:  # (2)
    ...
```

1. See [:material-code-braces: EncryptionConfigurationUnionTypeDef](#encryptionconfigurationuniontypedef)
2. See [:material-code-braces: UpdateVocabularyFilterResponseTypeDef](./type_defs.md#updatevocabularyfilterresponsetypedef)
