...
class DeploymentInfoTypeDef(TypedDict):
    ...
    deploymentMode: NotRequired[DeploymentModeType],  # (14)
    deploymentStatusMessages: NotRequired[list[str]],
    computePlatform: NotRequired[ComputePlatformType],  # (15)
    externalId: NotRequired[str],
    relatedDeployments: NotRequired[RelatedDeploymentsTypeDef],  # (16)
    overrideAlarmConfiguration: NotRequired[AlarmConfigurationOutputTypeDef],  # (17)
```
...
14. See [:material-code-brackets: DeploymentModeType](./literals.md#deploymentmodetype)
15. See [:material-code-brackets: ComputePlatformType](./literals.md#computeplatformtype)
16. See [:material-code-braces: RelatedDeploymentsTypeDef](./type_defs.md#relateddeploymentstypedef)
17. See [:material-code-braces: AlarmConfigurationOutputTypeDef](./type_defs.md#alarmconfigurationoutputtypedef)
