...
```python
# MultiviewLayoutTypeType usage example
from mypy_boto3_mediapackagev2.literals import MultiviewLayoutTypeType

def get_value() -> MultiviewLayoutTypeType:
    return "LAYOUT_2EH"
```

```python
# MultiviewLayoutTypeType definition
