...
```python
# MultiviewConfigurationUnionTypeDef Union usage example

from mypy_boto3_mediapackagev2.type_defs import MultiviewConfigurationUnionTypeDef


def get_value() -> MultiviewConfigurationUnionTypeDef:
    return ...


# MultiviewConfigurationUnionTypeDef definition

MultiviewConfigurationUnionTypeDef = Union[
    MultiviewConfigurationTypeDef,  # (1)
    MultiviewConfigurationOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: MultiviewConfigurationTypeDef](./type_defs.md#multiviewconfigurationtypedef)
2. See [:material-code-braces: MultiviewConfigurationOutputTypeDef](./type_defs.md#multiviewconfigurationoutputtypedef)
...
```python
# MultiviewConfigurationOutputTypeDef TypedDict usage example

from mypy_boto3_mediapackagev2.type_defs import MultiviewConfigurationOutputTypeDef


def get_value() -> MultiviewConfigurationOutputTypeDef:
    return {
        "AvailableSources": ...,
    }


# MultiviewConfigurationOutputTypeDef definition

class MultiviewConfigurationOutputTypeDef(TypedDict):
    AvailableSources: list[str],
    AvailableLayouts: list[MultiviewLayoutTypeType],  # (1)
```

1. See `list[MultiviewLayoutTypeType]`
...
```python
# MultiviewConfigurationTypeDef TypedDict usage example

from mypy_boto3_mediapackagev2.type_defs import MultiviewConfigurationTypeDef


def get_value() -> MultiviewConfigurationTypeDef:
    return {
        "AvailableSources": ...,
    }


# MultiviewConfigurationTypeDef definition

class MultiviewConfigurationTypeDef(TypedDict):
    AvailableSources: Sequence[str],
    AvailableLayouts: Sequence[MultiviewLayoutTypeType],  # (1)
```

1. See `Sequence[MultiviewLayoutTypeType]`
...
class ChannelListConfigurationTypeDef(TypedDict):
    ...
    MultiviewConfiguration: NotRequired[MultiviewConfigurationOutputTypeDef],  # (3)
...
3. See [:material-code-braces: MultiviewConfigurationOutputTypeDef](./type_defs.md#multiviewconfigurationoutputtypedef)
...
class CreateChannelResponseTypeDef(TypedDict):
    MultiviewConfiguration: MultiviewConfigurationOutputTypeDef,  # (1)
    ...
    ModifiedAt: datetime.datetime,
    Description: str,
    IngestEndpoints: list[IngestEndpointTypeDef],  # (2)
    InputType: InputTypeType,  # (3)
    ETag: str,
    Tags: dict[str, str],
    InputSwitchConfiguration: InputSwitchConfigurationTypeDef,  # (4)
    OutputHeaderConfiguration: OutputHeaderConfigurationTypeDef,  # (5)
    OutputLockingMode: OutputLockingModeType,  # (6)
    ResponseMetadata: ResponseMetadataTypeDef,  # (7)
```

1. See [:material-code-braces: MultiviewConfigurationOutputTypeDef](./type_defs.md#multiviewconfigurationoutputtypedef)
2. See `list[IngestEndpointTypeDef]`
3. See [:material-code-brackets: InputTypeType](./literals.md#inputtypetype)
4. See [:material-code-braces: InputSwitchConfigurationTypeDef](./type_defs.md#inputswitchconfigurationtypedef)
5. See [:material-code-braces: OutputHeaderConfigurationTypeDef](./type_defs.md#outputheaderconfigurationtypedef)
6. See [:material-code-brackets: OutputLockingModeType](./literals.md#outputlockingmodetype)
...
class CreateChannelRequestTypeDef(TypedDict):
    ...
    MultiviewConfiguration: NotRequired[MultiviewConfigurationUnionTypeDef],  # (4)
    OutputLockingMode: NotRequired[OutputLockingModeType],  # (5)
    Tags: NotRequired[Mapping[str, str]],
```
...
4. See [:material-code-braces: MultiviewConfigurationUnionTypeDef](#multiviewconfigurationuniontypedef)
...
class UpdateChannelRequestTypeDef(TypedDict):
    ...
    MultiviewConfiguration: NotRequired[MultiviewConfigurationUnionTypeDef],  # (3)
```
...
3. See [:material-code-braces: MultiviewConfigurationUnionTypeDef](#multiviewconfigurationuniontypedef)
