...
```python
# EventHoldDurationTypeDef TypedDict usage example

from mypy_boto3_s3.type_defs import EventHoldDurationTypeDef


def get_value() -> EventHoldDurationTypeDef:
    return {
        "Days": ...,
    }


# EventHoldDurationTypeDef definition
...
class GetObjectOutputTypeDef(TypedDict):
    ...
    ObjectLockEventHold: ObjectLockEventHoldType,  # (8)
...
8. See [:material-code-brackets: ObjectLockEventHoldType](./literals.md#objectlockeventholdtype)
...
class HeadObjectOutputTypeDef(TypedDict):
    ...
    ObjectLockEventHold: ObjectLockEventHoldType,  # (9)
    ObjectLockEventHoldDurationDays: int,
    ObjectLockEventHoldDurationYears: int,
...
9. See [:material-code-brackets: ObjectLockEventHoldType](./literals.md#objectlockeventholdtype)
...
class CreateMultipartUploadRequestObjectInitiateMultipartUploadTypeDef(TypedDict):
    ...
    ObjectLockEventHold: NotRequired[ObjectLockEventHoldType],  # (7)
    ObjectLockEventHoldDurationDays: NotRequired[int],
    ObjectLockEventHoldDurationYears: NotRequired[int],
    ExpectedBucketOwner: NotRequired[str],
    ChecksumAlgorithm: NotRequired[ChecksumAlgorithmType],  # (8)
    ChecksumType: NotRequired[ChecksumTypeType],  # (9)
```
...
7. See [:material-code-brackets: ObjectLockEventHoldType](./literals.md#objectlockeventholdtype)
8. See [:material-code-brackets: ChecksumAlgorithmType](./literals.md#checksumalgorithmtype)
9. See [:material-code-brackets: ChecksumTypeType](./literals.md#checksumtypetype)
...
class PutObjectRequestBucketPutObjectTypeDef(TypedDict):
    ...
    ObjectLockEventHold: NotRequired[ObjectLockEventHoldType],  # (8)
    ObjectLockEventHoldDurationDays: NotRequired[int],
    ObjectLockEventHoldDurationYears: NotRequired[int],
    ExpectedBucketOwner: NotRequired[str],
```
...
class DefaultRetentionTypeDef(TypedDict):
    ...
    Days: NotRequired[int],
    Years: NotRequired[int],
    DefaultEventHold: NotRequired[EventHoldDurationTypeDef],  # (2)
```

1. See [:material-code-brackets: ObjectLockRetentionModeType](./literals.md#objectlockretentionmodetype)
2. See [:material-code-braces: EventHoldDurationTypeDef](./type_defs.md#eventholddurationtypedef)
...
class ObjectLockRetentionOutputTypeDef(TypedDict):
    ...
    EventHold: NotRequired[ObjectLockEventHoldType],  # (2)
    EventHoldDuration: NotRequired[EventHoldDurationTypeDef],  # (3)
```

1. See [:material-code-brackets: ObjectLockRetentionModeType](./literals.md#objectlockretentionmodetype)
2. See [:material-code-brackets: ObjectLockEventHoldType](./literals.md#objectlockeventholdtype)
3. See [:material-code-braces: EventHoldDurationTypeDef](./type_defs.md#eventholddurationtypedef)
...
class CopyObjectRequestObjectCopyFromTypeDef(TypedDict):
    ...
    ObjectLockEventHold: NotRequired[ObjectLockEventHoldType],  # (12)
    ObjectLockEventHoldDurationDays: NotRequired[int],
    ObjectLockEventHoldDurationYears: NotRequired[int],
    ExpectedBucketOwner: NotRequired[str],
...
12. See [:material-code-brackets: ObjectLockEventHoldType](./literals.md#objectlockeventholdtype)
