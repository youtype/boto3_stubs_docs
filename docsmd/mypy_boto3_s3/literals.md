...
```python
# ObjectLockEventHoldType usage example
from mypy_boto3_s3.literals import ObjectLockEventHoldType

def get_value() -> ObjectLockEventHoldType:
    return "OFF"
```

```python
# ObjectLockEventHoldType definition
ObjectLockEventHoldType = Literal[
    "OFF",
    "ON",
]
```
