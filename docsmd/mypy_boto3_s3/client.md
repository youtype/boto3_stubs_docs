...
13. See [:material-code-braces: CopyObjectOutputTypeDef](./type_defs.md#copyobjectoutputtypedef)
...
def create_multipart_upload(
    ...
    *,
    ...
    ObjectLockEventHold: ObjectLockEventHoldType = ...,  # (7)
    ObjectLockEventHoldDurationDays: int = ...,
    ObjectLockEventHoldDurationYears: int = ...,
    ExpectedBucketOwner: str = ...,
    ChecksumAlgorithm: ChecksumAlgorithmType = ...,  # (8)
    ChecksumType: ChecksumTypeType = ...,  # (9)
) -> CreateMultipartUploadOutputTypeDef:  # (10)
    ...
```
...
10. See [:material-code-braces: CreateMultipartUploadOutputTypeDef](./type_defs.md#createmultipartuploadoutputtypedef)
...
9. See [:material-code-braces: PutObjectOutputTypeDef](./type_defs.md#putobjectoutputtypedef)
