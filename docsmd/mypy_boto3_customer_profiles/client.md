...
### search\_recommendations

Retrieves recommendations for a profile in a specific domain.

Type annotations and code completion for `#!python boto3.client("customer-profiles").search_recommendations` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/customer-profiles/client/search_recommendations.html)

```python
# search_recommendations method definition
...
def search_recommendations(
    ...
    *,
    ...
    CandidateIds: Sequence[str] = ...,
    Context: Mapping[str, str] = ...,
    Diversity: RecommendationDiversityConfigTypeDef = ...,  # (2)
    Metadata: RecommendationMetadataTypeDef = ...,  # (3)
    MaxRecommendations: int = ...,
) -> SearchRecommendationsResponseTypeDef:  # (4)
    ...
```
...
4. See [:material-code-braces: SearchRecommendationsResponseTypeDef](./type_defs.md#searchrecommendationsresponsetypedef)


```python
# search_recommendations method usage example with argument unpacking

kwargs: SearchRecommendationsRequestTypeDef = {  # (1)
    "DomainName": ...,
    "KeyName": ...,
    "KeyValues": ...,
    "Recommender": ...,
...
parent.search_recommendations(**kwargs)
```

1. See [:material-code-braces: SearchRecommendationsRequestTypeDef](./type_defs.md#searchrecommendationsrequesttypedef)
