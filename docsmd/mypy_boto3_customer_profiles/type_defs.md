...
```python
# RecommendationMetadataTypeDef TypedDict usage example

from mypy_boto3_customer_profiles.type_defs import RecommendationMetadataTypeDef


def get_value() -> RecommendationMetadataTypeDef:
    return {
        "Columns": ...,
    }


# RecommendationMetadataTypeDef definition
...
from mypy_boto3_customer_profiles.type_defs import RecommenderTypeDef
...
class RecommenderTypeDef(TypedDict):
    Name: str,
    Filters: NotRequired[Sequence[RecommenderFilterTypeDef]],  # (1)
    PromotionalFilters: NotRequired[Sequence[RecommenderPromotionalFilterTypeDef]],  # (2)
```
...
```python
# SearchRecommendationsResponseTypeDef TypedDict usage example

from mypy_boto3_customer_profiles.type_defs import SearchRecommendationsResponseTypeDef


def get_value() -> SearchRecommendationsResponseTypeDef:
    return {
        "ProfileId": ...,
    }


# SearchRecommendationsResponseTypeDef definition
...
```python
# SearchRecommendationsRequestTypeDef TypedDict usage example

from mypy_boto3_customer_profiles.type_defs import SearchRecommendationsRequestTypeDef


def get_value() -> SearchRecommendationsRequestTypeDef:
    return {
        "DomainName": ...,
    }


# SearchRecommendationsRequestTypeDef definition
...
class SearchRecommendationsRequestTypeDef(TypedDict):
    ...
    CandidateIds: NotRequired[Sequence[str]],
    Context: NotRequired[Mapping[str, str]],
    Diversity: NotRequired[RecommendationDiversityConfigTypeDef],  # (2)
    Metadata: NotRequired[RecommendationMetadataTypeDef],  # (3)
    MaxRecommendations: NotRequired[int],
```

1. See [:material-code-braces: RecommenderTypeDef](./type_defs.md#recommendertypedef)
2. See [:material-code-braces: RecommendationDiversityConfigTypeDef](./type_defs.md#recommendationdiversityconfigtypedef)
3. See [:material-code-braces: RecommendationMetadataTypeDef](./type_defs.md#recommendationmetadatatypedef)
