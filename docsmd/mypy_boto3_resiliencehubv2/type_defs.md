...
```python
# EksLabelSelectorRequirementUnionTypeDef Union usage example

from mypy_boto3_resiliencehubv2.type_defs import EksLabelSelectorRequirementUnionTypeDef


def get_value() -> EksLabelSelectorRequirementUnionTypeDef:
    return ...


# EksLabelSelectorRequirementUnionTypeDef definition

EksLabelSelectorRequirementUnionTypeDef = Union[
    EksLabelSelectorRequirementTypeDef,  # (1)
    EksLabelSelectorRequirementOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: EksLabelSelectorRequirementTypeDef](./type_defs.md#ekslabelselectorrequirementtypedef)
2. See [:material-code-braces: EksLabelSelectorRequirementOutputTypeDef](./type_defs.md#ekslabelselectorrequirementoutputtypedef)
...
```python
# EksLabelSelectorUnionTypeDef Union usage example

from mypy_boto3_resiliencehubv2.type_defs import EksLabelSelectorUnionTypeDef


def get_value() -> EksLabelSelectorUnionTypeDef:
    return ...


# EksLabelSelectorUnionTypeDef definition

EksLabelSelectorUnionTypeDef = Union[
    EksLabelSelectorTypeDef,  # (1)
    EksLabelSelectorOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: EksLabelSelectorTypeDef](./type_defs.md#ekslabelselectortypedef)
2. See [:material-code-braces: EksLabelSelectorOutputTypeDef](./type_defs.md#ekslabelselectoroutputtypedef)
...
```python
# AlarmStateChangeDetailTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import AlarmStateChangeDetailTypeDef


def get_value() -> AlarmStateChangeDetailTypeDef:
    return {
        "state": ...,
    }


# AlarmStateChangeDetailTypeDef definition

class AlarmStateChangeDetailTypeDef(TypedDict):
    state: AlarmStateType,  # (1)
    previousState: NotRequired[AlarmStateType],  # (1)
    reason: NotRequired[str],
```

1. See [:material-code-brackets: AlarmStateType](./literals.md#alarmstatetype)
2. See [:material-code-brackets: AlarmStateType](./literals.md#alarmstatetype)
...
```python
# DependencyInsightTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import DependencyInsightTypeDef


def get_value() -> DependencyInsightTypeDef:
    return {
        "category": ...,
    }


# DependencyInsightTypeDef definition

class DependencyInsightTypeDef(TypedDict):
    category: InsightsCategoryType,  # (1)
    description: str,
```

1. See [:material-code-brackets: InsightsCategoryType](./literals.md#insightscategorytype)
...
```python
# EksLabelSelectorRequirementOutputTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import EksLabelSelectorRequirementOutputTypeDef


def get_value() -> EksLabelSelectorRequirementOutputTypeDef:
    return {
        "key": ...,
    }


# EksLabelSelectorRequirementOutputTypeDef definition

class EksLabelSelectorRequirementOutputTypeDef(TypedDict):
    key: str,
    operator: EksLabelSelectorOperatorType,  # (1)
    values: NotRequired[list[str]],
```

1. See [:material-code-brackets: EksLabelSelectorOperatorType](./literals.md#ekslabelselectoroperatortype)

## EksLabelSelectorRequirementTypeDef

```python
# EksLabelSelectorRequirementTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import EksLabelSelectorRequirementTypeDef


def get_value() -> EksLabelSelectorRequirementTypeDef:
    return {
        "key": ...,
    }


# EksLabelSelectorRequirementTypeDef definition

class EksLabelSelectorRequirementTypeDef(TypedDict):
    key: str,
    operator: EksLabelSelectorOperatorType,  # (1)
...
```python
# GetDependencyInsightsRequestTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import GetDependencyInsightsRequestTypeDef


def get_value() -> GetDependencyInsightsRequestTypeDef:
    return {
        "serviceArn": ...,
    }


# GetDependencyInsightsRequestTypeDef definition
...
```python
# ListTestRunDependenciesRequestTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import ListTestRunDependenciesRequestTypeDef


def get_value() -> ListTestRunDependenciesRequestTypeDef:
    return {
        "testRunId": ...,
    }


# ListTestRunDependenciesRequestTypeDef definition
...
```python
# TestRunDependencySummaryTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import TestRunDependencySummaryTypeDef


def get_value() -> TestRunDependencySummaryTypeDef:
    return {
        "dependencyId": ...,
    }


# TestRunDependencySummaryTypeDef definition

class TestRunDependencySummaryTypeDef(TypedDict):
    dependencyName: str,
    dnsName: str,
    criticality: DependencyCriticalityType,  # (1)
    source: TestRunDependencySourceType,  # (2)
...
2. See [:material-code-brackets: TestRunDependencySourceType](./literals.md#testrundependencysourcetype)
...
```python
# ListTestRunSourceEventsRequestTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import ListTestRunSourceEventsRequestTypeDef


def get_value() -> ListTestRunSourceEventsRequestTypeDef:
    return {
        "testRunId": ...,
    }


# ListTestRunSourceEventsRequestTypeDef definition
...
```python
# PolicyAttachedToServiceMetadataTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import PolicyAttachedToServiceMetadataTypeDef


def get_value() -> PolicyAttachedToServiceMetadataTypeDef:
    return {
        "serviceArn": ...,
    }


# PolicyAttachedToServiceMetadataTypeDef definition
...
```python
# PolicyDeletedMetadataTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import PolicyDeletedMetadataTypeDef


def get_value() -> PolicyDeletedMetadataTypeDef:
    return {
        "affectedServiceCount": ...,
    }


# PolicyDeletedMetadataTypeDef definition
...
```python
# PolicyDetachedFromServiceMetadataTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import PolicyDetachedFromServiceMetadataTypeDef


def get_value() -> PolicyDetachedFromServiceMetadataTypeDef:
    return {
        "serviceArn": ...,
    }


# PolicyDetachedFromServiceMetadataTypeDef definition
...
```python
# PolicySharingRevokedMetadataTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import PolicySharingRevokedMetadataTypeDef


def get_value() -> PolicySharingRevokedMetadataTypeDef:
    return {
        "affectedServiceCount": ...,
    }


# PolicySharingRevokedMetadataTypeDef definition
...
class ServicePolicyAssociatedMetadataTypeDef(TypedDict):
    ...
    policySource: NotRequired[PolicyValueSourceType],  # (1)
```
...
class ServicePolicyDisassociatedMetadataTypeDef(TypedDict):
    ...
    policyOwnerAccountId: NotRequired[str],
    policySource: NotRequired[PolicyValueSourceType],  # (1)
    reason: NotRequired[PolicyDisassociationReasonType],  # (2)
```

1. See [:material-code-brackets: PolicyValueSourceType](./literals.md#policyvaluesourcetype)
2. See [:material-code-brackets: PolicyDisassociationReasonType](./literals.md#policydisassociationreasontype)
...
```python
# StartDependencyInsightsRequestTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import StartDependencyInsightsRequestTypeDef


def get_value() -> StartDependencyInsightsRequestTypeDef:
    return {
        "serviceArn": ...,
    }


# StartDependencyInsightsRequestTypeDef definition
...
```python
# TestRunSourceEventErrorTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import TestRunSourceEventErrorTypeDef


def get_value() -> TestRunSourceEventErrorTypeDef:
    return {
        "errorCode": ...,
    }


# TestRunSourceEventErrorTypeDef definition

class TestRunSourceEventErrorTypeDef(TypedDict):
    errorCode: TestRunSourceEventErrorCodeType,  # (1)
    errorMessage: str,
```

1. See [:material-code-brackets: TestRunSourceEventErrorCodeType](./literals.md#testrunsourceeventerrorcodetype)
...
```python
# StartDependencyInsightsResponseTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import StartDependencyInsightsResponseTypeDef


def get_value() -> StartDependencyInsightsResponseTypeDef:
    return {
        "status": ...,
    }


# StartDependencyInsightsResponseTypeDef definition

class StartDependencyInsightsResponseTypeDef(TypedDict):
    status: DependencyInsightsStatusType,  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-brackets: DependencyInsightsStatusType](./literals.md#dependencyinsightsstatustype)
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
```python
# GetDependencyInsightsResponseTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import GetDependencyInsightsResponseTypeDef


def get_value() -> GetDependencyInsightsResponseTypeDef:
    return {
        "overview": ...,
    }


# GetDependencyInsightsResponseTypeDef definition

class GetDependencyInsightsResponseTypeDef(TypedDict):
    overview: str,
    insights: list[DependencyInsightTypeDef],  # (1)
    status: DependencyInsightsStatusType,  # (2)
    createdAt: datetime.datetime,
    errorCode: DependencyInsightsErrorCodeType,  # (3)
    errorMessage: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (4)
```

1. See `list[DependencyInsightTypeDef]`
2. See [:material-code-brackets: DependencyInsightsStatusType](./literals.md#dependencyinsightsstatustype)
3. See [:material-code-brackets: DependencyInsightsErrorCodeType](./literals.md#dependencyinsightserrorcodetype)
...
```python
# EksLabelSelectorOutputTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import EksLabelSelectorOutputTypeDef


def get_value() -> EksLabelSelectorOutputTypeDef:
    return {
        "matchLabels": ...,
    }


# EksLabelSelectorOutputTypeDef definition

class EksLabelSelectorOutputTypeDef(TypedDict):
    matchLabels: NotRequired[dict[str, str]],
    matchExpressions: NotRequired[list[EksLabelSelectorRequirementOutputTypeDef]],  # (1)
```

1. See `list[EksLabelSelectorRequirementOutputTypeDef]`
...
```python
# ListTestRunDependenciesRequestPaginateTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import ListTestRunDependenciesRequestPaginateTypeDef


def get_value() -> ListTestRunDependenciesRequestPaginateTypeDef:
    return {
        "testRunId": ...,
    }


# ListTestRunDependenciesRequestPaginateTypeDef definition
...
```python
# ListTestRunSourceEventsRequestPaginateTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import ListTestRunSourceEventsRequestPaginateTypeDef


def get_value() -> ListTestRunSourceEventsRequestPaginateTypeDef:
    return {
        "testRunId": ...,
    }


# ListTestRunSourceEventsRequestPaginateTypeDef definition
...
```python
# ListPolicyEventsRequestPaginateTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import ListPolicyEventsRequestPaginateTypeDef


def get_value() -> ListPolicyEventsRequestPaginateTypeDef:
    return {
        "policyArn": ...,
    }


# ListPolicyEventsRequestPaginateTypeDef definition

class ListPolicyEventsRequestPaginateTypeDef(TypedDict):
    policyArn: str,
    eventTypes: NotRequired[Sequence[PolicyEventTypeType]],  # (1)
    startTime: NotRequired[TimestampTypeDef],
    endTime: NotRequired[TimestampTypeDef],
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (2)
```

1. See `Sequence[PolicyEventTypeType]`
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)

## ListPolicyEventsRequestTypeDef

```python
# ListPolicyEventsRequestTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import ListPolicyEventsRequestTypeDef


def get_value() -> ListPolicyEventsRequestTypeDef:
    return {
        "policyArn": ...,
    }


# ListPolicyEventsRequestTypeDef definition
...
```python
# ListTestRunDependenciesResponseTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import ListTestRunDependenciesResponseTypeDef


def get_value() -> ListTestRunDependenciesResponseTypeDef:
    return {
        "dependencies": ...,
    }


# ListTestRunDependenciesResponseTypeDef definition

class ListTestRunDependenciesResponseTypeDef(TypedDict):
    dependencies: list[TestRunDependencySummaryTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[TestRunDependencySummaryTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
```python
# PolicyEventMetadataTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import PolicyEventMetadataTypeDef


def get_value() -> PolicyEventMetadataTypeDef:
    return {
        "policyAttachedToService": ...,
    }


# PolicyEventMetadataTypeDef definition

class PolicyEventMetadataTypeDef(TypedDict):
    policyAttachedToService: NotRequired[PolicyAttachedToServiceMetadataTypeDef],  # (1)
    policyDetachedFromService: NotRequired[PolicyDetachedFromServiceMetadataTypeDef],  # (2)
    policySharingRevoked: NotRequired[PolicySharingRevokedMetadataTypeDef],  # (3)
    policyDeleted: NotRequired[PolicyDeletedMetadataTypeDef],  # (4)
```

1. See [:material-code-braces: PolicyAttachedToServiceMetadataTypeDef](./type_defs.md#policyattachedtoservicemetadatatypedef)
2. See [:material-code-braces: PolicyDetachedFromServiceMetadataTypeDef](./type_defs.md#policydetachedfromservicemetadatatypedef)
3. See [:material-code-braces: PolicySharingRevokedMetadataTypeDef](./type_defs.md#policysharingrevokedmetadatatypedef)
4. See [:material-code-braces: PolicyDeletedMetadataTypeDef](./type_defs.md#policydeletedmetadatatypedef)
...
```python
# TestRunSourceEventDetailTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import TestRunSourceEventDetailTypeDef


def get_value() -> TestRunSourceEventDetailTypeDef:
    return {
        "alarmStateChange": ...,
    }


# TestRunSourceEventDetailTypeDef definition

class TestRunSourceEventDetailTypeDef(TypedDict):
    alarmStateChange: NotRequired[AlarmStateChangeDetailTypeDef],  # (1)
    error: NotRequired[TestRunSourceEventErrorTypeDef],  # (2)
```

1. See [:material-code-braces: AlarmStateChangeDetailTypeDef](./type_defs.md#alarmstatechangedetailtypedef)
2. See [:material-code-braces: TestRunSourceEventErrorTypeDef](./type_defs.md#testrunsourceeventerrortypedef)
...
class EksSourceOutputTypeDef(TypedDict):
    clusterArn: str,
    namespaces: list[str],
    labelSelector: NotRequired[EksLabelSelectorOutputTypeDef],  # (1)
```

1. See [:material-code-braces: EksLabelSelectorOutputTypeDef](./type_defs.md#ekslabelselectoroutputtypedef)

## EksLabelSelectorTypeDef

```python
# EksLabelSelectorTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import EksLabelSelectorTypeDef


def get_value() -> EksLabelSelectorTypeDef:
    return {
        "matchLabels": ...,
    }


# EksLabelSelectorTypeDef definition

class EksLabelSelectorTypeDef(TypedDict):
    matchLabels: NotRequired[Mapping[str, str]],
    matchExpressions: NotRequired[Sequence[EksLabelSelectorRequirementUnionTypeDef]],  # (1)
```

1. See `Sequence[EksLabelSelectorRequirementUnionTypeDef]`
...
```python
# PolicyEventDetailsTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import PolicyEventDetailsTypeDef


def get_value() -> PolicyEventDetailsTypeDef:
    return {
        "title": ...,
    }


# PolicyEventDetailsTypeDef definition

class PolicyEventDetailsTypeDef(TypedDict):
    title: str,
    description: str,
    eventMetadata: NotRequired[PolicyEventMetadataTypeDef],  # (1)
```

1. See [:material-code-braces: PolicyEventMetadataTypeDef](./type_defs.md#policyeventmetadatatypedef)
...
```python
# TestRunSourceEventTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import TestRunSourceEventTypeDef


def get_value() -> TestRunSourceEventTypeDef:
    return {
        "timestamp": ...,
    }


# TestRunSourceEventTypeDef definition

class TestRunSourceEventTypeDef(TypedDict):
    timestamp: datetime.datetime,
    sourceArn: str,
    eventType: TestRunSourceEventTypeType,  # (1)
    detail: TestRunSourceEventDetailTypeDef,  # (2)
```

1. See [:material-code-brackets: TestRunSourceEventTypeType](./literals.md#testrunsourceeventtypetype)
2. See [:material-code-braces: TestRunSourceEventDetailTypeDef](./type_defs.md#testrunsourceeventdetailtypedef)
...
```python
# PolicyEventTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import PolicyEventTypeDef


def get_value() -> PolicyEventTypeDef:
    return {
        "eventId": ...,
    }


# PolicyEventTypeDef definition

class PolicyEventTypeDef(TypedDict):
    eventId: str,
    timestamp: datetime.datetime,
    eventType: PolicyEventTypeType,  # (1)
    policyArn: str,
    actor: EventActorTypeDef,  # (2)
    eventDetails: PolicyEventDetailsTypeDef,  # (3)
```

1. See [:material-code-brackets: PolicyEventTypeType](./literals.md#policyeventtypetype)
2. See [:material-code-braces: EventActorTypeDef](./type_defs.md#eventactortypedef)
3. See [:material-code-braces: PolicyEventDetailsTypeDef](./type_defs.md#policyeventdetailstypedef)
...
```python
# ListTestRunSourceEventsResponseTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import ListTestRunSourceEventsResponseTypeDef


def get_value() -> ListTestRunSourceEventsResponseTypeDef:
    return {
        "testRunSourceEvents": ...,
    }


# ListTestRunSourceEventsResponseTypeDef definition

class ListTestRunSourceEventsResponseTypeDef(TypedDict):
    testRunSourceEvents: list[TestRunSourceEventTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[TestRunSourceEventTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
class EksSourceTypeDef(TypedDict):
    ...
    labelSelector: NotRequired[EksLabelSelectorUnionTypeDef],  # (1)
```

1. See [:material-code-braces: EksLabelSelectorUnionTypeDef](#ekslabelselectoruniontypedef)

## ListPolicyEventsResponseTypeDef

```python
# ListPolicyEventsResponseTypeDef TypedDict usage example

from mypy_boto3_resiliencehubv2.type_defs import ListPolicyEventsResponseTypeDef


def get_value() -> ListPolicyEventsResponseTypeDef:
    return {
        "events": ...,
    }


# ListPolicyEventsResponseTypeDef definition

class ListPolicyEventsResponseTypeDef(TypedDict):
    events: list[PolicyEventTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[PolicyEventTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
