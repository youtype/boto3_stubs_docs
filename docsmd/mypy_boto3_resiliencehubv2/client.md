...
### get\_dependency\_insights

Retrieves the dependency insights generated for a service.

Type annotations and code completion for `#!python boto3.client("resiliencehubv2").get_dependency_insights` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/resiliencehubv2/client/get_dependency_insights.html)

```python
# get_dependency_insights method definition

def get_dependency_insights(
    self,
    *,
    serviceArn: str,
) -> GetDependencyInsightsResponseTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: GetDependencyInsightsResponseTypeDef](./type_defs.md#getdependencyinsightsresponsetypedef)


```python
# get_dependency_insights method usage example with argument unpacking

kwargs: GetDependencyInsightsRequestTypeDef = {  # (1)
    "serviceArn": ...,
}

parent.get_dependency_insights(**kwargs)
```

1. See [:material-code-braces: GetDependencyInsightsRequestTypeDef](./type_defs.md#getdependencyinsightsrequesttypedef)
...
Type annotations and code completion for `#!python boto3.client("resiliencehubv2").list_policy_events` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/resiliencehubv2/client/list_policy_events.html)

```python
# list_policy_events method definition

def list_policy_events(
    self,
    *,
    policyArn: str,
    eventTypes: Sequence[PolicyEventTypeType] = ...,  # (1)
    startTime: TimestampTypeDef = ...,
    endTime: TimestampTypeDef = ...,
    maxResults: int = ...,
    nextToken: str = ...,
) -> ListPolicyEventsResponseTypeDef:  # (2)
    ...
```

1. See `Sequence[PolicyEventTypeType]`
2. See [:material-code-braces: ListPolicyEventsResponseTypeDef](./type_defs.md#listpolicyeventsresponsetypedef)


```python
# list_policy_events method usage example with argument unpacking

kwargs: ListPolicyEventsRequestTypeDef = {  # (1)
    "policyArn": ...,
}

parent.list_policy_events(**kwargs)
```

1. See [:material-code-braces: ListPolicyEventsRequestTypeDef](./type_defs.md#listpolicyeventsrequesttypedef)
...
### list\_test\_run\_dependencies

Lists the dependencies that a test run blocked.

Type annotations and code completion for `#!python boto3.client("resiliencehubv2").list_test_run_dependencies` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/resiliencehubv2/client/list_test_run_dependencies.html)

```python
# list_test_run_dependencies method definition
...
def list_test_run_dependencies(
    ...
    *,
    ...
    maxResults: int = ...,
    nextToken: str = ...,
) -> ListTestRunDependenciesResponseTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: ListTestRunDependenciesResponseTypeDef](./type_defs.md#listtestrundependenciesresponsetypedef)


```python
# list_test_run_dependencies method usage example with argument unpacking

kwargs: ListTestRunDependenciesRequestTypeDef = {  # (1)
    "testRunId": ...,
    "serviceArn": ...,
}

parent.list_test_run_dependencies(**kwargs)
```

1. See [:material-code-braces: ListTestRunDependenciesRequestTypeDef](./type_defs.md#listtestrundependenciesrequesttypedef)
...
### list\_test\_run\_source\_events

Lists the state-change events observed for a test run monitoring source.

Type annotations and code completion for `#!python boto3.client("resiliencehubv2").list_test_run_source_events` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/resiliencehubv2/client/list_test_run_source_events.html)

```python
# list_test_run_source_events method definition
...
def list_test_run_source_events(
    ...
    *,
    ...
    maxResults: int = ...,
    nextToken: str = ...,
) -> ListTestRunSourceEventsResponseTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: ListTestRunSourceEventsResponseTypeDef](./type_defs.md#listtestrunsourceeventsresponsetypedef)


```python
# list_test_run_source_events method usage example with argument unpacking

kwargs: ListTestRunSourceEventsRequestTypeDef = {  # (1)
    "testRunId": ...,
    "serviceArn": ...,
    "sourceArn": ...,
}

parent.list_test_run_source_events(**kwargs)
```

1. See [:material-code-braces: ListTestRunSourceEventsRequestTypeDef](./type_defs.md#listtestrunsourceeventsrequesttypedef)
...
### start\_dependency\_insights

Starts generating dependency insights for a service.

Type annotations and code completion for `#!python boto3.client("resiliencehubv2").start_dependency_insights` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/resiliencehubv2/client/start_dependency_insights.html)

```python
# start_dependency_insights method definition
...
def start_dependency_insights(
    ...
    *,
    serviceArn: str,
    clientToken: str = ...,
) -> StartDependencyInsightsResponseTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: StartDependencyInsightsResponseTypeDef](./type_defs.md#startdependencyinsightsresponsetypedef)


```python
# start_dependency_insights method usage example with argument unpacking

kwargs: StartDependencyInsightsRequestTypeDef = {  # (1)
    "serviceArn": ...,
}

parent.start_dependency_insights(**kwargs)
```

1. See [:material-code-braces: StartDependencyInsightsRequestTypeDef](./type_defs.md#startdependencyinsightsrequesttypedef)
...
- `client.get_paginator("list_policy_events")` -> [ListPolicyEventsPaginator](./paginators.md#listpolicyeventspaginator)
...
- `client.get_paginator("list_test_run_dependencies")` -> [ListTestRunDependenciesPaginator](./paginators.md#listtestrundependenciespaginator)
- `client.get_paginator("list_test_run_events")` -> [ListTestRunEventsPaginator](./paginators.md#listtestruneventspaginator)
- `client.get_paginator("list_test_run_source_events")` -> [ListTestRunSourceEventsPaginator](./paginators.md#listtestrunsourceeventspaginator)
