...
from mypy_boto3_resiliencehubv2.literals import AlarmStateType
...
```python
# DependencyInsightsErrorCodeType usage example
from mypy_boto3_resiliencehubv2.literals import DependencyInsightsErrorCodeType

def get_value() -> DependencyInsightsErrorCodeType:
    return "INSUFFICIENT_DATA"
```

```python
# DependencyInsightsErrorCodeType definition
...
```python
# DependencyInsightsStatusType usage example
from mypy_boto3_resiliencehubv2.literals import DependencyInsightsStatusType

def get_value() -> DependencyInsightsStatusType:
    return "COMPLETED"
```

```python
# DependencyInsightsStatusType definition
DependencyInsightsStatusType = Literal[
    "COMPLETED",
    "FAILED",
    "IN_PROGRESS",
]
...
```python
# EksLabelSelectorOperatorType usage example
from mypy_boto3_resiliencehubv2.literals import EksLabelSelectorOperatorType

def get_value() -> EksLabelSelectorOperatorType:
    return "DOES_NOT_EXIST"
```

```python
# EksLabelSelectorOperatorType definition
EksLabelSelectorOperatorType = Literal[
    "DOES_NOT_EXIST",
    "EXISTS",
    "IN",
    "NOT_IN",
...
```python
# InsightsCategoryType usage example
from mypy_boto3_resiliencehubv2.literals import InsightsCategoryType

def get_value() -> InsightsCategoryType:
    return "AWS_SERVICE"
```

```python
# InsightsCategoryType definition
...
```python
# ListPolicyEventsPaginatorName usage example
from mypy_boto3_resiliencehubv2.literals import ListPolicyEventsPaginatorName

def get_value() -> ListPolicyEventsPaginatorName:
    return "list_policy_events"
```

```python
# ListPolicyEventsPaginatorName definition
ListPolicyEventsPaginatorName = Literal[
    "list_policy_events",
]
```
...
```python
# ListTestRunDependenciesPaginatorName usage example
from mypy_boto3_resiliencehubv2.literals import ListTestRunDependenciesPaginatorName

def get_value() -> ListTestRunDependenciesPaginatorName:
    return "list_test_run_dependencies"
```

```python
# ListTestRunDependenciesPaginatorName definition
ListTestRunDependenciesPaginatorName = Literal[
...
```python
# ListTestRunSourceEventsPaginatorName usage example
from mypy_boto3_resiliencehubv2.literals import ListTestRunSourceEventsPaginatorName

def get_value() -> ListTestRunSourceEventsPaginatorName:
    return "list_test_run_source_events"
```

```python
# ListTestRunSourceEventsPaginatorName definition
ListTestRunSourceEventsPaginatorName = Literal[
...
```python
# PolicyDisassociationReasonType usage example
from mypy_boto3_resiliencehubv2.literals import PolicyDisassociationReasonType

def get_value() -> PolicyDisassociationReasonType:
    return "POLICY_DELETED"
```

```python
# PolicyDisassociationReasonType definition
PolicyDisassociationReasonType = Literal[
    "POLICY_DELETED",
    "REPLACED_BY_UPDATE",
    "SHARING_REVOKED",
]
...
```python
# PolicyEventTypeType usage example
from mypy_boto3_resiliencehubv2.literals import PolicyEventTypeType

def get_value() -> PolicyEventTypeType:
    return "POLICY_ATTACHED_TO_SERVICE"
```

```python
# PolicyEventTypeType definition
...
```python
# TestRunDependencySourceType usage example
from mypy_boto3_resiliencehubv2.literals import TestRunDependencySourceType

def get_value() -> TestRunDependencySourceType:
    return "DISCOVERED"
```

```python
# TestRunDependencySourceType definition
TestRunDependencySourceType = Literal[
    "DISCOVERED",
    "MANUAL",
]
```
...
```python
# TestRunSourceEventErrorCodeType usage example
from mypy_boto3_resiliencehubv2.literals import TestRunSourceEventErrorCodeType

def get_value() -> TestRunSourceEventErrorCodeType:
    return "ACCESS_DENIED"
```

```python
# TestRunSourceEventErrorCodeType definition
TestRunSourceEventErrorCodeType = Literal[
    "ACCESS_DENIED",
    "INTERNAL_ERROR",
]
```
...
```python
# TestRunSourceEventTypeType usage example
from mypy_boto3_resiliencehubv2.literals import TestRunSourceEventTypeType

def get_value() -> TestRunSourceEventTypeType:
    return "ALARM"
```

```python
# TestRunSourceEventTypeType definition
TestRunSourceEventTypeType = Literal[
    "ALARM",
]
```
