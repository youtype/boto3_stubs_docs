...
> [Index](../README.md) > [AccountAccess](./README.md) > Literals
...
```python
# ApplicationActiveWaiterName definition
ApplicationActiveWaiterName = Literal[
    "application_active",
]
```
## ErrorCodeType
...
from mypy_boto3_account_access.literals import ErrorCodeType
...
from mypy_boto3_account_access.literals import ListApplicationsPaginatorName
...
from mypy_boto3_account_access.literals import ListEntitlementsPaginatorName
...
from mypy_boto3_account_access.literals import StatusType
...
```python
# AccountAccessServiceName usage example
from mypy_boto3_account_access.literals import AccountAccessServiceName

def get_value() -> AccountAccessServiceName:
    return "account-access"
```

```python
# AccountAccessServiceName definition
AccountAccessServiceName = Literal[
    "account-access",
]
```
## ServiceName
...
from mypy_boto3_account_access.literals import ServiceName
...
from mypy_boto3_account_access.literals import ResourceServiceName
...
from mypy_boto3_account_access.literals import PaginatorName
...
from mypy_boto3_account_access.literals import WaiterName
