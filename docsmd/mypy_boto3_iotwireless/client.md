...
def get_position_estimate(
    ...
    *,
    ...
    Ip: IpTypeDef = ...,  # (3)
    Gnss: GnssTypeDef = ...,  # (4)
    GnssMultiFrame: GnssMultiFrameTypeDef = ...,  # (5)
    Timestamp: TimestampTypeDef = ...,
    AdvancedConfiguration: AdvancedConfigurationTypeDef = ...,  # (6)
) -> GetPositionEstimateResponseTypeDef:  # (7)
    ...
```
...
7. See [:material-code-braces: GetPositionEstimateResponseTypeDef](./type_defs.md#getpositionestimateresponsetypedef)
