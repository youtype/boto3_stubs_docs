...
```python
# GnssCaptureTypeDef TypedDict usage example

from mypy_boto3_iotwireless.type_defs import GnssCaptureTypeDef


def get_value() -> GnssCaptureTypeDef:
    return {
        "Payload": ...,
    }


# GnssCaptureTypeDef definition
...
```python
# GnssMultiFrameTypeDef TypedDict usage example

from mypy_boto3_iotwireless.type_defs import GnssMultiFrameTypeDef


def get_value() -> GnssMultiFrameTypeDef:
    return {
        "Captures": ...,
    }


# GnssMultiFrameTypeDef definition

class GnssMultiFrameTypeDef(TypedDict):
    Captures: Sequence[GnssCaptureTypeDef],  # (1)
    CaptureTimeAccuracy: NotRequired[float],
    AssistPosition: NotRequired[Sequence[float]],
    AssistAltitude: NotRequired[float],
    Use2DSolver: NotRequired[bool],
...
1. See `Sequence[GnssCaptureTypeDef]`
...
class GetPositionEstimateRequestTypeDef(TypedDict):
    ...
    GnssMultiFrame: NotRequired[GnssMultiFrameTypeDef],  # (5)
    Timestamp: NotRequired[TimestampTypeDef],
    AdvancedConfiguration: NotRequired[AdvancedConfigurationTypeDef],  # (6)
```
...
5. See [:material-code-braces: GnssMultiFrameTypeDef](./type_defs.md#gnssmultiframetypedef)
6. See [:material-code-braces: AdvancedConfigurationTypeDef](./type_defs.md#advancedconfigurationtypedef)
