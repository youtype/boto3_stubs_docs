...
### attach\_cluster\_node\_network\_interface

Attaches an elastic network interface (ENI) to a node in a HyperPod cluster.

Type annotations and code completion for `#!python boto3.client("sagemaker").attach_cluster_node_network_interface` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/sagemaker/client/attach_cluster_node_network_interface.html)

```python
# attach_cluster_node_network_interface method definition
...
) -> AttachClusterNodeNetworkInterfaceResponseTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: AttachClusterNodeNetworkInterfaceResponseTypeDef](./type_defs.md#attachclusternodenetworkinterfaceresponsetypedef)


```python
# attach_cluster_node_network_interface method usage example with argument unpacking

kwargs: AttachClusterNodeNetworkInterfaceRequestTypeDef = {  # (1)
    "ClusterName": ...,
    "NodeId": ...,
    "NetworkInterfaceId": ...,
}

parent.attach_cluster_node_network_interface(**kwargs)
```

1. See [:material-code-braces: AttachClusterNodeNetworkInterfaceRequestTypeDef](./type_defs.md#attachclusternodenetworkinterfacerequesttypedef)
...
def create_processing_job(
    ...
    *,
    ...
    ProcessingResources: ProcessingResourcesUnionTypeDef,  # (1)
...
1. See [:material-code-braces: ProcessingResourcesUnionTypeDef](#processingresourcesuniontypedef)
