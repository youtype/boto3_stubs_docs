...
```python
# WhatsAppCallSettingsUnionTypeDef Union usage example

from mypy_boto3_socialmessaging.type_defs import WhatsAppCallSettingsUnionTypeDef


def get_value() -> WhatsAppCallSettingsUnionTypeDef:
    return ...


# WhatsAppCallSettingsUnionTypeDef definition

WhatsAppCallSettingsUnionTypeDef = Union[
    WhatsAppCallSettingsTypeDef,  # (1)
    WhatsAppCallSettingsOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: WhatsAppCallSettingsTypeDef](./type_defs.md#whatsappcallsettingstypedef)
2. See [:material-code-braces: WhatsAppCallSettingsOutputTypeDef](./type_defs.md#whatsappcallsettingsoutputtypedef)
...
```python
# GetWhatsAppCallPermissionInputTypeDef TypedDict usage example

from mypy_boto3_socialmessaging.type_defs import GetWhatsAppCallPermissionInputTypeDef


def get_value() -> GetWhatsAppCallPermissionInputTypeDef:
    return {
        "originationPhoneNumberId": ...,
    }


# GetWhatsAppCallPermissionInputTypeDef definition
...
```python
# WhatsAppCallPermissionTypeDef TypedDict usage example

from mypy_boto3_socialmessaging.type_defs import WhatsAppCallPermissionTypeDef


def get_value() -> WhatsAppCallPermissionTypeDef:
    return {
        "status": ...,
    }


# WhatsAppCallPermissionTypeDef definition
...
```python
# WhatsAppCallPermissionLimitTypeDef TypedDict usage example

from mypy_boto3_socialmessaging.type_defs import WhatsAppCallPermissionLimitTypeDef


def get_value() -> WhatsAppCallPermissionLimitTypeDef:
    return {
        "timePeriod": ...,
    }


# WhatsAppCallPermissionLimitTypeDef definition

class WhatsAppCallPermissionLimitTypeDef(TypedDict):
    timePeriod: str,
    maxAllowed: int,
    currentUsage: int,
    limitExpirationTime: NotRequired[datetime.datetime],
```
...
```python
# WhatsAppTimeOfDayTypeDef TypedDict usage example

from mypy_boto3_socialmessaging.type_defs import WhatsAppTimeOfDayTypeDef


def get_value() -> WhatsAppTimeOfDayTypeDef:
    return {
        "hours": ...,
    }


# WhatsAppTimeOfDayTypeDef definition
...
```python
# SendWhatsAppCallEventOutputTypeDef TypedDict usage example

from mypy_boto3_socialmessaging.type_defs import SendWhatsAppCallEventOutputTypeDef


def get_value() -> SendWhatsAppCallEventOutputTypeDef:
    return {
        "callId": ...,
    }


# SendWhatsAppCallEventOutputTypeDef definition
...
```python
# UpdateLinkedWhatsAppBusinessAccountPhoneNumberOutputTypeDef TypedDict usage example

from mypy_boto3_socialmessaging.type_defs import UpdateLinkedWhatsAppBusinessAccountPhoneNumberOutputTypeDef


def get_value() -> UpdateLinkedWhatsAppBusinessAccountPhoneNumberOutputTypeDef:
    return {
        "phoneNumberId": ...,
    }


# UpdateLinkedWhatsAppBusinessAccountPhoneNumberOutputTypeDef definition
...
```python
# SendWhatsAppCallEventInputTypeDef TypedDict usage example

from mypy_boto3_socialmessaging.type_defs import SendWhatsAppCallEventInputTypeDef


def get_value() -> SendWhatsAppCallEventInputTypeDef:
    return {
        "originationPhoneNumberId": ...,
    }


# SendWhatsAppCallEventInputTypeDef definition
...
```python
# WhatsAppCallPermissionActionTypeDef TypedDict usage example

from mypy_boto3_socialmessaging.type_defs import WhatsAppCallPermissionActionTypeDef


def get_value() -> WhatsAppCallPermissionActionTypeDef:
    return {
        "actionName": ...,
    }


# WhatsAppCallPermissionActionTypeDef definition

class WhatsAppCallPermissionActionTypeDef(TypedDict):
    actionName: str,
    canPerformAction: bool,
    limits: list[WhatsAppCallPermissionLimitTypeDef],  # (1)
```

1. See `list[WhatsAppCallPermissionLimitTypeDef]`

## WhatsAppHolidayScheduleEntryTypeDef

```python
# WhatsAppHolidayScheduleEntryTypeDef TypedDict usage example

from mypy_boto3_socialmessaging.type_defs import WhatsAppHolidayScheduleEntryTypeDef


def get_value() -> WhatsAppHolidayScheduleEntryTypeDef:
    return {
        "date": ...,
    }


# WhatsAppHolidayScheduleEntryTypeDef definition

class WhatsAppHolidayScheduleEntryTypeDef(TypedDict):
    date: str,
    startTime: WhatsAppTimeOfDayTypeDef,  # (1)
    endTime: WhatsAppTimeOfDayTypeDef,  # (1)
```

1. See [:material-code-braces: WhatsAppTimeOfDayTypeDef](./type_defs.md#whatsapptimeofdaytypedef)
2. See [:material-code-braces: WhatsAppTimeOfDayTypeDef](./type_defs.md#whatsapptimeofdaytypedef)

## WhatsAppWeeklyOperatingHoursEntryTypeDef

```python
# WhatsAppWeeklyOperatingHoursEntryTypeDef TypedDict usage example

from mypy_boto3_socialmessaging.type_defs import WhatsAppWeeklyOperatingHoursEntryTypeDef


def get_value() -> WhatsAppWeeklyOperatingHoursEntryTypeDef:
    return {
        "dayOfWeek": ...,
    }


# WhatsAppWeeklyOperatingHoursEntryTypeDef definition

class WhatsAppWeeklyOperatingHoursEntryTypeDef(TypedDict):
    dayOfWeek: WhatsAppDayOfWeekType,  # (1)
    openTime: WhatsAppTimeOfDayTypeDef,  # (2)
    closeTime: WhatsAppTimeOfDayTypeDef,  # (2)
```

1. See [:material-code-brackets: WhatsAppDayOfWeekType](./literals.md#whatsappdayofweektype)
2. See [:material-code-braces: WhatsAppTimeOfDayTypeDef](./type_defs.md#whatsapptimeofdaytypedef)
3. See [:material-code-braces: WhatsAppTimeOfDayTypeDef](./type_defs.md#whatsapptimeofdaytypedef)
...
```python
# GetWhatsAppCallPermissionOutputTypeDef TypedDict usage example

from mypy_boto3_socialmessaging.type_defs import GetWhatsAppCallPermissionOutputTypeDef


def get_value() -> GetWhatsAppCallPermissionOutputTypeDef:
    return {
        "permission": ...,
    }


# GetWhatsAppCallPermissionOutputTypeDef definition

class GetWhatsAppCallPermissionOutputTypeDef(TypedDict):
    permission: WhatsAppCallPermissionTypeDef,  # (1)
    actions: list[WhatsAppCallPermissionActionTypeDef],  # (2)
    ResponseMetadata: ResponseMetadataTypeDef,  # (3)
```

1. See [:material-code-braces: WhatsAppCallPermissionTypeDef](./type_defs.md#whatsappcallpermissiontypedef)
2. See `list[WhatsAppCallPermissionActionTypeDef]`
3. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## WhatsAppCallHoursOutputTypeDef

```python
# WhatsAppCallHoursOutputTypeDef TypedDict usage example

from mypy_boto3_socialmessaging.type_defs import WhatsAppCallHoursOutputTypeDef


def get_value() -> WhatsAppCallHoursOutputTypeDef:
    return {
        "enabled": ...,
    }


# WhatsAppCallHoursOutputTypeDef definition

class WhatsAppCallHoursOutputTypeDef(TypedDict):
    enabled: bool,
    timezone: str,
    weeklyOperatingHours: list[WhatsAppWeeklyOperatingHoursEntryTypeDef],  # (1)
    holidaySchedule: NotRequired[list[WhatsAppHolidayScheduleEntryTypeDef]],  # (2)
```

1. See `list[WhatsAppWeeklyOperatingHoursEntryTypeDef]`
2. See `list[WhatsAppHolidayScheduleEntryTypeDef]`

## WhatsAppCallHoursTypeDef

```python
# WhatsAppCallHoursTypeDef TypedDict usage example

from mypy_boto3_socialmessaging.type_defs import WhatsAppCallHoursTypeDef


def get_value() -> WhatsAppCallHoursTypeDef:
    return {
        "enabled": ...,
    }


# WhatsAppCallHoursTypeDef definition

class WhatsAppCallHoursTypeDef(TypedDict):
    enabled: bool,
    timezone: str,
    weeklyOperatingHours: Sequence[WhatsAppWeeklyOperatingHoursEntryTypeDef],  # (1)
    holidaySchedule: NotRequired[Sequence[WhatsAppHolidayScheduleEntryTypeDef]],  # (2)
```

1. See `Sequence[WhatsAppWeeklyOperatingHoursEntryTypeDef]`
2. See `Sequence[WhatsAppHolidayScheduleEntryTypeDef]`
...
```python
# WhatsAppCallSettingsOutputTypeDef TypedDict usage example

from mypy_boto3_socialmessaging.type_defs import WhatsAppCallSettingsOutputTypeDef


def get_value() -> WhatsAppCallSettingsOutputTypeDef:
    return {
        "callEnabled": ...,
    }


# WhatsAppCallSettingsOutputTypeDef definition

class WhatsAppCallSettingsOutputTypeDef(TypedDict):
    callEnabled: bool,
    callHours: NotRequired[WhatsAppCallHoursOutputTypeDef],  # (1)
    callIconVisibility: NotRequired[str],
    callbackPermissionStatus: NotRequired[str],
```

1. See [:material-code-braces: WhatsAppCallHoursOutputTypeDef](./type_defs.md#whatsappcallhoursoutputtypedef)

## WhatsAppCallSettingsTypeDef

```python
# WhatsAppCallSettingsTypeDef TypedDict usage example

from mypy_boto3_socialmessaging.type_defs import WhatsAppCallSettingsTypeDef


def get_value() -> WhatsAppCallSettingsTypeDef:
    return {
        "callEnabled": ...,
    }


# WhatsAppCallSettingsTypeDef definition

class WhatsAppCallSettingsTypeDef(TypedDict):
    callEnabled: bool,
    callHours: NotRequired[WhatsAppCallHoursTypeDef],  # (1)
    callIconVisibility: NotRequired[str],
    callbackPermissionStatus: NotRequired[str],
```

1. See [:material-code-braces: WhatsAppCallHoursTypeDef](./type_defs.md#whatsappcallhourstypedef)
...
class GetLinkedWhatsAppBusinessAccountPhoneNumberOutputTypeDef(TypedDict):
    ...
    linkedWhatsAppBusinessAccountId: str,
    callSettings: WhatsAppCallSettingsOutputTypeDef,  # (2)
    ResponseMetadata: ResponseMetadataTypeDef,  # (3)
```
...
```python
# UpdateLinkedWhatsAppBusinessAccountPhoneNumberInputTypeDef TypedDict usage example

from mypy_boto3_socialmessaging.type_defs import UpdateLinkedWhatsAppBusinessAccountPhoneNumberInputTypeDef


def get_value() -> UpdateLinkedWhatsAppBusinessAccountPhoneNumberInputTypeDef:
    return {
        "id": ...,
    }


# UpdateLinkedWhatsAppBusinessAccountPhoneNumberInputTypeDef definition

class UpdateLinkedWhatsAppBusinessAccountPhoneNumberInputTypeDef(TypedDict):
    id: str,
    callSettings: WhatsAppCallSettingsUnionTypeDef,  # (1)
```

1. See [:material-code-braces: WhatsAppCallSettingsUnionTypeDef](#whatsappcallsettingsuniontypedef)
