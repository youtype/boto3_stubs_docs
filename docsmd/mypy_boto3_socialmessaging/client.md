...
### get\_whatsapp\_call\_permission
...
Type annotations and code completion for `#!python boto3.client("socialmessaging").get_whatsapp_call_permission` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/socialmessaging/client/get_whatsapp_call_permission.html)

```python
# get_whatsapp_call_permission method definition
...
def get_whatsapp_call_permission(
    ...
    *,
    ...
    endUserBsuid: str = ...,
) -> GetWhatsAppCallPermissionOutputTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: GetWhatsAppCallPermissionOutputTypeDef](./type_defs.md#getwhatsappcallpermissionoutputtypedef)


```python
# get_whatsapp_call_permission method usage example with argument unpacking

kwargs: GetWhatsAppCallPermissionInputTypeDef = {  # (1)
    "originationPhoneNumberId": ...,
}

parent.get_whatsapp_call_permission(**kwargs)
```

1. See [:material-code-braces: GetWhatsAppCallPermissionInputTypeDef](./type_defs.md#getwhatsappcallpermissioninputtypedef)
...
### send\_whatsapp\_call\_event

Sends a WhatsApp calling event, such as connecting or terminating a call, for a
business phone number.

Type annotations and code completion for `#!python boto3.client("socialmessaging").send_whatsapp_call_event` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/socialmessaging/client/send_whatsapp_call_event.html)

```python
# send_whatsapp_call_event method definition
...
) -> SendWhatsAppCallEventOutputTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: SendWhatsAppCallEventOutputTypeDef](./type_defs.md#sendwhatsappcalleventoutputtypedef)


```python
# send_whatsapp_call_event method usage example with argument unpacking

kwargs: SendWhatsAppCallEventInputTypeDef = {  # (1)
    "originationPhoneNumberId": ...,
    "metaApiVersion": ...,
    "callEvent": ...,
}

parent.send_whatsapp_call_event(**kwargs)
```

1. See [:material-code-braces: SendWhatsAppCallEventInputTypeDef](./type_defs.md#sendwhatsappcalleventinputtypedef)
...
### update\_linked\_whatsapp\_business\_account\_phone\_number
...
Type annotations and code completion for `#!python boto3.client("socialmessaging").update_linked_whatsapp_business_account_phone_number` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/socialmessaging/client/update_linked_whatsapp_business_account_phone_number.html)

```python
# update_linked_whatsapp_business_account_phone_number method definition
...
) -> UpdateLinkedWhatsAppBusinessAccountPhoneNumberOutputTypeDef:  # (2)
    ...
```

1. See [:material-code-braces: WhatsAppCallSettingsUnionTypeDef](#whatsappcallsettingsuniontypedef)
2. See [:material-code-braces: UpdateLinkedWhatsAppBusinessAccountPhoneNumberOutputTypeDef](./type_defs.md#updatelinkedwhatsappbusinessaccountphonenumberoutputtypedef)


```python
# update_linked_whatsapp_business_account_phone_number method usage example with argument unpacking

kwargs: UpdateLinkedWhatsAppBusinessAccountPhoneNumberInputTypeDef = {  # (1)
    "id": ...,
    "callSettings": ...,
}

parent.update_linked_whatsapp_business_account_phone_number(**kwargs)
```

1. See [:material-code-braces: UpdateLinkedWhatsAppBusinessAccountPhoneNumberInputTypeDef](./type_defs.md#updatelinkedwhatsappbusinessaccountphonenumberinputtypedef)
