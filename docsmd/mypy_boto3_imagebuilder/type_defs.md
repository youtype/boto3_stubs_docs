...
```python
# ComponentFailureContextTypeDef TypedDict usage example

from mypy_boto3_imagebuilder.type_defs import ComponentFailureContextTypeDef


def get_value() -> ComponentFailureContextTypeDef:
    return {
        "componentArn": ...,
    }


# ComponentFailureContextTypeDef definition
...
```python
# RegionFailureTypeDef TypedDict usage example

from mypy_boto3_imagebuilder.type_defs import RegionFailureTypeDef


def get_value() -> RegionFailureTypeDef:
    return {
        "region": ...,
    }


# RegionFailureTypeDef definition

class RegionFailureTypeDef(TypedDict):
    region: NotRequired[str],
    status: NotRequired[RegionFailureStatusType],  # (1)
    imageConfigurationStep: NotRequired[ImageConfigurationStepType],  # (2)
    errorMessage: NotRequired[str],
    targetAccountId: NotRequired[str],
```

1. See [:material-code-brackets: RegionFailureStatusType](./literals.md#regionfailurestatustype)
2. See [:material-code-brackets: ImageConfigurationStepType](./literals.md#imageconfigurationsteptype)
...
```python
# DistributionFailureContextTypeDef TypedDict usage example

from mypy_boto3_imagebuilder.type_defs import DistributionFailureContextTypeDef


def get_value() -> DistributionFailureContextTypeDef:
    return {
        "errorMessage": ...,
    }


# DistributionFailureContextTypeDef definition

class DistributionFailureContextTypeDef(TypedDict):
    errorMessage: NotRequired[str],
    regionFailures: NotRequired[list[RegionFailureTypeDef]],  # (1)
```

1. See `list[RegionFailureTypeDef]`
...
```python
# ImageFailureContextTypeDef TypedDict usage example

from mypy_boto3_imagebuilder.type_defs import ImageFailureContextTypeDef


def get_value() -> ImageFailureContextTypeDef:
    return {
        "imageStatus": ...,
    }


# ImageFailureContextTypeDef definition

class ImageFailureContextTypeDef(TypedDict):
    imageStatus: NotRequired[ImageStatusType],  # (1)
    workflowExecutionId: NotRequired[str],
    workflowArn: NotRequired[str],
    stepExecutionId: NotRequired[str],
    failedStep: NotRequired[str],
    componentFailure: NotRequired[ComponentFailureContextTypeDef],  # (2)
    distributionFailure: NotRequired[DistributionFailureContextTypeDef],  # (3)
```

1. See [:material-code-brackets: ImageStatusType](./literals.md#imagestatustype)
2. See [:material-code-braces: ComponentFailureContextTypeDef](./type_defs.md#componentfailurecontexttypedef)
3. See [:material-code-braces: DistributionFailureContextTypeDef](./type_defs.md#distributionfailurecontexttypedef)
...
class ImageStateTypeDef(TypedDict):
    ...
    reason: NotRequired[str],
    failureContext: NotRequired[ImageFailureContextTypeDef],  # (2)
```

1. See [:material-code-brackets: ImageStatusType](./literals.md#imagestatustype)
2. See [:material-code-braces: ImageFailureContextTypeDef](./type_defs.md#imagefailurecontexttypedef)
