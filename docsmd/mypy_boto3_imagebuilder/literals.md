...
```python
# ImageConfigurationStepType usage example
from mypy_boto3_imagebuilder.literals import ImageConfigurationStepType

def get_value() -> ImageConfigurationStepType:
    return "ASSOCIATE_LICENSES"
```

```python
# ImageConfigurationStepType definition
...
```python
# RegionFailureStatusType usage example
from mypy_boto3_imagebuilder.literals import RegionFailureStatusType

def get_value() -> RegionFailureStatusType:
    return "CANCELLED"
```

```python
# RegionFailureStatusType definition
RegionFailureStatusType = Literal[
    "CANCELLED",
    "FAILED",
    "TIMED_OUT",
]
