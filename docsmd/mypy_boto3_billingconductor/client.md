...
### get\_billing\_transfer\_preference

Retrieves the auto billing group creation preference for a billing transfer.

Type annotations and code completion for `#!python boto3.client("billingconductor").get_billing_transfer_preference` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/billingconductor/client/get_billing_transfer_preference.html)

```python
# get_billing_transfer_preference method definition

def get_billing_transfer_preference(
    self,
    *,
    ResponsibilityTransferArn: str,
) -> GetBillingTransferPreferenceOutputTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: GetBillingTransferPreferenceOutputTypeDef](./type_defs.md#getbillingtransferpreferenceoutputtypedef)


```python
# get_billing_transfer_preference method usage example with argument unpacking

kwargs: GetBillingTransferPreferenceInputTypeDef = {  # (1)
    "ResponsibilityTransferArn": ...,
}

parent.get_billing_transfer_preference(**kwargs)
```

1. See [:material-code-braces: GetBillingTransferPreferenceInputTypeDef](./type_defs.md#getbillingtransferpreferenceinputtypedef)
...
### update\_billing\_transfer\_preference

Sets the auto billing group creation preference for a billing transfer.

Type annotations and code completion for `#!python boto3.client("billingconductor").update_billing_transfer_preference` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/billingconductor/client/update_billing_transfer_preference.html)

```python
# update_billing_transfer_preference method definition
...
def update_billing_transfer_preference(
    ...
    *,
    ...
    ClientToken: str = ...,
) -> UpdateBillingTransferPreferenceOutputTypeDef:  # (2)
    ...
```
...
2. See [:material-code-braces: UpdateBillingTransferPreferenceOutputTypeDef](./type_defs.md#updatebillingtransferpreferenceoutputtypedef)


```python
# update_billing_transfer_preference method usage example with argument unpacking

kwargs: UpdateBillingTransferPreferenceInputTypeDef = {  # (1)
    "ResponsibilityTransferArn": ...,
    "AutoBillingTransferBillingGroupCreation": ...,
}

parent.update_billing_transfer_preference(**kwargs)
```

1. See [:material-code-braces: UpdateBillingTransferPreferenceInputTypeDef](./type_defs.md#updatebillingtransferpreferenceinputtypedef)
...
def update_pricing_rule(
    ...
    *,
    ...
    ModifierPercentage: float = ...,
    Tiering: UpdateTieringInputUnionTypeDef = ...,  # (2)
