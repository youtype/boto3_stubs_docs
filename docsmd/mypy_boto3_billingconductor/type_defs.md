...
```python
# UpdateTieringInputUnionTypeDef Union usage example

from mypy_boto3_billingconductor.type_defs import UpdateTieringInputUnionTypeDef


def get_value() -> UpdateTieringInputUnionTypeDef:
    return ...


# UpdateTieringInputUnionTypeDef definition

UpdateTieringInputUnionTypeDef = Union[
    UpdateTieringInputTypeDef,  # (1)
    UpdateTieringInputOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: UpdateTieringInputTypeDef](./type_defs.md#updatetieringinputtypedef)
2. See [:material-code-braces: UpdateTieringInputOutputTypeDef](./type_defs.md#updatetieringinputoutputtypedef)
...
```python
# AutoTransferBillingGroupCreationPreferenceTypeDef TypedDict usage example

from mypy_boto3_billingconductor.type_defs import AutoTransferBillingGroupCreationPreferenceTypeDef


def get_value() -> AutoTransferBillingGroupCreationPreferenceTypeDef:
    return {
        "Enabled": ...,
    }


# AutoTransferBillingGroupCreationPreferenceTypeDef definition
...
```python
# CustomTierTypeDef TypedDict usage example

from mypy_boto3_billingconductor.type_defs import CustomTierTypeDef


def get_value() -> CustomTierTypeDef:
    return {
        "BeginRangeInclusive": ...,
    }


# CustomTierTypeDef definition
...
```python
# GetBillingTransferPreferenceInputTypeDef TypedDict usage example

from mypy_boto3_billingconductor.type_defs import GetBillingTransferPreferenceInputTypeDef


def get_value() -> GetBillingTransferPreferenceInputTypeDef:
    return {
        "ResponsibilityTransferArn": ...,
    }


# GetBillingTransferPreferenceInputTypeDef definition
...
```python
# GetBillingTransferPreferenceOutputTypeDef TypedDict usage example

from mypy_boto3_billingconductor.type_defs import GetBillingTransferPreferenceOutputTypeDef


def get_value() -> GetBillingTransferPreferenceOutputTypeDef:
    return {
        "ResponsibilityTransferArn": ...,
    }


# GetBillingTransferPreferenceOutputTypeDef definition

class GetBillingTransferPreferenceOutputTypeDef(TypedDict):
    ResponsibilityTransferArn: str,
    AutoBillingTransferBillingGroupCreation: AutoTransferBillingGroupCreationPreferenceTypeDef,  # (1)
    LastModifiedTime: int,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: AutoTransferBillingGroupCreationPreferenceTypeDef](./type_defs.md#autotransferbillinggroupcreationpreferencetypedef)
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## UpdateBillingTransferPreferenceInputTypeDef

```python
# UpdateBillingTransferPreferenceInputTypeDef TypedDict usage example

from mypy_boto3_billingconductor.type_defs import UpdateBillingTransferPreferenceInputTypeDef


def get_value() -> UpdateBillingTransferPreferenceInputTypeDef:
    return {
        "ResponsibilityTransferArn": ...,
    }


# UpdateBillingTransferPreferenceInputTypeDef definition
...
```python
# UpdateBillingTransferPreferenceOutputTypeDef TypedDict usage example

from mypy_boto3_billingconductor.type_defs import UpdateBillingTransferPreferenceOutputTypeDef


def get_value() -> UpdateBillingTransferPreferenceOutputTypeDef:
    return {
        "ResponsibilityTransferArn": ...,
    }


# UpdateBillingTransferPreferenceOutputTypeDef definition
...
class CreateTieringInputTypeDef(TypedDict):
    FreeTier: NotRequired[CreateFreeTierConfigTypeDef],  # (1)
    CustomTiers: NotRequired[Sequence[CustomTierTypeDef]],  # (2)
```

1. See [:material-code-braces: CreateFreeTierConfigTypeDef](./type_defs.md#createfreetierconfigtypedef)
2. See `Sequence[CustomTierTypeDef]`
...
class TieringTypeDef(TypedDict):
    FreeTier: NotRequired[FreeTierConfigTypeDef],  # (1)
    CustomTiers: NotRequired[list[CustomTierTypeDef]],  # (2)
```

1. See [:material-code-braces: FreeTierConfigTypeDef](./type_defs.md#freetierconfigtypedef)
2. See `list[CustomTierTypeDef]`
...
```python
# UpdateTieringInputOutputTypeDef TypedDict usage example

from mypy_boto3_billingconductor.type_defs import UpdateTieringInputOutputTypeDef


def get_value() -> UpdateTieringInputOutputTypeDef:
    return {
        "FreeTier": ...,
    }


# UpdateTieringInputOutputTypeDef definition

class UpdateTieringInputOutputTypeDef(TypedDict):
    FreeTier: NotRequired[UpdateFreeTierConfigTypeDef],  # (1)
    CustomTiers: NotRequired[list[CustomTierTypeDef]],  # (2)
```
...
class UpdatePricingRuleOutputTypeDef(TypedDict):
    ...
    LastModifiedTime: int,
    BillingEntity: str,
    Tiering: UpdateTieringInputOutputTypeDef,  # (3)
    UsageType: str,
    Operation: str,
...
1. See [:material-code-brackets: PricingRuleScopeType](./literals.md#pricingrulescopetype)
2. See [:material-code-brackets: PricingRuleTypeType](./literals.md#pricingruletypetype)
3. See [:material-code-braces: UpdateTieringInputOutputTypeDef](./type_defs.md#updatetieringinputoutputtypedef)
...
class UpdatePricingRuleInputTypeDef(TypedDict):
    ...
    ModifierPercentage: NotRequired[float],
    Tiering: NotRequired[UpdateTieringInputUnionTypeDef],  # (2)
```

1. See [:material-code-brackets: PricingRuleTypeType](./literals.md#pricingruletypetype)
2. See [:material-code-braces: UpdateTieringInputUnionTypeDef](#updatetieringinputuniontypedef)
