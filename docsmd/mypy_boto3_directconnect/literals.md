...
from mypy_boto3_directconnect.literals import BillingModeType
...
```python
# RequestBillingModeType usage example
from mypy_boto3_directconnect.literals import RequestBillingModeType

def get_value() -> RequestBillingModeType:
    return "FlatRateTier1"
```

```python
# RequestBillingModeType definition
...
```python
# ResiliencyGroupAssociationStateType usage example
from mypy_boto3_directconnect.literals import ResiliencyGroupAssociationStateType

def get_value() -> ResiliencyGroupAssociationStateType:
    return "associated"
```

```python
# ResiliencyGroupAssociationStateType definition
...
```python
# ResiliencyGroupStateType usage example
from mypy_boto3_directconnect.literals import ResiliencyGroupStateType

def get_value() -> ResiliencyGroupStateType:
    return "available"
```

```python
# ResiliencyGroupStateType definition
ResiliencyGroupStateType = Literal[
    "available",
    "deleted",
    "deleting",
    "pending",
...
```python
# ResiliencyGroupTypeType usage example
from mypy_boto3_directconnect.literals import ResiliencyGroupTypeType

def get_value() -> ResiliencyGroupTypeType:
    return "Managed"
```

```python
# ResiliencyGroupTypeType definition
ResiliencyGroupTypeType = Literal[
    "Managed",
]
```
## ResiliencyModelType
...
```python
# ResiliencyModelType usage example
from mypy_boto3_directconnect.literals import ResiliencyModelType

def get_value() -> ResiliencyModelType:
    return "basic-resiliency"
```

```python
# ResiliencyModelType definition
ResiliencyModelType = Literal[
    "basic-resiliency",
    "high-resiliency",
    "maximum-resiliency",
]
