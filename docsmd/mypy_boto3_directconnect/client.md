...
### associate\_connections\_to\_resiliency\_group

Associates one or more connections with the specified resiliency group.

Type annotations and code completion for `#!python boto3.client("directconnect").associate_connections_to_resiliency_group` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/directconnect/client/associate_connections_to_resiliency_group.html)

```python
# associate_connections_to_resiliency_group method definition
...
def associate_connections_to_resiliency_group(
    ...
    *,
    ...
    clientToken: str = ...,
) -> AssociateConnectionsToResiliencyGroupResultTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: AssociateConnectionsToResiliencyGroupResultTypeDef](./type_defs.md#associateconnectionstoresiliencygroupresulttypedef)


```python
# associate_connections_to_resiliency_group method usage example with argument unpacking

kwargs: AssociateConnectionsToResiliencyGroupRequestTypeDef = {  # (1)
    "connectionIdentifiers": ...,
    "resiliencyGroupId": ...,
}

parent.associate_connections_to_resiliency_group(**kwargs)
```

1. See [:material-code-braces: AssociateConnectionsToResiliencyGroupRequestTypeDef](./type_defs.md#associateconnectionstoresiliencygrouprequesttypedef)
...
def create_connection(
    ...
    *,
    ...
    providerName: str = ...,
    requestMACSec: bool = ...,
    billingMode: RequestBillingModeType = ...,  # (2)
) -> ConnectionResponseTypeDef:  # (3)
    ...
```

1. See `Sequence[TagTypeDef]`
2. See [:material-code-brackets: RequestBillingModeType](./literals.md#requestbillingmodetype)
3. See [:material-code-braces: ConnectionResponseTypeDef](./type_defs.md#connectionresponsetypedef)
...
def create_lag(
    ...
    *,
    ...
    providerName: str = ...,
    requestMACSec: bool = ...,
    billingMode: RequestBillingModeType = ...,  # (3)
) -> LagResponseTypeDef:  # (4)
    ...
```

1. See `Sequence[TagTypeDef]`
2. See `Sequence[TagTypeDef]`
3. See [:material-code-brackets: RequestBillingModeType](./literals.md#requestbillingmodetype)
4. See [:material-code-braces: LagResponseTypeDef](./type_defs.md#lagresponsetypedef)
...
### create\_resiliency\_group

Creates a resiliency group.

Type annotations and code completion for `#!python boto3.client("directconnect").create_resiliency_group` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/directconnect/client/create_resiliency_group.html)

```python
# create_resiliency_group method definition

def create_resiliency_group(
    self,
    *,
    resiliencyGroupName: str,
    intendedResiliencyModel: ResiliencyModelType,  # (1)
    clientToken: str = ...,
    tags: Sequence[TagTypeDef] = ...,  # (2)
) -> CreateResiliencyGroupResultTypeDef:  # (3)
    ...
```

1. See [:material-code-brackets: ResiliencyModelType](./literals.md#resiliencymodeltype)
2. See `Sequence[TagTypeDef]`
3. See [:material-code-braces: CreateResiliencyGroupResultTypeDef](./type_defs.md#createresiliencygroupresulttypedef)


```python
# create_resiliency_group method usage example with argument unpacking

kwargs: CreateResiliencyGroupRequestTypeDef = {  # (1)
    "resiliencyGroupName": ...,
    "intendedResiliencyModel": ...,
}

parent.create_resiliency_group(**kwargs)
```

1. See [:material-code-braces: CreateResiliencyGroupRequestTypeDef](./type_defs.md#createresiliencygrouprequesttypedef)
...
### delete\_resiliency\_group

Deletes the specified resiliency group.

Type annotations and code completion for `#!python boto3.client("directconnect").delete_resiliency_group` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/directconnect/client/delete_resiliency_group.html)

```python
# delete_resiliency_group method definition

def delete_resiliency_group(
    self,
    *,
    resiliencyGroupId: str,
) -> DeleteResiliencyGroupResultTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: DeleteResiliencyGroupResultTypeDef](./type_defs.md#deleteresiliencygroupresulttypedef)


```python
# delete_resiliency_group method usage example with argument unpacking

kwargs: DeleteResiliencyGroupRequestTypeDef = {  # (1)
    "resiliencyGroupId": ...,
}

parent.delete_resiliency_group(**kwargs)
```

1. See [:material-code-braces: DeleteResiliencyGroupRequestTypeDef](./type_defs.md#deleteresiliencygrouprequesttypedef)
...
### disassociate\_connections\_from\_resiliency\_group

Disassociates one or more connections from the specified resiliency group.

Type annotations and code completion for `#!python boto3.client("directconnect").disassociate_connections_from_resiliency_group` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/directconnect/client/disassociate_connections_from_resiliency_group.html)

```python
# disassociate_connections_from_resiliency_group method definition
...
def disassociate_connections_from_resiliency_group(
    ...
    *,
    ...
    resiliencyGroupId: str,
    clientToken: str = ...,
) -> DisassociateConnectionsFromResiliencyGroupResultTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: DisassociateConnectionsFromResiliencyGroupResultTypeDef](./type_defs.md#disassociateconnectionsfromresiliencygroupresulttypedef)


```python
# disassociate_connections_from_resiliency_group method usage example with argument unpacking

kwargs: DisassociateConnectionsFromResiliencyGroupRequestTypeDef = {  # (1)
    "connectionIdentifiers": ...,
    "resiliencyGroupId": ...,
}

parent.disassociate_connections_from_resiliency_group(**kwargs)
```

1. See [:material-code-braces: DisassociateConnectionsFromResiliencyGroupRequestTypeDef](./type_defs.md#disassociateconnectionsfromresiliencygrouprequesttypedef)
...
### get\_resiliency\_group

Gets information about the specified resiliency group.

Type annotations and code completion for `#!python boto3.client("directconnect").get_resiliency_group` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/directconnect/client/get_resiliency_group.html)

```python
# get_resiliency_group method definition

def get_resiliency_group(
    self,
    *,
    resiliencyGroupId: str,
) -> GetResiliencyGroupResultTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: GetResiliencyGroupResultTypeDef](./type_defs.md#getresiliencygroupresulttypedef)


```python
# get_resiliency_group method usage example with argument unpacking

kwargs: GetResiliencyGroupRequestTypeDef = {  # (1)
    "resiliencyGroupId": ...,
}

parent.get_resiliency_group(**kwargs)
```

1. See [:material-code-braces: GetResiliencyGroupRequestTypeDef](./type_defs.md#getresiliencygrouprequesttypedef)

### list\_resiliency\_group\_associations

Lists the connection associations for the specified resiliency group.

Type annotations and code completion for `#!python boto3.client("directconnect").list_resiliency_group_associations` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/directconnect/client/list_resiliency_group_associations.html)

```python
# list_resiliency_group_associations method definition
...
def list_resiliency_group_associations(
    ...
    *,
    ...
    maxResults: int = ...,
    nextToken: str = ...,
) -> ListResiliencyGroupAssociationsResultTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: ListResiliencyGroupAssociationsResultTypeDef](./type_defs.md#listresiliencygroupassociationsresulttypedef)


```python
# list_resiliency_group_associations method usage example with argument unpacking

kwargs: ListResiliencyGroupAssociationsRequestTypeDef = {  # (1)
    "resiliencyGroupId": ...,
}

parent.list_resiliency_group_associations(**kwargs)
```

1. See [:material-code-braces: ListResiliencyGroupAssociationsRequestTypeDef](./type_defs.md#listresiliencygroupassociationsrequesttypedef)

### list\_resiliency\_groups

Lists the resiliency groups owned by your Amazon Web Services account in the
current Amazon Web Services Region.

Type annotations and code completion for `#!python boto3.client("directconnect").list_resiliency_groups` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/directconnect/client/list_resiliency_groups.html)

```python
# list_resiliency_groups method definition
...
def list_resiliency_groups(
    ...
    *,
    maxResults: int = ...,
    nextToken: str = ...,
) -> ListResiliencyGroupsResultTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: ListResiliencyGroupsResultTypeDef](./type_defs.md#listresiliencygroupsresulttypedef)


```python
# list_resiliency_groups method usage example with argument unpacking

kwargs: ListResiliencyGroupsRequestTypeDef = {  # (1)
    "maxResults": ...,
}

parent.list_resiliency_groups(**kwargs)
```

1. See [:material-code-braces: ListResiliencyGroupsRequestTypeDef](./type_defs.md#listresiliencygroupsrequesttypedef)
...
### update\_connections\_billing\_mode

Updates the billing mode for the specified Direct Connect connections.

Type annotations and code completion for `#!python boto3.client("directconnect").update_connections_billing_mode` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/directconnect/client/update_connections_billing_mode.html)

```python
# update_connections_billing_mode method definition

def update_connections_billing_mode(
    self,
    *,
    connectionIds: Sequence[str],
    billingMode: RequestBillingModeType,  # (1)
) -> UpdateConnectionsBillingModeResponseTypeDef:  # (2)
    ...
```

1. See [:material-code-brackets: RequestBillingModeType](./literals.md#requestbillingmodetype)
2. See [:material-code-braces: UpdateConnectionsBillingModeResponseTypeDef](./type_defs.md#updateconnectionsbillingmoderesponsetypedef)


```python
# update_connections_billing_mode method usage example with argument unpacking

kwargs: UpdateConnectionsBillingModeRequestTypeDef = {  # (1)
    "connectionIds": ...,
    "billingMode": ...,
}

parent.update_connections_billing_mode(**kwargs)
```

1. See [:material-code-braces: UpdateConnectionsBillingModeRequestTypeDef](./type_defs.md#updateconnectionsbillingmoderequesttypedef)
...
### update\_resiliency\_group

Updates the name of the specified resiliency group.

Type annotations and code completion for `#!python boto3.client("directconnect").update_resiliency_group` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/directconnect/client/update_resiliency_group.html)

```python
# update_resiliency_group method definition
...
def update_resiliency_group(
    ...
    *,
    ...
    resiliencyGroupName: str,
    clientToken: str = ...,
) -> UpdateResiliencyGroupResultTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: UpdateResiliencyGroupResultTypeDef](./type_defs.md#updateresiliencygroupresulttypedef)


```python
# update_resiliency_group method usage example with argument unpacking

kwargs: UpdateResiliencyGroupRequestTypeDef = {  # (1)
    "resiliencyGroupId": ...,
    "resiliencyGroupName": ...,
}

parent.update_resiliency_group(**kwargs)
```

1. See [:material-code-braces: UpdateResiliencyGroupRequestTypeDef](./type_defs.md#updateresiliencygrouprequesttypedef)
