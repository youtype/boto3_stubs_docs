...
```python
# InvoiceConfigurationTypeDef TypedDict usage example

from mypy_boto3_invoicing.type_defs import InvoiceConfigurationTypeDef


def get_value() -> InvoiceConfigurationTypeDef:
    return {
        "DocumentTypes": ...,
    }


# InvoiceConfigurationTypeDef definition

class InvoiceConfigurationTypeDef(TypedDict):
    DocumentTypes: NotRequired[list[EinvoiceDeliveryDocumentTypeType]],  # (1)
    AttachmentTypes: NotRequired[list[EinvoiceDeliveryAttachmentTypeType]],  # (2)
```
...
```python
# ListProcurementPortalSuppliersRequestTypeDef TypedDict usage example

from mypy_boto3_invoicing.type_defs import ListProcurementPortalSuppliersRequestTypeDef


def get_value() -> ListProcurementPortalSuppliersRequestTypeDef:
    return {
        "PortalIdentifier": ...,
    }


# ListProcurementPortalSuppliersRequestTypeDef definition
...
```python
# ProcurementPortalSupplierTypeDef TypedDict usage example

from mypy_boto3_invoicing.type_defs import ProcurementPortalSupplierTypeDef


def get_value() -> ProcurementPortalSupplierTypeDef:
    return {
        "SupplierIdentifier": ...,
    }


# ProcurementPortalSupplierTypeDef definition

class ProcurementPortalSupplierTypeDef(TypedDict):
    SupplierIdentifier: str,
    SellerOfRecord: NotRequired[str],
    CountryCode: NotRequired[str],
    Environment: NotRequired[ProcurementPortalEnvType],  # (1)
```

1. See [:material-code-brackets: ProcurementPortalEnvType](./literals.md#procurementportalenvtype)

## ListProcurementPortalsRequestTypeDef

```python
# ListProcurementPortalsRequestTypeDef TypedDict usage example

from mypy_boto3_invoicing.type_defs import ListProcurementPortalsRequestTypeDef


def get_value() -> ListProcurementPortalsRequestTypeDef:
    return {
        "NextToken": ...,
    }


# ListProcurementPortalsRequestTypeDef definition
...
```python
# FeatureConfigurationsTypeDef TypedDict usage example

from mypy_boto3_invoicing.type_defs import FeatureConfigurationsTypeDef


def get_value() -> FeatureConfigurationsTypeDef:
    return {
        "InvoiceConfiguration": ...,
    }


# FeatureConfigurationsTypeDef definition

class FeatureConfigurationsTypeDef(TypedDict):
    InvoiceConfiguration: NotRequired[InvoiceConfigurationTypeDef],  # (1)
```

1. See [:material-code-braces: InvoiceConfigurationTypeDef](./type_defs.md#invoiceconfigurationtypedef)
...
```python
# ListProcurementPortalSuppliersRequestPaginateTypeDef TypedDict usage example

from mypy_boto3_invoicing.type_defs import ListProcurementPortalSuppliersRequestPaginateTypeDef


def get_value() -> ListProcurementPortalSuppliersRequestPaginateTypeDef:
    return {
        "PortalIdentifier": ...,
    }


# ListProcurementPortalSuppliersRequestPaginateTypeDef definition
...
```python
# ListProcurementPortalsRequestPaginateTypeDef TypedDict usage example

from mypy_boto3_invoicing.type_defs import ListProcurementPortalsRequestPaginateTypeDef


def get_value() -> ListProcurementPortalsRequestPaginateTypeDef:
    return {
        "PaginationConfig": ...,
    }


# ListProcurementPortalsRequestPaginateTypeDef definition
...
```python
# ListProcurementPortalSuppliersResponseTypeDef TypedDict usage example

from mypy_boto3_invoicing.type_defs import ListProcurementPortalSuppliersResponseTypeDef


def get_value() -> ListProcurementPortalSuppliersResponseTypeDef:
    return {
        "ProcurementPortalSuppliers": ...,
    }


# ListProcurementPortalSuppliersResponseTypeDef definition

class ListProcurementPortalSuppliersResponseTypeDef(TypedDict):
    ProcurementPortalSuppliers: list[ProcurementPortalSupplierTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    NextToken: NotRequired[str],
```

1. See `list[ProcurementPortalSupplierTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
```python
# ProcurementPortalTypeDef TypedDict usage example

from mypy_boto3_invoicing.type_defs import ProcurementPortalTypeDef


def get_value() -> ProcurementPortalTypeDef:
    return {
        "PortalIdentifier": ...,
    }


# ProcurementPortalTypeDef definition

class ProcurementPortalTypeDef(TypedDict):
    PortalIdentifier: str,
    PortalName: ProcurementPortalNameType,  # (1)
    PortalDisplayName: NotRequired[str],
    DefaultFeatureConfigurations: NotRequired[FeatureConfigurationsTypeDef],  # (2)
```

1. See [:material-code-brackets: ProcurementPortalNameType](./literals.md#procurementportalnametype)
2. See [:material-code-braces: FeatureConfigurationsTypeDef](./type_defs.md#featureconfigurationstypedef)
...
```python
# ListProcurementPortalsResponseTypeDef TypedDict usage example

from mypy_boto3_invoicing.type_defs import ListProcurementPortalsResponseTypeDef


def get_value() -> ListProcurementPortalsResponseTypeDef:
    return {
        "ProcurementPortals": ...,
    }


# ListProcurementPortalsResponseTypeDef definition

class ListProcurementPortalsResponseTypeDef(TypedDict):
    ProcurementPortals: list[ProcurementPortalTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    NextToken: NotRequired[str],
```

1. See `list[ProcurementPortalTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
