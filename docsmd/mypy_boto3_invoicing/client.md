...
### list\_procurement\_portal\_suppliers
...
Type annotations and code completion for `#!python boto3.client("invoicing").list_procurement_portal_suppliers` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/invoicing/client/list_procurement_portal_suppliers.html)

```python
# list_procurement_portal_suppliers method definition
...
def list_procurement_portal_suppliers(
    ...
    *,
    ...
    NextToken: str = ...,
    MaxResults: int = ...,
) -> ListProcurementPortalSuppliersResponseTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: ListProcurementPortalSuppliersResponseTypeDef](./type_defs.md#listprocurementportalsuppliersresponsetypedef)


```python
# list_procurement_portal_suppliers method usage example with argument unpacking

kwargs: ListProcurementPortalSuppliersRequestTypeDef = {  # (1)
    "PortalIdentifier": ...,
}

parent.list_procurement_portal_suppliers(**kwargs)
```

1. See [:material-code-braces: ListProcurementPortalSuppliersRequestTypeDef](./type_defs.md#listprocurementportalsuppliersrequesttypedef)

### list\_procurement\_portals

Returns the Amazon Web Services-supported procurement portals for e-invoice
delivery and purchase order retrieval.

Type annotations and code completion for `#!python boto3.client("invoicing").list_procurement_portals` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/invoicing/client/list_procurement_portals.html)

```python
# list_procurement_portals method definition
...
def list_procurement_portals(
    ...
    *,
    NextToken: str = ...,
    MaxResults: int = ...,
) -> ListProcurementPortalsResponseTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: ListProcurementPortalsResponseTypeDef](./type_defs.md#listprocurementportalsresponsetypedef)


```python
# list_procurement_portals method usage example with argument unpacking

kwargs: ListProcurementPortalsRequestTypeDef = {  # (1)
    "NextToken": ...,
}

parent.list_procurement_portals(**kwargs)
```

1. See [:material-code-braces: ListProcurementPortalsRequestTypeDef](./type_defs.md#listprocurementportalsrequesttypedef)
...
- `client.get_paginator("list_procurement_portal_suppliers")` -> [ListProcurementPortalSuppliersPaginator](./paginators.md#listprocurementportalsupplierspaginator)
- `client.get_paginator("list_procurement_portals")` -> [ListProcurementPortalsPaginator](./paginators.md#listprocurementportalspaginator)
