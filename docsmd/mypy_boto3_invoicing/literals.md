...
```python
# ListProcurementPortalSuppliersPaginatorName usage example
from mypy_boto3_invoicing.literals import ListProcurementPortalSuppliersPaginatorName

def get_value() -> ListProcurementPortalSuppliersPaginatorName:
    return "list_procurement_portal_suppliers"
```

```python
# ListProcurementPortalSuppliersPaginatorName definition
ListProcurementPortalSuppliersPaginatorName = Literal[
...
```python
# ListProcurementPortalsPaginatorName usage example
from mypy_boto3_invoicing.literals import ListProcurementPortalsPaginatorName

def get_value() -> ListProcurementPortalsPaginatorName:
    return "list_procurement_portals"
```

```python
# ListProcurementPortalsPaginatorName definition
ListProcurementPortalsPaginatorName = Literal[
...
```python
# ProcurementPortalEnvType usage example
from mypy_boto3_invoicing.literals import ProcurementPortalEnvType

def get_value() -> ProcurementPortalEnvType:
    return "PROD"
```

```python
# ProcurementPortalEnvType definition
ProcurementPortalEnvType = Literal[
    "PROD",
    "TEST",
]
```
