...
```python
# AgentTargetTypeDef TypedDict usage example

from mypy_boto3_qconnect.type_defs import AgentTargetTypeDef


def get_value() -> AgentTargetTypeDef:
    return {
        "aiAgentId": ...,
    }


# AgentTargetTypeDef definition
...
```python
# MultiAgentInstructionOutputTypeDef TypedDict usage example

from mypy_boto3_qconnect.type_defs import MultiAgentInstructionOutputTypeDef


def get_value() -> MultiAgentInstructionOutputTypeDef:
    return {
        "instruction": ...,
    }


# MultiAgentInstructionOutputTypeDef definition
...
```python
# MultiAgentInstructionTypeDef TypedDict usage example

from mypy_boto3_qconnect.type_defs import MultiAgentInstructionTypeDef


def get_value() -> MultiAgentInstructionTypeDef:
    return {
        "instruction": ...,
    }


# MultiAgentInstructionTypeDef definition
...
```python
# DelegateAgentConfigurationOutputTypeDef TypedDict usage example

from mypy_boto3_qconnect.type_defs import DelegateAgentConfigurationOutputTypeDef


def get_value() -> DelegateAgentConfigurationOutputTypeDef:
    return {
        "agentTarget": ...,
    }


# DelegateAgentConfigurationOutputTypeDef definition

class DelegateAgentConfigurationOutputTypeDef(TypedDict):
    agentTarget: AgentTargetTypeDef,  # (1)
    instruction: NotRequired[MultiAgentInstructionOutputTypeDef],  # (2)
```

1. See [:material-code-braces: AgentTargetTypeDef](./type_defs.md#agenttargettypedef)
2. See [:material-code-braces: MultiAgentInstructionOutputTypeDef](./type_defs.md#multiagentinstructionoutputtypedef)

## HandoffAgentConfigurationOutputTypeDef

```python
# HandoffAgentConfigurationOutputTypeDef TypedDict usage example

from mypy_boto3_qconnect.type_defs import HandoffAgentConfigurationOutputTypeDef


def get_value() -> HandoffAgentConfigurationOutputTypeDef:
    return {
        "agentTarget": ...,
    }


# HandoffAgentConfigurationOutputTypeDef definition
...
```python
# DelegateAgentConfigurationTypeDef TypedDict usage example

from mypy_boto3_qconnect.type_defs import DelegateAgentConfigurationTypeDef


def get_value() -> DelegateAgentConfigurationTypeDef:
    return {
        "agentTarget": ...,
    }


# DelegateAgentConfigurationTypeDef definition

class DelegateAgentConfigurationTypeDef(TypedDict):
    agentTarget: AgentTargetTypeDef,  # (1)
    instruction: NotRequired[MultiAgentInstructionTypeDef],  # (2)
```

1. See [:material-code-braces: AgentTargetTypeDef](./type_defs.md#agenttargettypedef)
2. See [:material-code-braces: MultiAgentInstructionTypeDef](./type_defs.md#multiagentinstructiontypedef)

## HandoffAgentConfigurationTypeDef

```python
# HandoffAgentConfigurationTypeDef TypedDict usage example

from mypy_boto3_qconnect.type_defs import HandoffAgentConfigurationTypeDef


def get_value() -> HandoffAgentConfigurationTypeDef:
    return {
        "agentTarget": ...,
    }


# HandoffAgentConfigurationTypeDef definition
...
```python
# MultiAgentConfigurationOutputTypeDef TypedDict usage example

from mypy_boto3_qconnect.type_defs import MultiAgentConfigurationOutputTypeDef


def get_value() -> MultiAgentConfigurationOutputTypeDef:
    return {
        "delegateAgentConfiguration": ...,
    }


# MultiAgentConfigurationOutputTypeDef definition

class MultiAgentConfigurationOutputTypeDef(TypedDict):
    delegateAgentConfiguration: NotRequired[DelegateAgentConfigurationOutputTypeDef],  # (1)
    handoffAgentConfiguration: NotRequired[HandoffAgentConfigurationOutputTypeDef],  # (2)
```

1. See [:material-code-braces: DelegateAgentConfigurationOutputTypeDef](./type_defs.md#delegateagentconfigurationoutputtypedef)
2. See [:material-code-braces: HandoffAgentConfigurationOutputTypeDef](./type_defs.md#handoffagentconfigurationoutputtypedef)

## MultiAgentConfigurationTypeDef

```python
# MultiAgentConfigurationTypeDef TypedDict usage example

from mypy_boto3_qconnect.type_defs import MultiAgentConfigurationTypeDef


def get_value() -> MultiAgentConfigurationTypeDef:
    return {
        "delegateAgentConfiguration": ...,
    }


# MultiAgentConfigurationTypeDef definition

class MultiAgentConfigurationTypeDef(TypedDict):
    delegateAgentConfiguration: NotRequired[DelegateAgentConfigurationTypeDef],  # (1)
    handoffAgentConfiguration: NotRequired[HandoffAgentConfigurationTypeDef],  # (2)
```

1. See [:material-code-braces: DelegateAgentConfigurationTypeDef](./type_defs.md#delegateagentconfigurationtypedef)
2. See [:material-code-braces: HandoffAgentConfigurationTypeDef](./type_defs.md#handoffagentconfigurationtypedef)
...
class SpanAttributesPaginatorTypeDef(TypedDict):
    ...
    returnReason: NotRequired[ReturnReasonType],  # (3)
    ...
    inputMessages: NotRequired[list[SpanMessagePaginatorTypeDef]],  # (4)
    outputMessages: NotRequired[list[SpanMessagePaginatorTypeDef]],  # (4)
    systemInstructions: NotRequired[list[SpanMessageValuePaginatorTypeDef]],  # (6)
    promptArn: NotRequired[str],
    promptId: NotRequired[str],
    promptType: NotRequired[AIPromptTypeType],  # (7)
    promptName: NotRequired[str],
    promptVersion: NotRequired[int],
    timeToFirstTokenMs: NotRequired[int],
    guardrailAssessments: NotRequired[list[SpanGuardrailAssessmentTypeDef]],  # (8)
```

1. See [:material-code-brackets: AIAgentTypeType](./literals.md#aiagenttypetype)
2. See [:material-code-brackets: InteractionModeType](./literals.md#interactionmodetype)
3. See [:material-code-brackets: ReturnReasonType](./literals.md#returnreasontype)
4. See `list[SpanMessagePaginatorTypeDef]`
5. See `list[SpanMessagePaginatorTypeDef]`
6. See `list[SpanMessageValuePaginatorTypeDef]`
7. See [:material-code-brackets: AIPromptTypeType](./literals.md#aiprompttypetype)
8. See `list[SpanGuardrailAssessmentTypeDef]`
...
class SpanAttributesTypeDef(TypedDict):
    ...
    cacheReadInputTokens: NotRequired[int],
    cacheWriteInputTokens: NotRequired[int],
    inputMessages: NotRequired[list[SpanMessageTypeDef]],  # (4)
    outputMessages: NotRequired[list[SpanMessageTypeDef]],  # (4)
    systemInstructions: NotRequired[list[SpanMessageValueTypeDef]],  # (6)
    promptArn: NotRequired[str],
    promptId: NotRequired[str],
    promptType: NotRequired[AIPromptTypeType],  # (7)
    promptName: NotRequired[str],
...
2. See [:material-code-brackets: InteractionModeType](./literals.md#interactionmodetype)
3. See [:material-code-brackets: ReturnReasonType](./literals.md#returnreasontype)
4. See `list[SpanMessageTypeDef]`
5. See `list[SpanMessageTypeDef]`
6. See `list[SpanMessageValueTypeDef]`
7. See [:material-code-brackets: AIPromptTypeType](./literals.md#aiprompttypetype)
8. See `list[SpanGuardrailAssessmentTypeDef]`
...
class OrchestrationAIAgentConfigurationOutputTypeDef(TypedDict):
    ...
    multiAgentConfigurations: NotRequired[list[MultiAgentConfigurationOutputTypeDef]],  # (2)
...
2. See `list[MultiAgentConfigurationOutputTypeDef]`
...
class OrchestrationAIAgentConfigurationTypeDef(TypedDict):
    ...
    multiAgentConfigurations: NotRequired[Sequence[MultiAgentConfigurationTypeDef]],  # (2)
    connectInstanceArn: NotRequired[str],
    locale: NotRequired[str],
...
2. See `Sequence[MultiAgentConfigurationTypeDef]`
