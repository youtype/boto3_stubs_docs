...
from mypy_boto3_qconnect.literals import InteractionModeType
...
```python
# ReturnReasonType usage example
from mypy_boto3_qconnect.literals import ReturnReasonType

def get_value() -> ReturnReasonType:
    return "COMPLETE"
```

```python
# ReturnReasonType definition
