...
```python
# S3ObjectLockEventHoldDurationTypeDef TypedDict usage example

from mypy_boto3_s3control.type_defs import S3ObjectLockEventHoldDurationTypeDef


def get_value() -> S3ObjectLockEventHoldDurationTypeDef:
    return {
        "Days": ...,
    }


# S3ObjectLockEventHoldDurationTypeDef definition
...
```python
# S3ObjectLockRetentionEventHoldDurationTypeDef TypedDict usage example

from mypy_boto3_s3control.type_defs import S3ObjectLockRetentionEventHoldDurationTypeDef


def get_value() -> S3ObjectLockRetentionEventHoldDurationTypeDef:
    return {
        "Days": ...,
    }


# S3ObjectLockRetentionEventHoldDurationTypeDef definition
...
class S3RetentionOutputTypeDef(TypedDict):
    ...
    EventHold: NotRequired[S3ObjectLockRetentionEventHoldType],  # (2)
    EventHoldDuration: NotRequired[S3ObjectLockRetentionEventHoldDurationTypeDef],  # (3)
```

1. See [:material-code-brackets: S3ObjectLockRetentionModeType](./literals.md#s3objectlockretentionmodetype)
2. See [:material-code-brackets: S3ObjectLockRetentionEventHoldType](./literals.md#s3objectlockretentioneventholdtype)
3. See [:material-code-braces: S3ObjectLockRetentionEventHoldDurationTypeDef](./type_defs.md#s3objectlockretentioneventholddurationtypedef)
...
class S3CopyObjectOperationOutputTypeDef(TypedDict):
    ...
    AnnotationDirective: NotRequired[S3AnnotationDirectiveType],  # (4)
    ModifiedSinceConstraint: NotRequired[datetime.datetime],
    NewObjectMetadata: NotRequired[S3ObjectMetadataOutputTypeDef],  # (5)
    NewObjectTagging: NotRequired[list[S3TagTypeDef]],  # (6)
    RedirectLocation: NotRequired[str],
    RequesterPays: NotRequired[bool],
    StorageClass: NotRequired[S3StorageClassType],  # (7)
    UnModifiedSinceConstraint: NotRequired[datetime.datetime],
    SSEAwsKmsKeyId: NotRequired[str],
    TargetKeyPrefix: NotRequired[str],
    ObjectLockLegalHoldStatus: NotRequired[S3ObjectLockLegalHoldStatusType],  # (8)
    ObjectLockMode: NotRequired[S3ObjectLockModeType],  # (9)
    ObjectLockRetainUntilDate: NotRequired[datetime.datetime],
    BucketKeyEnabled: NotRequired[bool],
    ChecksumAlgorithm: NotRequired[S3ChecksumAlgorithmType],  # (10)
    ObjectLockEventHold: NotRequired[S3ObjectLockEventHoldType],  # (11)
    ObjectLockEventHoldDuration: NotRequired[S3ObjectLockEventHoldDurationTypeDef],  # (12)
```
...
4. See [:material-code-brackets: S3AnnotationDirectiveType](./literals.md#s3annotationdirectivetype)
5. See [:material-code-braces: S3ObjectMetadataOutputTypeDef](./type_defs.md#s3objectmetadataoutputtypedef)
6. See `list[S3TagTypeDef]`
7. See [:material-code-brackets: S3StorageClassType](./literals.md#s3storageclasstype)
8. See [:material-code-brackets: S3ObjectLockLegalHoldStatusType](./literals.md#s3objectlocklegalholdstatustype)
9. See [:material-code-brackets: S3ObjectLockModeType](./literals.md#s3objectlockmodetype)
10. See [:material-code-brackets: S3ChecksumAlgorithmType](./literals.md#s3checksumalgorithmtype)
11. See [:material-code-brackets: S3ObjectLockEventHoldType](./literals.md#s3objectlockeventholdtype)
12. See [:material-code-braces: S3ObjectLockEventHoldDurationTypeDef](./type_defs.md#s3objectlockeventholddurationtypedef)
...
class S3CopyObjectOperationTypeDef(TypedDict):
    ...
    NewObjectMetadata: NotRequired[S3ObjectMetadataTypeDef],  # (5)
    NewObjectTagging: NotRequired[Sequence[S3TagTypeDef]],  # (6)
    RedirectLocation: NotRequired[str],
    RequesterPays: NotRequired[bool],
    StorageClass: NotRequired[S3StorageClassType],  # (7)
...
3. See [:material-code-brackets: S3MetadataDirectiveType](./literals.md#s3metadatadirectivetype)
4. See [:material-code-brackets: S3AnnotationDirectiveType](./literals.md#s3annotationdirectivetype)
5. See [:material-code-braces: S3ObjectMetadataTypeDef](./type_defs.md#s3objectmetadatatypedef)
6. See `Sequence[S3TagTypeDef]`
7. See [:material-code-brackets: S3StorageClassType](./literals.md#s3storageclasstype)
8. See [:material-code-brackets: S3ObjectLockLegalHoldStatusType](./literals.md#s3objectlocklegalholdstatustype)
9. See [:material-code-brackets: S3ObjectLockModeType](./literals.md#s3objectlockmodetype)
10. See [:material-code-brackets: S3ChecksumAlgorithmType](./literals.md#s3checksumalgorithmtype)
