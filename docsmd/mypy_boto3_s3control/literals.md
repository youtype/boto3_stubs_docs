...
```python
# S3AnnotationDirectiveType usage example
from mypy_boto3_s3control.literals import S3AnnotationDirectiveType

def get_value() -> S3AnnotationDirectiveType:
    return "COPY"
```

```python
# S3AnnotationDirectiveType definition
S3AnnotationDirectiveType = Literal[
    "COPY",
    "EXCLUDE",
]
```
...
```python
# S3ObjectLockEventHoldType usage example
from mypy_boto3_s3control.literals import S3ObjectLockEventHoldType

def get_value() -> S3ObjectLockEventHoldType:
    return "OFF"
```

```python
# S3ObjectLockEventHoldType definition
S3ObjectLockEventHoldType = Literal[
    "OFF",
    "ON",
]
```
...
```python
# S3ObjectLockRetentionEventHoldType usage example
from mypy_boto3_s3control.literals import S3ObjectLockRetentionEventHoldType

def get_value() -> S3ObjectLockRetentionEventHoldType:
    return "OFF"
```

```python
# S3ObjectLockRetentionEventHoldType definition
S3ObjectLockRetentionEventHoldType = Literal[
    "OFF",
    "ON",
]
```
