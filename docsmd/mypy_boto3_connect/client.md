...
def create_routing_profile(
    ...
    *,
    ...
    MediaConcurrencies: Sequence[MediaConcurrencyUnionTypeDef],  # (1)
...
1. See `Sequence[MediaConcurrencyUnionTypeDef]`
...
def create_security_profile(
    ...
    *,
    ...
    AllowedAIAgents: Sequence[AIAgentTypeDef] = ...,  # (3)
    GranularAccessControlConfiguration: GranularAccessControlConfigurationUnionTypeDef = ...,  # (4)
...
3. See `Sequence[AIAgentTypeDef]`
4. See [:material-code-braces: GranularAccessControlConfigurationUnionTypeDef](#granularaccesscontrolconfigurationuniontypedef)
...
### list\_evaluation\_form\_ai\_versions

Lists the available AI versions for evaluation forms in the specified Connect
Customer instance.

Type annotations and code completion for `#!python boto3.client("connect").list_evaluation_form_ai_versions` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/connect/client/list_evaluation_form_ai_versions.html)

```python
# list_evaluation_form_ai_versions method definition
...
def list_evaluation_form_ai_versions(
    ...
    *,
    ...
    MaxResults: int = ...,
    NextToken: str = ...,
) -> ListEvaluationFormAIVersionsResponseTypeDef:  # (2)
    ...
```

1. See [:material-code-brackets: ContactInteractionTypeType](./literals.md#contactinteractiontypetype)
2. See [:material-code-braces: ListEvaluationFormAIVersionsResponseTypeDef](./type_defs.md#listevaluationformaiversionsresponsetypedef)


```python
# list_evaluation_form_ai_versions method usage example with argument unpacking

kwargs: ListEvaluationFormAIVersionsRequestTypeDef = {  # (1)
    "InstanceId": ...,
    "ContactInteractionType": ...,
}

parent.list_evaluation_form_ai_versions(**kwargs)
```

1. See [:material-code-braces: ListEvaluationFormAIVersionsRequestTypeDef](./type_defs.md#listevaluationformaiversionsrequesttypedef)
...
### list\_security\_profile\_ai\_agents

Returns a list of the allowed AI agents in a specific security profile.

Type annotations and code completion for `#!python boto3.client("connect").list_security_profile_ai_agents` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/connect/client/list_security_profile_ai_agents.html)

```python
# list_security_profile_ai_agents method definition
...
def list_security_profile_ai_agents(
    ...
    *,
    ...
    NextToken: str = ...,
    MaxResults: int = ...,
) -> ListSecurityProfileAIAgentsResponseTypeDef:  # (1)
    ...
```

1. See [:material-code-braces: ListSecurityProfileAIAgentsResponseTypeDef](./type_defs.md#listsecurityprofileaiagentsresponsetypedef)


```python
# list_security_profile_ai_agents method usage example with argument unpacking

kwargs: ListSecurityProfileAIAgentsRequestTypeDef = {  # (1)
    "SecurityProfileId": ...,
    "InstanceId": ...,
}

parent.list_security_profile_ai_agents(**kwargs)
```

1. See [:material-code-braces: ListSecurityProfileAIAgentsRequestTypeDef](./type_defs.md#listsecurityprofileaiagentsrequesttypedef)
...
- `client.get_paginator("list_security_profile_ai_agents")` -> [ListSecurityProfileAIAgentsPaginator](./paginators.md#listsecurityprofileaiagentspaginator)
