...
Type annotations and code completion for `#!python boto3.client("connect").get_paginator("list_security_profile_ai_agents")`.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/connect/paginator/ListSecurityProfileAIAgents.html#Connect.Paginator.ListSecurityProfileAIAgents)

```python
# ListSecurityProfileAIAgentsPaginator usage example

from boto3.session import Session

from mypy_boto3_connect.paginator import ListSecurityProfileAIAgentsPaginator

def get_list_security_profile_ai_agents_paginator() -> ListSecurityProfileAIAgentsPaginator:
    return Session().client("connect").get_paginator("list_security_profile_ai_agents")
```

```python
# ListSecurityProfileAIAgentsPaginator usage example with type annotations
...
client = Session().client("connect")  # (1)
paginator: ListSecurityProfileAIAgentsPaginator = client.get_paginator("list_security_profile_ai_agents")  # (2)
for item in paginator.paginate(...):
    print(item)  # (3)
```

1. client: [ConnectClient](./client.md)
2. paginator: [ListSecurityProfileAIAgentsPaginator](./paginators.md#listsecurityprofileaiagentspaginator)
3. item: `PageIterator[ListSecurityProfileAIAgentsResponseTypeDef]`


### paginate

Type annotations and code completion for `#!python ListSecurityProfileAIAgentsPaginator.paginate` method.
...
def paginate(
    ...
    *,
    ...
    InstanceId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> botocore.paginate.PageIterator[ListSecurityProfileAIAgentsResponseTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
2. See `PageIterator[ListSecurityProfileAIAgentsResponseTypeDef]`


```python
# paginate method usage example with argument unpacking

kwargs: ListSecurityProfileAIAgentsRequestPaginateTypeDef = {  # (1)
    "SecurityProfileId": ...,
    "InstanceId": ...,
}
...
1. See [:material-code-braces: ListSecurityProfileAIAgentsRequestPaginateTypeDef](./type_defs.md#listsecurityprofileaiagentsrequestpaginatetypedef)
