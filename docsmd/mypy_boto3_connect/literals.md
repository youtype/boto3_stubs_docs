...
```python
# ChannelWorkloadBehaviorTypeType usage example
from mypy_boto3_connect.literals import ChannelWorkloadBehaviorTypeType

def get_value() -> ChannelWorkloadBehaviorTypeType:
    return "ROUTE_ANY_CHANNEL_ANY_WORKLOAD_TYPE"
```

```python
# ChannelWorkloadBehaviorTypeType definition
...
```python
# EvaluationFormAIVersionStatusType usage example
from mypy_boto3_connect.literals import EvaluationFormAIVersionStatusType

def get_value() -> EvaluationFormAIVersionStatusType:
    return "ACTIVE"
```

```python
# EvaluationFormAIVersionStatusType definition
EvaluationFormAIVersionStatusType = Literal[
    "ACTIVE",
    "DEPRECATED",
    "LATEST",
    "PREVIEW",
...
```python
# EvaluationFormMetricTypeType usage example
from mypy_boto3_connect.literals import EvaluationFormMetricTypeType

def get_value() -> EvaluationFormMetricTypeType:
    return "BUSINESS_OUTCOME"
```

```python
# EvaluationFormMetricTypeType definition
EvaluationFormMetricTypeType = Literal[
    "BUSINESS_OUTCOME",
]
```
...
```python
# ListSecurityProfileAIAgentsPaginatorName usage example
from mypy_boto3_connect.literals import ListSecurityProfileAIAgentsPaginatorName

def get_value() -> ListSecurityProfileAIAgentsPaginatorName:
    return "list_security_profile_ai_agents"
```

```python
# ListSecurityProfileAIAgentsPaginatorName definition
ListSecurityProfileAIAgentsPaginatorName = Literal[
