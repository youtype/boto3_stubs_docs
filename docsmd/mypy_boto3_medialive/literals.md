...
```python
# EmbeddedDestinationStyleControlType usage example
from mypy_boto3_medialive.literals import EmbeddedDestinationStyleControlType

def get_value() -> EmbeddedDestinationStyleControlType:
    return "MANUAL"
```

```python
# EmbeddedDestinationStyleControlType definition
EmbeddedDestinationStyleControlType = Literal[
    "MANUAL",
    "PASSTHROUGH",
]
```
...
```python
# EnrichmentMethodType usage example
from mypy_boto3_medialive.literals import EnrichmentMethodType

def get_value() -> EnrichmentMethodType:
    return "SCTE35_ELEMENTAL_INFERENCE_QUERY_PARAMS"
```

```python
# EnrichmentMethodType definition
EnrichmentMethodType = Literal[
...
```python
# OutputUsageType usage example
from mypy_boto3_medialive.literals import OutputUsageType

def get_value() -> OutputUsageType:
    return "MULTIVIEW_EQUAL_SIZE_VIEW"
```

```python
# OutputUsageType definition
