...
```python
# DolbyVisionPresenceType usage example
from mypy_boto3_mediaconvert.literals import DolbyVisionPresenceType

def get_value() -> DolbyVisionPresenceType:
    return "ABSENT"
```

```python
# DolbyVisionPresenceType definition
DolbyVisionPresenceType = Literal[
    "ABSENT",
    "PRESENT",
]
```
