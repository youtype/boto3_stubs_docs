...
```python
# DolbyVisionMetadataTypeDef TypedDict usage example

from mypy_boto3_mediaconvert.type_defs import DolbyVisionMetadataTypeDef


def get_value() -> DolbyVisionMetadataTypeDef:
    return {
        "BaseLayer": ...,
    }


# DolbyVisionMetadataTypeDef definition

class DolbyVisionMetadataTypeDef(TypedDict):
    BaseLayer: NotRequired[DolbyVisionPresenceType],  # (1)
    EnhancementLayer: NotRequired[DolbyVisionPresenceType],  # (1)
    Level: NotRequired[int],
    Profile: NotRequired[int],
    Rpu: NotRequired[DolbyVisionPresenceType],  # (1)
```

1. See [:material-code-brackets: DolbyVisionPresenceType](./literals.md#dolbyvisionpresencetype)
2. See [:material-code-brackets: DolbyVisionPresenceType](./literals.md#dolbyvisionpresencetype)
3. See [:material-code-brackets: DolbyVisionPresenceType](./literals.md#dolbyvisionpresencetype)
...
class CodecMetadataTypeDef(TypedDict):
    ...
    DisplayAspectRatio: NotRequired[AspectRatioTypeDef],  # (4)
    DolbyVision: NotRequired[DolbyVisionMetadataTypeDef],  # (5)
    FieldOrder: NotRequired[str],
    Hdr10PlusPresence: NotRequired[Hdr10PlusPresenceType],  # (6)
    Height: NotRequired[int],
    Level: NotRequired[str],
    MatrixCoefficients: NotRequired[MatrixCoefficientsType],  # (7)
    Profile: NotRequired[str],
    Rotation: NotRequired[int],
    SampleAspectRatio: NotRequired[AspectRatioTypeDef],  # (4)
    ScanType: NotRequired[str],
    TransferCharacteristics: NotRequired[TransferCharacteristicsType],  # (9)
    Width: NotRequired[int],
```
...
4. See [:material-code-braces: AspectRatioTypeDef](./type_defs.md#aspectratiotypedef)
5. See [:material-code-braces: DolbyVisionMetadataTypeDef](./type_defs.md#dolbyvisionmetadatatypedef)
6. See [:material-code-brackets: Hdr10PlusPresenceType](./literals.md#hdr10pluspresencetype)
7. See [:material-code-brackets: MatrixCoefficientsType](./literals.md#matrixcoefficientstype)
8. See [:material-code-braces: AspectRatioTypeDef](./type_defs.md#aspectratiotypedef)
9. See [:material-code-brackets: TransferCharacteristicsType](./literals.md#transfercharacteristicstype)
