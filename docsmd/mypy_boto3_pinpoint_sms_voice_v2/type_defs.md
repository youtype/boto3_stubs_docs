...
```python
# NumberPreferenceItemTypeDef TypedDict usage example

from mypy_boto3_pinpoint_sms_voice_v2.type_defs import NumberPreferenceItemTypeDef


def get_value() -> NumberPreferenceItemTypeDef:
    return {
        "PreferenceType": ...,
    }


# NumberPreferenceItemTypeDef definition

class NumberPreferenceItemTypeDef(TypedDict):
    PreferenceType: Sequence[PreferenceTypeType],  # (1)
    Filter: Sequence[str],
```

1. See `Sequence[PreferenceTypeType]`
...
```python
# MessagingLimitsTypeDef TypedDict usage example

from mypy_boto3_pinpoint_sms_voice_v2.type_defs import MessagingLimitsTypeDef


def get_value() -> MessagingLimitsTypeDef:
    return {
        "RateLimits": ...,
    }


# MessagingLimitsTypeDef definition
...
```python
# ListAvailablePhoneNumbersResultTypeDef TypedDict usage example

from mypy_boto3_pinpoint_sms_voice_v2.type_defs import ListAvailablePhoneNumbersResultTypeDef


def get_value() -> ListAvailablePhoneNumbersResultTypeDef:
    return {
        "AvailablePhoneNumbers": ...,
    }


# ListAvailablePhoneNumbersResultTypeDef definition
...
```python
# ListAvailablePhoneNumbersRequestPaginateTypeDef TypedDict usage example

from mypy_boto3_pinpoint_sms_voice_v2.type_defs import ListAvailablePhoneNumbersRequestPaginateTypeDef


def get_value() -> ListAvailablePhoneNumbersRequestPaginateTypeDef:
    return {
        "IsoCountryCode": ...,
    }


# ListAvailablePhoneNumbersRequestPaginateTypeDef definition

class ListAvailablePhoneNumbersRequestPaginateTypeDef(TypedDict):
    IsoCountryCode: str,
    NumberCapabilities: Sequence[NumberCapabilityType],  # (1)
    NumberType: SearchableNumberTypeType,  # (2)
    RegistrationId: NotRequired[str],
    NumberPreference: NotRequired[Sequence[NumberPreferenceItemTypeDef]],  # (3)
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (4)
```

1. See `Sequence[NumberCapabilityType]`
2. See [:material-code-brackets: SearchableNumberTypeType](./literals.md#searchablenumbertypetype)
3. See `Sequence[NumberPreferenceItemTypeDef]`
4. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)

## ListAvailablePhoneNumbersRequestTypeDef

```python
# ListAvailablePhoneNumbersRequestTypeDef TypedDict usage example

from mypy_boto3_pinpoint_sms_voice_v2.type_defs import ListAvailablePhoneNumbersRequestTypeDef


def get_value() -> ListAvailablePhoneNumbersRequestTypeDef:
    return {
        "IsoCountryCode": ...,
    }


# ListAvailablePhoneNumbersRequestTypeDef definition
...
class RequestPhoneNumberRequestTypeDef(TypedDict):
    ...
    PoolId: NotRequired[str],
    RegistrationId: NotRequired[str],
    NumberPreference: NotRequired[Sequence[NumberPreferenceItemTypeDef]],  # (4)
    InternationalSendingEnabled: NotRequired[bool],
    DeletionProtectionEnabled: NotRequired[bool],
...
4. See `Sequence[NumberPreferenceItemTypeDef]`
...
class PhoneNumberInformationTypeDef(TypedDict):
    ...
    PoolId: NotRequired[str],
    RegistrationId: NotRequired[str],
    MessagingLimits: NotRequired[MessagingLimitsTypeDef],  # (5)
```
...
3. See `list[NumberCapabilityType]`
4. See [:material-code-brackets: NumberTypeType](./literals.md#numbertypetype)
5. See [:material-code-braces: MessagingLimitsTypeDef](./type_defs.md#messaginglimitstypedef)
...
class SenderIdInformationTypeDef(TypedDict):
    ...
    Registered: bool,
    RegistrationId: NotRequired[str],
    MessagingLimits: NotRequired[MessagingLimitsTypeDef],  # (2)
```

1. See `list[MessageTypeType]`
2. See [:material-code-braces: MessagingLimitsTypeDef](./type_defs.md#messaginglimitstypedef)
...
class RcsAgentInformationTypeDef(TypedDict):
    ...
    MessagingLimits: NotRequired[MessagingLimitsTypeDef],  # (3)
```

1. See [:material-code-brackets: RcsAgentStatusType](./literals.md#rcsagentstatustype)
2. See [:material-code-braces: TestingAgentInformationTypeDef](./type_defs.md#testingagentinformationtypedef)
3. See [:material-code-braces: MessagingLimitsTypeDef](./type_defs.md#messaginglimitstypedef)
