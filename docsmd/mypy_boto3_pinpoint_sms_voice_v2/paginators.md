...
Type annotations and code completion for `#!python boto3.client("pinpoint-sms-voice-v2").get_paginator("list_available_phone_numbers")`.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/pinpoint-sms-voice-v2/paginator/ListAvailablePhoneNumbers.html#PinpointSMSVoiceV2.Paginator.ListAvailablePhoneNumbers)

```python
# ListAvailablePhoneNumbersPaginator usage example

from boto3.session import Session

from mypy_boto3_pinpoint_sms_voice_v2.paginator import ListAvailablePhoneNumbersPaginator

def get_list_available_phone_numbers_paginator() -> ListAvailablePhoneNumbersPaginator:
    return Session().client("pinpoint-sms-voice-v2").get_paginator("list_available_phone_numbers")
```

```python
# ListAvailablePhoneNumbersPaginator usage example with type annotations
...
client = Session().client("pinpoint-sms-voice-v2")  # (1)
paginator: ListAvailablePhoneNumbersPaginator = client.get_paginator("list_available_phone_numbers")  # (2)
for item in paginator.paginate(...):
    print(item)  # (3)
```

1. client: [PinpointSMSVoiceV2Client](./client.md)
2. paginator: [ListAvailablePhoneNumbersPaginator](./paginators.md#listavailablephonenumberspaginator)
3. item: `PageIterator[ListAvailablePhoneNumbersResultTypeDef]`


### paginate

Type annotations and code completion for `#!python ListAvailablePhoneNumbersPaginator.paginate` method.
...
def paginate(
    ...
    *,
    ...
    RegistrationId: str = ...,
    NumberPreference: Sequence[NumberPreferenceItemTypeDef] = ...,  # (3)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (4)
) -> botocore.paginate.PageIterator[ListAvailablePhoneNumbersResultTypeDef]:  # (5)
    ...
```
...
4. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
5. See `PageIterator[ListAvailablePhoneNumbersResultTypeDef]`


```python
# paginate method usage example with argument unpacking

kwargs: ListAvailablePhoneNumbersRequestPaginateTypeDef = {  # (1)
    "IsoCountryCode": ...,
    "NumberCapabilities": ...,
    "NumberType": ...,
}
...
1. See [:material-code-braces: ListAvailablePhoneNumbersRequestPaginateTypeDef](./type_defs.md#listavailablephonenumbersrequestpaginatetypedef)
