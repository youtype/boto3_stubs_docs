...
### list\_available\_phone\_numbers

Search available phone numbers from aggregator inventory, optionally filtered
by pattern.

Type annotations and code completion for `#!python boto3.client("pinpoint-sms-voice-v2").list_available_phone_numbers` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/pinpoint-sms-voice-v2/client/list_available_phone_numbers.html)

```python
# list_available_phone_numbers method definition
...
def list_available_phone_numbers(
    ...
    *,
    ...
    NextToken: str = ...,
    MaxResults: int = ...,
) -> ListAvailablePhoneNumbersResultTypeDef:  # (4)
    ...
```
...
4. See [:material-code-braces: ListAvailablePhoneNumbersResultTypeDef](./type_defs.md#listavailablephonenumbersresulttypedef)


```python
# list_available_phone_numbers method usage example with argument unpacking

kwargs: ListAvailablePhoneNumbersRequestTypeDef = {  # (1)
    "IsoCountryCode": ...,
    "NumberCapabilities": ...,
    "NumberType": ...,
}

parent.list_available_phone_numbers(**kwargs)
```

1. See [:material-code-braces: ListAvailablePhoneNumbersRequestTypeDef](./type_defs.md#listavailablephonenumbersrequesttypedef)
...
def request_phone_number(
    ...
    *,
    ...
    PoolId: str = ...,
    RegistrationId: str = ...,
    NumberPreference: Sequence[NumberPreferenceItemTypeDef] = ...,  # (4)
    InternationalSendingEnabled: bool = ...,
    DeletionProtectionEnabled: bool = ...,
    Tags: Sequence[TagTypeDef] = ...,  # (5)
    ClientToken: str = ...,
) -> RequestPhoneNumberResultTypeDef:  # (6)
    ...
```
...
6. See [:material-code-braces: RequestPhoneNumberResultTypeDef](./type_defs.md#requestphonenumberresulttypedef)
...
- `client.get_paginator("list_available_phone_numbers")` -> [ListAvailablePhoneNumbersPaginator](./paginators.md#listavailablephonenumberspaginator)
