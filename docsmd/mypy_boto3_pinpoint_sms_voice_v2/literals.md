...
```python
# ListAvailablePhoneNumbersPaginatorName usage example
from mypy_boto3_pinpoint_sms_voice_v2.literals import ListAvailablePhoneNumbersPaginatorName

def get_value() -> ListAvailablePhoneNumbersPaginatorName:
    return "list_available_phone_numbers"
```

```python
# ListAvailablePhoneNumbersPaginatorName definition
ListAvailablePhoneNumbersPaginatorName = Literal[
...
from mypy_boto3_pinpoint_sms_voice_v2.literals import PreferenceTypeType
...
```python
# SearchableNumberTypeType usage example
from mypy_boto3_pinpoint_sms_voice_v2.literals import SearchableNumberTypeType

def get_value() -> SearchableNumberTypeType:
    return "TEN_DLC"
```

```python
# SearchableNumberTypeType definition
SearchableNumberTypeType = Literal[
    "TEN_DLC",
]
```
