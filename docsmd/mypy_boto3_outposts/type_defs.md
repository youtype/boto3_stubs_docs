...
class OutpostTypeDef(TypedDict):
    ...
    SupportedHardwareType: NotRequired[SupportedHardwareTypeType],  # (1)
    Generation: NotRequired[OutpostGenerationType],  # (2)
    RackScalingType: NotRequired[RackScalingTypeType],  # (3)
```

1. See [:material-code-brackets: SupportedHardwareTypeType](./literals.md#supportedhardwaretypetype)
2. See [:material-code-brackets: OutpostGenerationType](./literals.md#outpostgenerationtype)
3. See [:material-code-brackets: RackScalingTypeType](./literals.md#rackscalingtypetype)
...
class CatalogItemTypeDef(TypedDict):
    ...
    RackScalingType: NotRequired[RackScalingTypeType],  # (4)
```
...
4. See [:material-code-brackets: RackScalingTypeType](./literals.md#rackscalingtypetype)
