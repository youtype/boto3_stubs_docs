...
```python
# RackScalingTypeType usage example
from mypy_boto3_outposts.literals import RackScalingTypeType

def get_value() -> RackScalingTypeType:
    return "MULTI_RACK"
```

```python
# RackScalingTypeType definition
RackScalingTypeType = Literal[
    "MULTI_RACK",
    "SINGLE_RACK",
]
```
