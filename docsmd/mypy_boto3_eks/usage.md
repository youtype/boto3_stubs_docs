...
result = client.activate_certificate_authority()  # (2)
```

1. client: [EKSClient](./client.md)
2. result: [:material-code-braces: ActivateCertificateAuthorityResponseTypeDef](./type_defs.md#activatecertificateauthorityresponsetypedef)
...
kwargs: ActivateCertificateAuthorityRequestTypeDef = {...}
result: ActivateCertificateAuthorityResponseTypeDef = client.activate_certificate_authority(**kwargs)
```
