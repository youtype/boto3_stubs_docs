...
```python
# ResaleAuthorizationIssuerAccountIdFilterTypeDef TypedDict usage example

from mypy_boto3_marketplace_catalog.type_defs import ResaleAuthorizationIssuerAccountIdFilterTypeDef


def get_value() -> ResaleAuthorizationIssuerAccountIdFilterTypeDef:
    return {
        "ValueList": ...,
    }


# ResaleAuthorizationIssuerAccountIdFilterTypeDef definition
...
```python
# ResaleAuthorizationSourceAuthorizationFilterTypeDef TypedDict usage example

from mypy_boto3_marketplace_catalog.type_defs import ResaleAuthorizationSourceAuthorizationFilterTypeDef


def get_value() -> ResaleAuthorizationSourceAuthorizationFilterTypeDef:
    return {
        "ValueList": ...,
    }


# ResaleAuthorizationSourceAuthorizationFilterTypeDef definition
...
class ResaleAuthorizationFiltersTypeDef(TypedDict):
    ...
    SourceAuthorization: NotRequired[ResaleAuthorizationSourceAuthorizationFilterTypeDef],  # (15)
    IssuerAccountId: NotRequired[ResaleAuthorizationIssuerAccountIdFilterTypeDef],  # (16)
```
...
15. See [:material-code-braces: ResaleAuthorizationSourceAuthorizationFilterTypeDef](./type_defs.md#resaleauthorizationsourceauthorizationfiltertypedef)
16. See [:material-code-braces: ResaleAuthorizationIssuerAccountIdFilterTypeDef](./type_defs.md#resaleauthorizationissueraccountidfiltertypedef)
