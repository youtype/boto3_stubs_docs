...
def put_function(
    ...
    *,
    ...
    AwsServiceRequestConfiguration: AwsServiceRequestConfigurationUnionTypeDef = ...,  # (3)
    CustomOutputConfiguration: CustomOutputConfigurationUnionTypeDef = ...,  # (4)
    ConcurrentExecutorConfiguration: ConcurrentExecutorConfigurationUnionTypeDef = ...,  # (5)
    SequentialExecutorConfiguration: SequentialExecutorConfigurationUnionTypeDef = ...,  # (6)
    VastRequestConfiguration: VastRequestConfigurationUnionTypeDef = ...,  # (7)
    Tags: Mapping[str, str] = ...,
) -> PutFunctionResponseTypeDef:  # (8)
    ...
```
...
8. See [:material-code-braces: PutFunctionResponseTypeDef](./type_defs.md#putfunctionresponsetypedef)
