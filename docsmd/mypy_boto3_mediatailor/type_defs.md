...
```python
# AwsServiceRequestConfigurationUnionTypeDef Union usage example

from mypy_boto3_mediatailor.type_defs import AwsServiceRequestConfigurationUnionTypeDef


def get_value() -> AwsServiceRequestConfigurationUnionTypeDef:
    return ...


# AwsServiceRequestConfigurationUnionTypeDef definition

AwsServiceRequestConfigurationUnionTypeDef = Union[
    AwsServiceRequestConfigurationTypeDef,  # (1)
    AwsServiceRequestConfigurationOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: AwsServiceRequestConfigurationTypeDef](./type_defs.md#awsservicerequestconfigurationtypedef)
2. See [:material-code-braces: AwsServiceRequestConfigurationOutputTypeDef](./type_defs.md#awsservicerequestconfigurationoutputtypedef)
...
```python
# AwsServiceRequestConfigurationOutputTypeDef TypedDict usage example

from mypy_boto3_mediatailor.type_defs import AwsServiceRequestConfigurationOutputTypeDef


def get_value() -> AwsServiceRequestConfigurationOutputTypeDef:
    return {
        "Runtime": ...,
    }


# AwsServiceRequestConfigurationOutputTypeDef definition

class AwsServiceRequestConfigurationOutputTypeDef(TypedDict):
...
```python
# AwsServiceRequestConfigurationTypeDef TypedDict usage example

from mypy_boto3_mediatailor.type_defs import AwsServiceRequestConfigurationTypeDef


def get_value() -> AwsServiceRequestConfigurationTypeDef:
    return {
        "Runtime": ...,
    }


# AwsServiceRequestConfigurationTypeDef definition

class AwsServiceRequestConfigurationTypeDef(TypedDict):
    Runtime: RuntimeTypeType,  # (1)
    MethodType: MethodTypeType,  # (2)
    RequestTimeoutMilliseconds: int,
    Url: str,
...
class FunctionTypeDef(TypedDict):
    ...
    AwsServiceRequestConfiguration: NotRequired[AwsServiceRequestConfigurationOutputTypeDef],  # (3)
    CustomOutputConfiguration: NotRequired[CustomOutputConfigurationOutputTypeDef],  # (4)
    ConcurrentExecutorConfiguration: NotRequired[ConcurrentExecutorConfigurationOutputTypeDef],  # (5)
    SequentialExecutorConfiguration: NotRequired[SequentialExecutorConfigurationOutputTypeDef],  # (6)
    VastRequestConfiguration: NotRequired[VastRequestConfigurationOutputTypeDef],  # (7)
    Tags: NotRequired[dict[str, str]],
    Arn: NotRequired[str],
```
...
2. See [:material-code-braces: HttpRequestConfigurationOutputTypeDef](./type_defs.md#httprequestconfigurationoutputtypedef)
3. See [:material-code-braces: AwsServiceRequestConfigurationOutputTypeDef](./type_defs.md#awsservicerequestconfigurationoutputtypedef)
4. See [:material-code-braces: CustomOutputConfigurationOutputTypeDef](./type_defs.md#customoutputconfigurationoutputtypedef)
5. See [:material-code-braces: ConcurrentExecutorConfigurationOutputTypeDef](./type_defs.md#concurrentexecutorconfigurationoutputtypedef)
6. See [:material-code-braces: SequentialExecutorConfigurationOutputTypeDef](./type_defs.md#sequentialexecutorconfigurationoutputtypedef)
7. See [:material-code-braces: VastRequestConfigurationOutputTypeDef](./type_defs.md#vastrequestconfigurationoutputtypedef)
...
class GetFunctionResponseTypeDef(TypedDict):
    ...
    AwsServiceRequestConfiguration: AwsServiceRequestConfigurationOutputTypeDef,  # (3)
    CustomOutputConfiguration: CustomOutputConfigurationOutputTypeDef,  # (4)
    ConcurrentExecutorConfiguration: ConcurrentExecutorConfigurationOutputTypeDef,  # (5)
    SequentialExecutorConfiguration: SequentialExecutorConfigurationOutputTypeDef,  # (6)
    VastRequestConfiguration: VastRequestConfigurationOutputTypeDef,  # (7)
    Tags: dict[str, str],
    Arn: str,
...
class PutFunctionRequestTypeDef(TypedDict):
    ...
    AwsServiceRequestConfiguration: NotRequired[AwsServiceRequestConfigurationUnionTypeDef],  # (3)
    CustomOutputConfiguration: NotRequired[CustomOutputConfigurationUnionTypeDef],  # (4)
    ConcurrentExecutorConfiguration: NotRequired[ConcurrentExecutorConfigurationUnionTypeDef],  # (5)
    SequentialExecutorConfiguration: NotRequired[SequentialExecutorConfigurationUnionTypeDef],  # (6)
    VastRequestConfiguration: NotRequired[VastRequestConfigurationUnionTypeDef],  # (7)
    Tags: NotRequired[Mapping[str, str]],
```

1. See [:material-code-brackets: FunctionTypeType](./literals.md#functiontypetype)
2. See [:material-code-braces: HttpRequestConfigurationUnionTypeDef](#httprequestconfigurationuniontypedef)
3. See [:material-code-braces: AwsServiceRequestConfigurationUnionTypeDef](#awsservicerequestconfigurationuniontypedef)
4. See [:material-code-braces: CustomOutputConfigurationUnionTypeDef](#customoutputconfigurationuniontypedef)
5. See [:material-code-braces: ConcurrentExecutorConfigurationUnionTypeDef](#concurrentexecutorconfigurationuniontypedef)
6. See [:material-code-braces: SequentialExecutorConfigurationUnionTypeDef](#sequentialexecutorconfigurationuniontypedef)
7. See [:material-code-braces: VastRequestConfigurationUnionTypeDef](#vastrequestconfigurationuniontypedef)
