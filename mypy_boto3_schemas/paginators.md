...
`Iterator`\[[ListDiscoverersResponseResponseTypeDef](./type_defs.md#listdiscoverersresponseresponsetypedef)\].
...
`Iterator`\[[SearchSchemasResponseResponseTypeDef](./type_defs.md#searchschemasresponseresponsetypedef)\].
