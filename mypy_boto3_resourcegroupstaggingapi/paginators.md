...
`Iterator`\[[GetComplianceSummaryOutputResponseTypeDef](./type_defs.md#getcompliancesummaryoutputresponsetypedef)\].
...
`Iterator`\[[GetResourcesOutputResponseTypeDef](./type_defs.md#getresourcesoutputresponsetypedef)\].
...
`Iterator`\[[GetTagKeysOutputResponseTypeDef](./type_defs.md#gettagkeysoutputresponsetypedef)\].
...
`Iterator`\[[GetTagValuesOutputResponseTypeDef](./type_defs.md#gettagvaluesoutputresponsetypedef)\].
